...
public class StringSequenceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::StringSequence";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final StringSequenceTypeSupport _singleton
    = new StringSequenceTypeSupport();
    ...
    */
    public static StringSequenceTypeSupport get_instance() {
        return _singleton;
    }

    public static StringSequenceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return StringSequenceTypeCode.VALUE;
    }

    public Object create_data() {
        return StringSequence.create();
    }
    ...
    * <code>this</code> is not a <code>StringSequence</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        StringSequence typedDst = (StringSequence) destination;
        StringSequence typedSrc = (StringSequence) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        StringSequence typedSrc = (StringSequence) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.userData,(255),100);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            StringSequence typedDst = (StringSequence) dst;
            src.readStringSequence(typedDst.userData, 100);
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            StringSequence typedDst = (StringSequence) sample;
    ...
    protected StringSequenceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,StringSequenceTypeCode.VALUE,StringSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected StringSequenceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,StringSequenceTypeCode.VALUE,StringSequence.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
