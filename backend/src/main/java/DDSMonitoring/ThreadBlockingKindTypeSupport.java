...
public class ThreadBlockingKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ThreadBlockingKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThreadBlockingKindTypeSupport _singleton
    = new ThreadBlockingKindTypeSupport();
    ...
    */
    public static ThreadBlockingKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ThreadBlockingKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ThreadBlockingKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ThreadBlockingKind.class;
    }
    ...
    * <code>this</code> is not a <code>ThreadBlockingKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ThreadBlockingKind typedSrc = (ThreadBlockingKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ThreadBlockingKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ThreadBlockingKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ThreadBlockingKindTypeCode.VALUE,ThreadBlockingKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
