...
public class LivelinessQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::LivelinessQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LivelinessQosPolicyTypeSupport _singleton
    = new LivelinessQosPolicyTypeSupport();
    ...
    */
    public static LivelinessQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static LivelinessQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LivelinessQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return LivelinessQosPolicy.create();
    }
    ...
    public Class get_type() {
        return LivelinessQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>LivelinessQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LivelinessQosPolicy typedDst = (LivelinessQosPolicy) destination;
        LivelinessQosPolicy typedSrc = (LivelinessQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.LivelinessQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.LivelinessQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LivelinessQosPolicy typedSrc = (LivelinessQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.LivelinessQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.lease_duration);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.LivelinessQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.lease_duration, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.assertions_per_lease_duration);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LivelinessQosPolicy typedDst = (LivelinessQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.LivelinessQosPolicyKind)DDSMonitoring.LivelinessQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
                typedDst.lease_duration = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.lease_duration, src, false, true, endpoint_plugin_qos);     
                typedDst.assertions_per_lease_duration = src.readInt();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.LivelinessQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LivelinessQosPolicy typedDst = (LivelinessQosPolicy) sample;
    ...
    protected LivelinessQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LivelinessQosPolicyTypeCode.VALUE,LivelinessQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LivelinessQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LivelinessQosPolicyTypeCode.VALUE,LivelinessQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
