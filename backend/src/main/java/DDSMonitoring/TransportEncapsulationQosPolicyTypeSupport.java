...
public class TransportEncapsulationQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportEncapsulationQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportEncapsulationQosPolicyTypeSupport _singleton
    = new TransportEncapsulationQosPolicyTypeSupport();
    ...
    */
    public static TransportEncapsulationQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportEncapsulationQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportEncapsulationQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportEncapsulationQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TransportEncapsulationQosPolicy();
    }
    ...
    public Class get_type() {
        return TransportEncapsulationQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TransportEncapsulationQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportEncapsulationQosPolicy typedDst = (TransportEncapsulationQosPolicy) destination;
        TransportEncapsulationQosPolicy typedSrc = (TransportEncapsulationQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportEncapsulationSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportEncapsulationSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportEncapsulationQosPolicy typedSrc = (TransportEncapsulationQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.TransportEncapsulationSettings_tTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.TransportEncapsulationSettings_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.value,4, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        TransportEncapsulationQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportEncapsulationQosPolicy typedDst = (TransportEncapsulationQosPolicy) dst;
            typedDst.clear();      
            try{
                DDSMonitoring.TransportEncapsulationSettings_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.value, src, 4, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        TransportEncapsulationQosPolicy dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.TransportEncapsulationSettings_tTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportEncapsulationQosPolicy typedDst = (TransportEncapsulationQosPolicy) sample;
    ...
    protected TransportEncapsulationQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportEncapsulationQosPolicyTypeCode.VALUE,TransportEncapsulationQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportEncapsulationQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportEncapsulationQosPolicyTypeCode.VALUE,TransportEncapsulationQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
