...
public class HistoryQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::HistoryQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HistoryQosPolicyTypeSupport _singleton
    = new HistoryQosPolicyTypeSupport();
    ...
    */
    public static HistoryQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static HistoryQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HistoryQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return HistoryQosPolicy.create();
    }
    ...
    * <code>this</code> is not a <code>HistoryQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HistoryQosPolicy typedDst = (HistoryQosPolicy) destination;
        HistoryQosPolicy typedSrc = (HistoryQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.RefilterQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.RefilterQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HistoryQosPolicy typedSrc = (HistoryQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.RefilterQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.refilter);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.depth);

            DDSMonitoring.RefilterQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.refilter, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HistoryQosPolicy typedDst = (HistoryQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.HistoryQosPolicyKind)DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
                typedDst.depth = src.readInt();
                typedDst.refilter = (DDSMonitoring.RefilterQosPolicyKind)DDSMonitoring.RefilterQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.refilter, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.RefilterQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HistoryQosPolicy typedDst = (HistoryQosPolicy) sample;
    ...
    protected HistoryQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HistoryQosPolicyTypeCode.VALUE,HistoryQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HistoryQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HistoryQosPolicyTypeCode.VALUE,HistoryQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
