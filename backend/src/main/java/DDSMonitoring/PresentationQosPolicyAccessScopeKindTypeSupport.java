...
public class PresentationQosPolicyAccessScopeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PresentationQosPolicyAccessScopeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PresentationQosPolicyAccessScopeKindTypeSupport _singleton
    = new PresentationQosPolicyAccessScopeKindTypeSupport();
    ...
    */
    public static PresentationQosPolicyAccessScopeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static PresentationQosPolicyAccessScopeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PresentationQosPolicyAccessScopeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return PresentationQosPolicyAccessScopeKind.class;
    }
    ...
    * <code>this</code> is not a <code>PresentationQosPolicyAccessScopeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        PresentationQosPolicyAccessScopeKind typedSrc = (PresentationQosPolicyAccessScopeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = PresentationQosPolicyAccessScopeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected PresentationQosPolicyAccessScopeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PresentationQosPolicyAccessScopeKindTypeCode.VALUE,PresentationQosPolicyAccessScopeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
