...
public class PublishModeQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PublishModeQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PublishModeQosPolicyKindTypeSupport _singleton
    = new PublishModeQosPolicyKindTypeSupport();
    ...
    */
    public static PublishModeQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static PublishModeQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PublishModeQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return PublishModeQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>PublishModeQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        PublishModeQosPolicyKind typedSrc = (PublishModeQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = PublishModeQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected PublishModeQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PublishModeQosPolicyKindTypeCode.VALUE,PublishModeQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
