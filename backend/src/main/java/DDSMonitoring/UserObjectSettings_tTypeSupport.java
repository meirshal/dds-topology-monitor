...
public class UserObjectSettings_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::UserObjectSettings_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UserObjectSettings_tTypeSupport _singleton
    = new UserObjectSettings_tTypeSupport();
    ...
    */
    public static UserObjectSettings_tTypeSupport get_instance() {
        return _singleton;
    }

    public static UserObjectSettings_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UserObjectSettings_tTypeCode.VALUE;
    }

    public Object create_data() {
        return UserObjectSettings_t.create();
    }
    ...
    public Object create_key() {
        return new UserObjectSettings_t();
    }
    ...
    public Class get_type() {
        return UserObjectSettings_t.class;
    }
    ...
    * <code>this</code> is not a <code>UserObjectSettings_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UserObjectSettings_t typedDst = (UserObjectSettings_t) destination;
        UserObjectSettings_t typedSrc = (UserObjectSettings_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        UserObjectSettings_t typedSrc = (UserObjectSettings_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.alignment);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UserObjectSettings_t typedDst = (UserObjectSettings_t) dst;
            typedDst.size = src.readInt();
            typedDst.alignment = src.readInt();
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UserObjectSettings_t typedDst = (UserObjectSettings_t) sample;
    ...
    protected UserObjectSettings_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UserObjectSettings_tTypeCode.VALUE,UserObjectSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UserObjectSettings_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UserObjectSettings_tTypeCode.VALUE,UserObjectSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
