...
public class HistoryQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::HistoryQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HistoryQosPolicyKindTypeSupport _singleton
    = new HistoryQosPolicyKindTypeSupport();
    ...
    */
    public static HistoryQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static HistoryQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HistoryQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return HistoryQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>HistoryQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        HistoryQosPolicyKind typedSrc = (HistoryQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = HistoryQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected HistoryQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HistoryQosPolicyKindTypeCode.VALUE,HistoryQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
