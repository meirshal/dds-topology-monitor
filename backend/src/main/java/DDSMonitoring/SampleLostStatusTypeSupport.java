...
public class SampleLostStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SampleLostStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SampleLostStatusTypeSupport _singleton
    = new SampleLostStatusTypeSupport();
    ...
    */
    public static SampleLostStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static SampleLostStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SampleLostStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return SampleLostStatus.create();
    }
    ...
    * <code>this</code> is not a <code>SampleLostStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SampleLostStatus typedDst = (SampleLostStatus) destination;
        SampleLostStatus typedSrc = (SampleLostStatus) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.SampleLostStatusKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.SampleLostStatusKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SampleLostStatus typedSrc = (SampleLostStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.SampleLostStatusKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.SampleLostStatusKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.last_reason, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SampleLostStatus typedDst = (SampleLostStatus) dst;
            typedDst.clear();      
            try{
                typedDst.total_count = src.readInt();
                typedDst.total_count_change = src.readInt();
                typedDst.last_reason = (DDSMonitoring.SampleLostStatusKind)DDSMonitoring.SampleLostStatusKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.last_reason, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.SampleLostStatusKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SampleLostStatus typedDst = (SampleLostStatus) sample;
    ...
    protected SampleLostStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SampleLostStatusTypeCode.VALUE,SampleLostStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SampleLostStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SampleLostStatusTypeCode.VALUE,SampleLostStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
