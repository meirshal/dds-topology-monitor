...
public class EventQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::EventQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EventQosPolicyTypeSupport _singleton
    = new EventQosPolicyTypeSupport();
    ...
    */
    public static EventQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static EventQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EventQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return EventQosPolicy.create();
    }
    ...
    * <code>this</code> is not a <code>EventQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EventQosPolicy typedDst = (EventQosPolicy) destination;
        EventQosPolicy typedSrc = (EventQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EventQosPolicy typedSrc = (EventQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            memberId = 1;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.initial_count);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 2;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.max_count);
            dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EventQosPolicy typedDst = (EventQosPolicy) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 1:
                    typedDst.initial_count = src.readInt();
                    break;
                    case 2:
                    typedDst.max_count = src.readInt();
                    break;
                    default:
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EventQosPolicy typedDst = (EventQosPolicy) sample;
    ...
    protected EventQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EventQosPolicyTypeCode.VALUE,EventQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EventQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EventQosPolicyTypeCode.VALUE,EventQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
