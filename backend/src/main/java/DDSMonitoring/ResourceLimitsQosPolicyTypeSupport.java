...
public class ResourceLimitsQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ResourceLimitsQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ResourceLimitsQosPolicyTypeSupport _singleton
    = new ResourceLimitsQosPolicyTypeSupport();
    ...
    */
    public static ResourceLimitsQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static ResourceLimitsQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ResourceLimitsQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return ResourceLimitsQosPolicy.create();
    }
    ...
    public Class get_type() {
        return ResourceLimitsQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>ResourceLimitsQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ResourceLimitsQosPolicy typedDst = (ResourceLimitsQosPolicy) destination;
        ResourceLimitsQosPolicy typedSrc = (ResourceLimitsQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ResourceLimitsQosPolicy typedSrc = (ResourceLimitsQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.initial_instances);

            dst.writeInt(typedSrc.instance_hash_buckets);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ResourceLimitsQosPolicy typedDst = (ResourceLimitsQosPolicy) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.initial_instances = src.readInt();
                typedDst.instance_hash_buckets = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ResourceLimitsQosPolicy typedDst = (ResourceLimitsQosPolicy) sample;
    ...
    protected ResourceLimitsQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ResourceLimitsQosPolicyTypeCode.VALUE,ResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ResourceLimitsQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ResourceLimitsQosPolicyTypeCode.VALUE,ResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
