...
public class AvailabilityQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::AvailabilityQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AvailabilityQosPolicyTypeSupport _singleton
    = new AvailabilityQosPolicyTypeSupport();
    ...
    */
    public static AvailabilityQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static AvailabilityQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AvailabilityQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return AvailabilityQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new AvailabilityQosPolicy();
    }
    ...
    public Class get_type() {
        return AvailabilityQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>AvailabilityQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AvailabilityQosPolicy typedDst = (AvailabilityQosPolicy) destination;
        AvailabilityQosPolicy typedSrc = (AvailabilityQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.EndpointGroup_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 256);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.EndpointGroup_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        AvailabilityQosPolicy typedSrc = (AvailabilityQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.max_data_availability_waiting_time);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.max_endpoint_availability_waiting_time);
        currentAlignment += DDSMonitoring.EndpointGroup_tTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.required_matched_endpoint_groups);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.enable_required_subscriptions);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.max_data_availability_waiting_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.max_endpoint_availability_waiting_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.EndpointGroup_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.required_matched_endpoint_groups,256, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AvailabilityQosPolicy typedDst = (AvailabilityQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.enable_required_subscriptions = src.readBoolean();
                typedDst.max_data_availability_waiting_time = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.max_data_availability_waiting_time, src, false, true, endpoint_plugin_qos);     
                typedDst.max_endpoint_availability_waiting_time = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.max_endpoint_availability_waiting_time, src, false, true, endpoint_plugin_qos);     
                DDSMonitoring.EndpointGroup_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.required_matched_endpoint_groups, src, 256, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.EndpointGroup_tTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AvailabilityQosPolicy typedDst = (AvailabilityQosPolicy) sample;
    ...
    protected AvailabilityQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AvailabilityQosPolicyTypeCode.VALUE,AvailabilityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AvailabilityQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AvailabilityQosPolicyTypeCode.VALUE,AvailabilityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
