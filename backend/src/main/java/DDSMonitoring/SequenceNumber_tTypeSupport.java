...
public class SequenceNumber_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SequenceNumber_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceNumber_tTypeSupport _singleton
    = new SequenceNumber_tTypeSupport();
    ...
    */
    public static SequenceNumber_tTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceNumber_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceNumber_tTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceNumber_t.create();
    }
    ...
    * <code>this</code> is not a <code>SequenceNumber_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceNumber_t typedDst = (SequenceNumber_t) destination;
        SequenceNumber_t typedSrc = (SequenceNumber_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceNumber_t typedSrc = (SequenceNumber_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.high);

            dst.writeInt(typedSrc.low);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceNumber_t typedDst = (SequenceNumber_t) dst;
            typedDst.high = src.readInt();
            typedDst.low = src.readInt();
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceNumber_t typedDst = (SequenceNumber_t) sample;
    ...
    protected SequenceNumber_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceNumber_tTypeCode.VALUE,SequenceNumber_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceNumber_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceNumber_tTypeCode.VALUE,SequenceNumber_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
