...
public class DataWriterResourceLimitsQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DataWriterResourceLimitsQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataWriterResourceLimitsQosPolicyTypeSupport _singleton
    = new DataWriterResourceLimitsQosPolicyTypeSupport();
    ...
    */
    public static DataWriterResourceLimitsQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DataWriterResourceLimitsQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataWriterResourceLimitsQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DataWriterResourceLimitsQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new DataWriterResourceLimitsQosPolicy();
    }
    ...
    public Class get_type() {
        return DataWriterResourceLimitsQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DataWriterResourceLimitsQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataWriterResourceLimitsQosPolicy typedDst = (DataWriterResourceLimitsQosPolicy) destination;
        DataWriterResourceLimitsQosPolicy typedSrc = (DataWriterResourceLimitsQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.DataWriterResourceLimitsInstanceReplacementKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.DataWriterResourceLimitsInstanceReplacementKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataWriterResourceLimitsQosPolicy typedSrc = (DataWriterResourceLimitsQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.DataWriterResourceLimitsInstanceReplacementKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.instance_replacement);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.initial_concurrent_blocking_threads);

            dst.writeInt(typedSrc.max_concurrent_blocking_threads);

            dst.writeInt(typedSrc.max_remote_reader_filters);

            dst.writeInt(typedSrc.initial_batches);

            dst.writeInt(typedSrc.max_batches);

            dst.writeInt(typedSrc.cookie_max_length);

            DDSMonitoring.DataWriterResourceLimitsInstanceReplacementKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.instance_replacement, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeBoolean(typedSrc.replace_empty_instances);

            dst.writeBoolean(typedSrc.autoregister_instances);

            dst.writeInt(typedSrc.initial_virtual_writers);

            dst.writeInt(typedSrc.max_virtual_writers);

            dst.writeInt(typedSrc.max_remote_readers);

            dst.writeInt(typedSrc.max_app_ack_remote_readers);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DataWriterResourceLimitsQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataWriterResourceLimitsQosPolicy typedDst = (DataWriterResourceLimitsQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.initial_concurrent_blocking_threads = src.readInt();
                typedDst.max_concurrent_blocking_threads = src.readInt();
                typedDst.max_remote_reader_filters = src.readInt();
                typedDst.initial_batches = src.readInt();
                typedDst.max_batches = src.readInt();
                typedDst.cookie_max_length = src.readInt();
                typedDst.instance_replacement = (DDSMonitoring.DataWriterResourceLimitsInstanceReplacementKind)DDSMonitoring.DataWriterResourceLimitsInstanceReplacementKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.instance_replacement, src, false, true, endpoint_plugin_qos);     
                typedDst.replace_empty_instances = src.readBoolean();
                typedDst.autoregister_instances = src.readBoolean();
                typedDst.initial_virtual_writers = src.readInt();
                typedDst.max_virtual_writers = src.readInt();
                typedDst.max_remote_readers = src.readInt();
                typedDst.max_app_ack_remote_readers = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        DataWriterResourceLimitsQosPolicy dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.DataWriterResourceLimitsInstanceReplacementKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataWriterResourceLimitsQosPolicy typedDst = (DataWriterResourceLimitsQosPolicy) sample;
    ...
    protected DataWriterResourceLimitsQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataWriterResourceLimitsQosPolicyTypeCode.VALUE,DataWriterResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataWriterResourceLimitsQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataWriterResourceLimitsQosPolicyTypeCode.VALUE,DataWriterResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
