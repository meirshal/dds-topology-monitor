...
public class OwnershipStrengthQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::OwnershipStrengthQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OwnershipStrengthQosPolicyTypeSupport _singleton
    = new OwnershipStrengthQosPolicyTypeSupport();
    ...
    */
    public static OwnershipStrengthQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static OwnershipStrengthQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OwnershipStrengthQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return OwnershipStrengthQosPolicy.create();
    }
    ...
    public Class get_type() {
        return OwnershipStrengthQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>OwnershipStrengthQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OwnershipStrengthQosPolicy typedDst = (OwnershipStrengthQosPolicy) destination;
        OwnershipStrengthQosPolicy typedSrc = (OwnershipStrengthQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OwnershipStrengthQosPolicy typedSrc = (OwnershipStrengthQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        OwnershipStrengthQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OwnershipStrengthQosPolicy typedDst = (OwnershipStrengthQosPolicy) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        OwnershipStrengthQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OwnershipStrengthQosPolicy typedDst = (OwnershipStrengthQosPolicy) sample;
    ...
    protected OwnershipStrengthQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OwnershipStrengthQosPolicyTypeCode.VALUE,OwnershipStrengthQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OwnershipStrengthQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OwnershipStrengthQosPolicyTypeCode.VALUE,OwnershipStrengthQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
