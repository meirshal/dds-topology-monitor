...
public class TypeSupportQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TypeSupportQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TypeSupportQosPolicyTypeSupport _singleton
    = new TypeSupportQosPolicyTypeSupport();
    ...
    */
    public static TypeSupportQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TypeSupportQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TypeSupportQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TypeSupportQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TypeSupportQosPolicy();
    }
    ...
    public Class get_type() {
        return TypeSupportQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TypeSupportQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TypeSupportQosPolicy typedDst = (TypeSupportQosPolicy) destination;
        TypeSupportQosPolicy typedSrc = (TypeSupportQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.CdrPaddingKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.CdrPaddingKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TypeSupportQosPolicy typedSrc = (TypeSupportQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.CdrPaddingKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.cdr_padding_kind);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.plugin_data);

            DDSMonitoring.CdrPaddingKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cdr_padding_kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TypeSupportQosPolicy typedDst = (TypeSupportQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.plugin_data = src.readLong();
                typedDst.cdr_padding_kind = (DDSMonitoring.CdrPaddingKind)DDSMonitoring.CdrPaddingKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cdr_padding_kind, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.CdrPaddingKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TypeSupportQosPolicy typedDst = (TypeSupportQosPolicy) sample;
    ...
    protected TypeSupportQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TypeSupportQosPolicyTypeCode.VALUE,TypeSupportQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TypeSupportQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TypeSupportQosPolicyTypeCode.VALUE,TypeSupportQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
