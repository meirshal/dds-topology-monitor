...
public class BuiltinTopicKey_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::BuiltinTopicKey_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BuiltinTopicKey_tTypeSupport _singleton
    = new BuiltinTopicKey_tTypeSupport();
    ...
    */
    public static BuiltinTopicKey_tTypeSupport get_instance() {
        return _singleton;
    }

    public static BuiltinTopicKey_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BuiltinTopicKey_tTypeCode.VALUE;
    }

    public Object create_data() {
        return BuiltinTopicKey_t.create();
    }
    ...
    public Class get_type() {
        return BuiltinTopicKey_t.class;
    }
    ...
    * <code>this</code> is not a <code>BuiltinTopicKey_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BuiltinTopicKey_t typedDst = (BuiltinTopicKey_t) destination;
        BuiltinTopicKey_t typedSrc = (BuiltinTopicKey_t) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getArrayMaxSizeSerialized(currentAlignment,  (4));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BuiltinTopicKey_t typedSrc = (BuiltinTopicKey_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 4; ++i1__){
                ...
                dst.writeInt(typedSrc.value[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BuiltinTopicKey_t typedDst = (BuiltinTopicKey_t) dst;
            for(int i1__ = 0; i1__< 4; ++i1__){

                typedDst.value[i1__] = src.readInt();
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BuiltinTopicKey_t typedDst = (BuiltinTopicKey_t) sample;
    ...
    protected BuiltinTopicKey_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BuiltinTopicKey_tTypeCode.VALUE,BuiltinTopicKey_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BuiltinTopicKey_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BuiltinTopicKey_tTypeCode.VALUE,BuiltinTopicKey_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
