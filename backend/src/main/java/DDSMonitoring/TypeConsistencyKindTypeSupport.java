...
public class TypeConsistencyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TypeConsistencyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TypeConsistencyKindTypeSupport _singleton
    = new TypeConsistencyKindTypeSupport();
    ...
    */
    public static TypeConsistencyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static TypeConsistencyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TypeConsistencyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return TypeConsistencyKind.class;
    }
    ...
    * <code>this</code> is not a <code>TypeConsistencyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        TypeConsistencyKind typedSrc = (TypeConsistencyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = TypeConsistencyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected TypeConsistencyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TypeConsistencyKindTypeCode.VALUE,TypeConsistencyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
