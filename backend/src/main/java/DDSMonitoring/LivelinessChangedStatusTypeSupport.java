...
public class LivelinessChangedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::LivelinessChangedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LivelinessChangedStatusTypeSupport _singleton
    = new LivelinessChangedStatusTypeSupport();
    ...
    */
    public static LivelinessChangedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static LivelinessChangedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LivelinessChangedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return LivelinessChangedStatus.create();
    }
    ...
    public Class get_type() {
        return LivelinessChangedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>LivelinessChangedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LivelinessChangedStatus typedDst = (LivelinessChangedStatus) destination;
        LivelinessChangedStatus typedSrc = (LivelinessChangedStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LivelinessChangedStatus typedSrc = (LivelinessChangedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.alive_count);

            dst.writeInt(typedSrc.not_alive_count);

            dst.writeInt(typedSrc.alive_count_change);

            dst.writeInt(typedSrc.not_alive_count_change);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LivelinessChangedStatus typedDst = (LivelinessChangedStatus) dst;
            typedDst.clear();      
            try{
                typedDst.alive_count = src.readInt();
                typedDst.not_alive_count = src.readInt();
                typedDst.alive_count_change = src.readInt();
                typedDst.not_alive_count_change = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LivelinessChangedStatus typedDst = (LivelinessChangedStatus) sample;
    ...
    protected LivelinessChangedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LivelinessChangedStatusTypeCode.VALUE,LivelinessChangedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LivelinessChangedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LivelinessChangedStatusTypeCode.VALUE,LivelinessChangedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
