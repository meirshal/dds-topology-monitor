...
public class ThreadSettingsCpuRotationKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ThreadSettingsCpuRotationKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThreadSettingsCpuRotationKindTypeSupport _singleton
    = new ThreadSettingsCpuRotationKindTypeSupport();
    ...
    */
    public static ThreadSettingsCpuRotationKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ThreadSettingsCpuRotationKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ThreadSettingsCpuRotationKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ThreadSettingsCpuRotationKind.class;
    }
    ...
    * <code>this</code> is not a <code>ThreadSettingsCpuRotationKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ThreadSettingsCpuRotationKind typedSrc = (ThreadSettingsCpuRotationKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ThreadSettingsCpuRotationKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ThreadSettingsCpuRotationKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ThreadSettingsCpuRotationKindTypeCode.VALUE,ThreadSettingsCpuRotationKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
