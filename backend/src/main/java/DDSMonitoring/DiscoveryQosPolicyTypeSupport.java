...
public class DiscoveryQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DiscoveryQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiscoveryQosPolicyTypeSupport _singleton
    = new DiscoveryQosPolicyTypeSupport();
    ...
    */
    public static DiscoveryQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DiscoveryQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiscoveryQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DiscoveryQosPolicy.create();
    }
    ...
    public Class get_type() {
        return DiscoveryQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DiscoveryQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiscoveryQosPolicy typedDst = (DiscoveryQosPolicy) destination;
        DiscoveryQosPolicy typedSrc = (DiscoveryQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringSeqMaxSizeSerialized(
            currentAlignment, (60)+1,(256));
        currentAlignment += CdrPrimitiveType.getStringSeqMaxSizeSerialized(
            currentAlignment, (60)+1,(4));
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiscoveryQosPolicy typedSrc = (DiscoveryQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSeqSerializedSize(
            currentAlignment , typedSrc.enabled_transports );
        currentAlignment  +=  CdrPrimitiveType.getStringSeqSerializedSize(
            currentAlignment , typedSrc.initial_peers );
        currentAlignment  +=  CdrPrimitiveType.getStringSeqSerializedSize(
            currentAlignment , typedSrc.multicast_receive_addresses );
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.enabled_transports,(128),128);

            dst.writeStringSeq(typedSrc.initial_peers,(60),256);

            dst.writeStringSeq(typedSrc.multicast_receive_addresses,(60),4);

            dst.writeInt(typedSrc.metatraffic_transport_priority);

            dst.writeBoolean(typedSrc.accept_unknown_peers);

            dst.writeBoolean(typedSrc.enable_endpoint_discovery);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiscoveryQosPolicy typedDst = (DiscoveryQosPolicy) dst;
            typedDst.clear();      
            try{
                src.readStringSequence(typedDst.enabled_transports, 128);
                src.readStringSequence(typedDst.initial_peers, 256);
                src.readStringSequence(typedDst.multicast_receive_addresses, 4);
                typedDst.metatraffic_transport_priority = src.readInt();
                typedDst.accept_unknown_peers = src.readBoolean();
                typedDst.enable_endpoint_discovery = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiscoveryQosPolicy typedDst = (DiscoveryQosPolicy) sample;
    ...
    protected DiscoveryQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiscoveryQosPolicyTypeCode.VALUE,DiscoveryQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiscoveryQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiscoveryQosPolicyTypeCode.VALUE,DiscoveryQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
