...
public class TransportBuiltinQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportBuiltinQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportBuiltinQosPolicyTypeSupport _singleton
    = new TransportBuiltinQosPolicyTypeSupport();
    ...
    */
    public static TransportBuiltinQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportBuiltinQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportBuiltinQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportBuiltinQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TransportBuiltinQosPolicy();
    }
    ...
    public Class get_type() {
        return TransportBuiltinQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TransportBuiltinQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportBuiltinQosPolicy typedDst = (TransportBuiltinQosPolicy) destination;
        TransportBuiltinQosPolicy typedSrc = (TransportBuiltinQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportBuiltinQosPolicy typedSrc = (TransportBuiltinQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportBuiltinQosPolicy typedDst = (TransportBuiltinQosPolicy) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportBuiltinQosPolicy typedDst = (TransportBuiltinQosPolicy) sample;
    ...
    protected TransportBuiltinQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportBuiltinQosPolicyTypeCode.VALUE,TransportBuiltinQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportBuiltinQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportBuiltinQosPolicyTypeCode.VALUE,TransportBuiltinQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
