...
/**
* A sequence of DataWriterQos instances.
*/
public final class DataWriterQosSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DataWriterQosSeq() {
        super(DataWriterQos.class);
    }

    public DataWriterQosSeq (int initialMaximum) {
        super(DataWriterQos.class, initialMaximum);
    }

    public DataWriterQosSeq (Collection elements) {
        super(DataWriterQos.class, elements);
    }
