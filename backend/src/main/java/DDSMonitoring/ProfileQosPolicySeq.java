...
/**
* A sequence of ProfileQosPolicy instances.
*/
public final class ProfileQosPolicySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ProfileQosPolicySeq() {
        super(ProfileQosPolicy.class);
    }

    public ProfileQosPolicySeq (int initialMaximum) {
        super(ProfileQosPolicy.class, initialMaximum);
    }

    public ProfileQosPolicySeq (Collection elements) {
        super(ProfileQosPolicy.class, elements);
    }
