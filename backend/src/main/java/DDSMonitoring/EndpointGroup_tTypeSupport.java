...
public class EndpointGroup_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::EndpointGroup_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EndpointGroup_tTypeSupport _singleton
    = new EndpointGroup_tTypeSupport();
    ...
    */
    public static EndpointGroup_tTypeSupport get_instance() {
        return _singleton;
    }

    public static EndpointGroup_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EndpointGroup_tTypeCode.VALUE;
    }

    public Object create_data() {
        return EndpointGroup_t.create();
    }
    ...
    * <code>this</code> is not a <code>EndpointGroup_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EndpointGroup_t typedDst = (EndpointGroup_t) destination;
        EndpointGroup_t typedSrc = (EndpointGroup_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EndpointGroup_t typedSrc = (EndpointGroup_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EndpointGroup_t typedDst = (EndpointGroup_t) dst;
            typedDst.role_name = src.readString(255);
            typedDst.quorum = src.readInt();
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EndpointGroup_t typedDst = (EndpointGroup_t) sample;
    ...
    protected EndpointGroup_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EndpointGroup_tTypeCode.VALUE,EndpointGroup_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EndpointGroup_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EndpointGroup_tTypeCode.VALUE,EndpointGroup_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
