...
public class RtpsWellKnownPorts_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::RtpsWellKnownPorts_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RtpsWellKnownPorts_tTypeSupport _singleton
    = new RtpsWellKnownPorts_tTypeSupport();
    ...
    */
    public static RtpsWellKnownPorts_tTypeSupport get_instance() {
        return _singleton;
    }

    public static RtpsWellKnownPorts_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RtpsWellKnownPorts_tTypeCode.VALUE;
    }

    public Object create_data() {
        return RtpsWellKnownPorts_t.create();
    }
    ...
    public Object create_key() {
        return new RtpsWellKnownPorts_t();
    }
    ...
    public Class get_type() {
        return RtpsWellKnownPorts_t.class;
    }
    ...
    * <code>this</code> is not a <code>RtpsWellKnownPorts_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RtpsWellKnownPorts_t typedDst = (RtpsWellKnownPorts_t) destination;
        RtpsWellKnownPorts_t typedSrc = (RtpsWellKnownPorts_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RtpsWellKnownPorts_t typedSrc = (RtpsWellKnownPorts_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.port_base);

            dst.writeInt(typedSrc.domain_id_gain);

            dst.writeInt(typedSrc.participant_id_gain);

            dst.writeInt(typedSrc.builtin_multicast_port_offset);

            dst.writeInt(typedSrc.builtin_unicast_port_offset);

            dst.writeInt(typedSrc.user_multicast_port_offset);

            dst.writeInt(typedSrc.user_unicast_port_offset);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RtpsWellKnownPorts_t typedDst = (RtpsWellKnownPorts_t) dst;
            typedDst.port_base = src.readInt();
            typedDst.domain_id_gain = src.readInt();
            typedDst.participant_id_gain = src.readInt();
            typedDst.builtin_multicast_port_offset = src.readInt();
            typedDst.builtin_unicast_port_offset = src.readInt();
            typedDst.user_multicast_port_offset = src.readInt();
            typedDst.user_unicast_port_offset = src.readInt();
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RtpsWellKnownPorts_t typedDst = (RtpsWellKnownPorts_t) sample;
    ...
    protected RtpsWellKnownPorts_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RtpsWellKnownPorts_tTypeCode.VALUE,RtpsWellKnownPorts_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RtpsWellKnownPorts_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RtpsWellKnownPorts_tTypeCode.VALUE,RtpsWellKnownPorts_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
