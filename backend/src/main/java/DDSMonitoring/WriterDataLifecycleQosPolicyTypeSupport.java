...
public class WriterDataLifecycleQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::WriterDataLifecycleQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WriterDataLifecycleQosPolicyTypeSupport _singleton
    = new WriterDataLifecycleQosPolicyTypeSupport();
    ...
    */
    public static WriterDataLifecycleQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static WriterDataLifecycleQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WriterDataLifecycleQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return WriterDataLifecycleQosPolicy.create();
    }
    ...
    public Class get_type() {
        return WriterDataLifecycleQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>WriterDataLifecycleQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WriterDataLifecycleQosPolicy typedDst = (WriterDataLifecycleQosPolicy) destination;
        WriterDataLifecycleQosPolicy typedSrc = (WriterDataLifecycleQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WriterDataLifecycleQosPolicy typedSrc = (WriterDataLifecycleQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.autopurge_unregistered_instances_delay);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.autodispose_unregistered_instances);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.autopurge_unregistered_instances_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        WriterDataLifecycleQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WriterDataLifecycleQosPolicy typedDst = (WriterDataLifecycleQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.autodispose_unregistered_instances = src.readBoolean();
                typedDst.autopurge_unregistered_instances_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.autopurge_unregistered_instances_delay, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        WriterDataLifecycleQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WriterDataLifecycleQosPolicy typedDst = (WriterDataLifecycleQosPolicy) sample;
    ...
    protected WriterDataLifecycleQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WriterDataLifecycleQosPolicyTypeCode.VALUE,WriterDataLifecycleQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WriterDataLifecycleQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WriterDataLifecycleQosPolicyTypeCode.VALUE,WriterDataLifecycleQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
