...
public class DataWriterResourceLimitsInstanceReplacementKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DataWriterResourceLimitsInstanceReplacementKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataWriterResourceLimitsInstanceReplacementKindTypeSupport _singleton
    = new DataWriterResourceLimitsInstanceReplacementKindTypeSupport();
    ...
    */
    public static DataWriterResourceLimitsInstanceReplacementKindTypeSupport get_instance() {
        return _singleton;
    }

    public static DataWriterResourceLimitsInstanceReplacementKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataWriterResourceLimitsInstanceReplacementKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return DataWriterResourceLimitsInstanceReplacementKind.class;
    }
    ...
    * <code>this</code> is not a <code>DataWriterResourceLimitsInstanceReplacementKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DataWriterResourceLimitsInstanceReplacementKind typedSrc = (DataWriterResourceLimitsInstanceReplacementKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = DataWriterResourceLimitsInstanceReplacementKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected DataWriterResourceLimitsInstanceReplacementKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataWriterResourceLimitsInstanceReplacementKindTypeCode.VALUE,DataWriterResourceLimitsInstanceReplacementKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
