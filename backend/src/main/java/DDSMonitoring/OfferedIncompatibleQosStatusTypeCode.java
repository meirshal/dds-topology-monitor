...
public class  OfferedIncompatibleQosStatusTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("DDSMonitoring::OfferedIncompatibleQosStatus",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
