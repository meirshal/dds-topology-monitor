...
public class SampleRejectedStatus   implements Copyable, Serializable{

    public int total_count= 0;
    public int total_count_change= 0;
    public DDSMonitoring.SampleRejectedStatusKind last_reason = (DDSMonitoring.SampleRejectedStatusKind)DDSMonitoring.SampleRejectedStatusKind.create();
    ...
    public SampleRejectedStatus (SampleRejectedStatus other) {
    ...
    public static Object create() {
        ...
        SampleRejectedStatus self;
        self = new  SampleRejectedStatus();
        self.clear();
        return self;
    ...
    public void clear() {
        ...
        last_reason = DDSMonitoring.SampleRejectedStatusKind.create();
    ...
    public boolean equals(Object o) {
        ...
        SampleRejectedStatus otherObj = (SampleRejectedStatus)o;
    ...
    * This method could be placed into <code>SampleRejectedStatusTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        SampleRejectedStatus typedSrc = (SampleRejectedStatus) src;
        SampleRejectedStatus typedDst = this;

        typedDst.total_count = typedSrc.total_count;
        typedDst.total_count_change = typedSrc.total_count_change;
        typedDst.last_reason = (DDSMonitoring.SampleRejectedStatusKind) typedDst.last_reason.copy_from(typedSrc.last_reason);
