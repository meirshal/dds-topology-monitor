...
public class RequestedIncompatibleQosStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::RequestedIncompatibleQosStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RequestedIncompatibleQosStatusTypeSupport _singleton
    = new RequestedIncompatibleQosStatusTypeSupport();
    ...
    */
    public static RequestedIncompatibleQosStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static RequestedIncompatibleQosStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RequestedIncompatibleQosStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return RequestedIncompatibleQosStatus.create();
    }
    ...
    public Class get_type() {
        return RequestedIncompatibleQosStatus.class;
    }
    ...
    * <code>this</code> is not a <code>RequestedIncompatibleQosStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RequestedIncompatibleQosStatus typedDst = (RequestedIncompatibleQosStatus) destination;
        RequestedIncompatibleQosStatus typedSrc = (RequestedIncompatibleQosStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RequestedIncompatibleQosStatus typedSrc = (RequestedIncompatibleQosStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RequestedIncompatibleQosStatus src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RequestedIncompatibleQosStatus typedDst = (RequestedIncompatibleQosStatus) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        RequestedIncompatibleQosStatus dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RequestedIncompatibleQosStatus typedDst = (RequestedIncompatibleQosStatus) sample;
    ...
    protected RequestedIncompatibleQosStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RequestedIncompatibleQosStatusTypeCode.VALUE,RequestedIncompatibleQosStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RequestedIncompatibleQosStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RequestedIncompatibleQosStatusTypeCode.VALUE,RequestedIncompatibleQosStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
