...
public class OwnershipQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::OwnershipQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OwnershipQosPolicyKindTypeSupport _singleton
    = new OwnershipQosPolicyKindTypeSupport();
    ...
    */
    public static OwnershipQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static OwnershipQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OwnershipQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return OwnershipQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>OwnershipQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        OwnershipQosPolicyKind typedSrc = (OwnershipQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = OwnershipQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected OwnershipQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OwnershipQosPolicyKindTypeCode.VALUE,OwnershipQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
