...
public class DurabilityQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DurabilityQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DurabilityQosPolicyTypeSupport _singleton
    = new DurabilityQosPolicyTypeSupport();
    ...
    */
    public static DurabilityQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DurabilityQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DurabilityQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DurabilityQosPolicy.create();
    }
    ...
    public Class get_type() {
        return DurabilityQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DurabilityQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DurabilityQosPolicy typedDst = (DurabilityQosPolicy) destination;
        DurabilityQosPolicy typedSrc = (DurabilityQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.DurabilityQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.DurabilityQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DurabilityQosPolicy typedSrc = (DurabilityQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.DurabilityQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.DurabilityQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeBoolean(typedSrc.direct_communication);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DurabilityQosPolicy typedDst = (DurabilityQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.DurabilityQosPolicyKind)DDSMonitoring.DurabilityQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
                typedDst.direct_communication = src.readBoolean();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.DurabilityQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DurabilityQosPolicy typedDst = (DurabilityQosPolicy) sample;
    ...
    protected DurabilityQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DurabilityQosPolicyTypeCode.VALUE,DurabilityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DurabilityQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DurabilityQosPolicyTypeCode.VALUE,DurabilityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
