...
public class DatabaseQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DatabaseQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DatabaseQosPolicyTypeSupport _singleton
    = new DatabaseQosPolicyTypeSupport();
    ...
    */
    public static DatabaseQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DatabaseQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DatabaseQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DatabaseQosPolicy.create();
    }
    ...
    public Class get_type() {
        return DatabaseQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DatabaseQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DatabaseQosPolicy typedDst = (DatabaseQosPolicy) destination;
        DatabaseQosPolicy typedSrc = (DatabaseQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DatabaseQosPolicy typedSrc = (DatabaseQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.shutdown_timeout);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.cleanup_period);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.shutdown_cleanup_period);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.shutdown_timeout, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cleanup_period, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.shutdown_cleanup_period, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberId = 4;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.initial_records);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 5;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.max_skiplist_level);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 6;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.table_allocation_block_size);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 7;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.max_weak_references);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 8;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.initial_weak_references);
            dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DatabaseQosPolicy typedDst = (DatabaseQosPolicy) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 1:
                    typedDst.shutdown_timeout = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.shutdown_timeout, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 2:
                    typedDst.cleanup_period = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cleanup_period, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 3:
                    typedDst.shutdown_cleanup_period = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.shutdown_cleanup_period, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 4:
                    typedDst.initial_records = src.readInt();
                    break;
                    case 5:
                    typedDst.max_skiplist_level = src.readInt();
                    break;
                    case 6:
                    typedDst.table_allocation_block_size = src.readInt();
                    break;
                    case 7:
                    typedDst.max_weak_references = src.readInt();
                    break;
                    case 8:
                    typedDst.initial_weak_references = src.readInt();
                    break;
                    default:
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DatabaseQosPolicy typedDst = (DatabaseQosPolicy) sample;
    ...
    protected DatabaseQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DatabaseQosPolicyTypeCode.VALUE,DatabaseQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DatabaseQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DatabaseQosPolicyTypeCode.VALUE,DatabaseQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
