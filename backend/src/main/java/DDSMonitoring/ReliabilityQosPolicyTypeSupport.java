...
public class ReliabilityQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReliabilityQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliabilityQosPolicyTypeSupport _singleton
    = new ReliabilityQosPolicyTypeSupport();
    ...
    */
    public static ReliabilityQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliabilityQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliabilityQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return ReliabilityQosPolicy.create();
    }
    ...
    public Class get_type() {
        return ReliabilityQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>ReliabilityQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReliabilityQosPolicy typedDst = (ReliabilityQosPolicy) destination;
        ReliabilityQosPolicy typedSrc = (ReliabilityQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ReliabilityQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += DDSMonitoring.ReliabilityQosPolicyAcknowledgementModeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ReliabilityQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += DDSMonitoring.ReliabilityQosPolicyAcknowledgementModeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReliabilityQosPolicy typedSrc = (ReliabilityQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.max_blocking_time);
        currentAlignment += DDSMonitoring.ReliabilityQosPolicyAcknowledgementModeKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.acknowledgementKind);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.ReliabilityQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.max_blocking_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.ReliabilityQosPolicyAcknowledgementModeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.acknowledgementKind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReliabilityQosPolicy typedDst = (ReliabilityQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.ReliabilityQosPolicyKind)DDSMonitoring.ReliabilityQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
                typedDst.max_blocking_time = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.max_blocking_time, src, false, true, endpoint_plugin_qos);     
                typedDst.acknowledgementKind = (DDSMonitoring.ReliabilityQosPolicyAcknowledgementModeKind)DDSMonitoring.ReliabilityQosPolicyAcknowledgementModeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.acknowledgementKind, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.ReliabilityQosPolicyAcknowledgementModeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReliabilityQosPolicy typedDst = (ReliabilityQosPolicy) sample;
    ...
    protected ReliabilityQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliabilityQosPolicyTypeCode.VALUE,ReliabilityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReliabilityQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReliabilityQosPolicyTypeCode.VALUE,ReliabilityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
