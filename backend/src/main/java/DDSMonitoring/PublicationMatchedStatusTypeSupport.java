...
public class PublicationMatchedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PublicationMatchedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PublicationMatchedStatusTypeSupport _singleton
    = new PublicationMatchedStatusTypeSupport();
    ...
    */
    public static PublicationMatchedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static PublicationMatchedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PublicationMatchedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return PublicationMatchedStatus.create();
    }
    ...
    public Class get_type() {
        return PublicationMatchedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>PublicationMatchedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PublicationMatchedStatus typedDst = (PublicationMatchedStatus) destination;
        PublicationMatchedStatus typedSrc = (PublicationMatchedStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PublicationMatchedStatus typedSrc = (PublicationMatchedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.last_subscription_handle);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().serialize(endpoint_data, typedSrc.last_subscription_handle, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PublicationMatchedStatus typedDst = (PublicationMatchedStatus) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.last_subscription_handle = (DDSMonitoring.RTIInstanceHandle)DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.last_subscription_handle, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PublicationMatchedStatus typedDst = (PublicationMatchedStatus) sample;
    ...
    protected PublicationMatchedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PublicationMatchedStatusTypeCode.VALUE,PublicationMatchedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PublicationMatchedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PublicationMatchedStatusTypeCode.VALUE,PublicationMatchedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
