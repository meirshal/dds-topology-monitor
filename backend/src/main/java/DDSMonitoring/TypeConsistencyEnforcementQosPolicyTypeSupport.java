...
public class TypeConsistencyEnforcementQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TypeConsistencyEnforcementQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TypeConsistencyEnforcementQosPolicyTypeSupport _singleton
    = new TypeConsistencyEnforcementQosPolicyTypeSupport();
    ...
    */
    public static TypeConsistencyEnforcementQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TypeConsistencyEnforcementQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TypeConsistencyEnforcementQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TypeConsistencyEnforcementQosPolicy.create();
    }
    ...
    public Class get_type() {
        return TypeConsistencyEnforcementQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TypeConsistencyEnforcementQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TypeConsistencyEnforcementQosPolicy typedDst = (TypeConsistencyEnforcementQosPolicy) destination;
        TypeConsistencyEnforcementQosPolicy typedSrc = (TypeConsistencyEnforcementQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TypeConsistencyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TypeConsistencyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TypeConsistencyEnforcementQosPolicy typedSrc = (TypeConsistencyEnforcementQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.TypeConsistencyKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.TypeConsistencyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        TypeConsistencyEnforcementQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TypeConsistencyEnforcementQosPolicy typedDst = (TypeConsistencyEnforcementQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.TypeConsistencyKind)DDSMonitoring.TypeConsistencyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        TypeConsistencyEnforcementQosPolicy dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.TypeConsistencyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TypeConsistencyEnforcementQosPolicy typedDst = (TypeConsistencyEnforcementQosPolicy) sample;
    ...
    protected TypeConsistencyEnforcementQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TypeConsistencyEnforcementQosPolicyTypeCode.VALUE,TypeConsistencyEnforcementQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TypeConsistencyEnforcementQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TypeConsistencyEnforcementQosPolicyTypeCode.VALUE,TypeConsistencyEnforcementQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
