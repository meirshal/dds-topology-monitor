...
public class DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DiscoveryBuiltinReaderFragmentationResourceLimits_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeSupport _singleton
    = new DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeSupport();
    ...
    */
    public static DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeSupport get_instance() {
        return _singleton;
    }

    public static DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeCode.VALUE;
    }

    public Object create_data() {
        return DiscoveryBuiltinReaderFragmentationResourceLimits_t.create();
    }
    ...
    public Object create_key() {
        return new DiscoveryBuiltinReaderFragmentationResourceLimits_t();
    }
    ...
    public Class get_type() {
        return DiscoveryBuiltinReaderFragmentationResourceLimits_t.class;
    }
    ...
    * <code>this</code> is not a <code>DiscoveryBuiltinReaderFragmentationResourceLimits_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiscoveryBuiltinReaderFragmentationResourceLimits_t typedDst = (DiscoveryBuiltinReaderFragmentationResourceLimits_t) destination;
        DiscoveryBuiltinReaderFragmentationResourceLimits_t typedSrc = (DiscoveryBuiltinReaderFragmentationResourceLimits_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiscoveryBuiltinReaderFragmentationResourceLimits_t typedSrc = (DiscoveryBuiltinReaderFragmentationResourceLimits_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DiscoveryBuiltinReaderFragmentationResourceLimits_t src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiscoveryBuiltinReaderFragmentationResourceLimits_t typedDst = (DiscoveryBuiltinReaderFragmentationResourceLimits_t) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        DiscoveryBuiltinReaderFragmentationResourceLimits_t dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiscoveryBuiltinReaderFragmentationResourceLimits_t typedDst = (DiscoveryBuiltinReaderFragmentationResourceLimits_t) sample;
    ...
    protected DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeCode.VALUE,DiscoveryBuiltinReaderFragmentationResourceLimits_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiscoveryBuiltinReaderFragmentationResourceLimits_tTypeCode.VALUE,DiscoveryBuiltinReaderFragmentationResourceLimits_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
