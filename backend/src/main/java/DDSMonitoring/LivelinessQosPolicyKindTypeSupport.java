...
public class LivelinessQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::LivelinessQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LivelinessQosPolicyKindTypeSupport _singleton
    = new LivelinessQosPolicyKindTypeSupport();
    ...
    */
    public static LivelinessQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static LivelinessQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LivelinessQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return LivelinessQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>LivelinessQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        LivelinessQosPolicyKind typedSrc = (LivelinessQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = LivelinessQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected LivelinessQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LivelinessQosPolicyKindTypeCode.VALUE,LivelinessQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
