...
public class DurabilityQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DurabilityQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DurabilityQosPolicyKindTypeSupport _singleton
    = new DurabilityQosPolicyKindTypeSupport();
    ...
    */
    public static DurabilityQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static DurabilityQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DurabilityQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return DurabilityQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>DurabilityQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DurabilityQosPolicyKind typedSrc = (DurabilityQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = DurabilityQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected DurabilityQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DurabilityQosPolicyKindTypeCode.VALUE,DurabilityQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
