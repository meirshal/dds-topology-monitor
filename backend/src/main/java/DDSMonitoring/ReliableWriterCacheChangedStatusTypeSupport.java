...
public class ReliableWriterCacheChangedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReliableWriterCacheChangedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliableWriterCacheChangedStatusTypeSupport _singleton
    = new ReliableWriterCacheChangedStatusTypeSupport();
    ...
    */
    public static ReliableWriterCacheChangedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliableWriterCacheChangedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliableWriterCacheChangedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return ReliableWriterCacheChangedStatus.create();
    }
    ...
    public Object create_key() {
        return new ReliableWriterCacheChangedStatus();
    }
    ...
    public Class get_type() {
        return ReliableWriterCacheChangedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>ReliableWriterCacheChangedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReliableWriterCacheChangedStatus typedDst = (ReliableWriterCacheChangedStatus) destination;
        ReliableWriterCacheChangedStatus typedSrc = (ReliableWriterCacheChangedStatus) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReliableWriterCacheChangedStatus typedSrc = (ReliableWriterCacheChangedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.empty_reliable_writer_cache);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.full_reliable_writer_cache);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.low_watermark_reliable_writer_cache);
        currentAlignment += DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.high_watermark_reliable_writer_cache);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().serialize(endpoint_data, typedSrc.empty_reliable_writer_cache, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().serialize(endpoint_data, typedSrc.full_reliable_writer_cache, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().serialize(endpoint_data, typedSrc.low_watermark_reliable_writer_cache, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().serialize(endpoint_data, typedSrc.high_watermark_reliable_writer_cache, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.unacknowledged_sample_count);

            dst.writeInt(typedSrc.unacknowledged_sample_count_peak);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReliableWriterCacheChangedStatus typedDst = (ReliableWriterCacheChangedStatus) dst;
            typedDst.clear();      
            try{
                typedDst.empty_reliable_writer_cache = (DDSMonitoring.ReliableWriterCacheEventCount)DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.empty_reliable_writer_cache, src, false, true, endpoint_plugin_qos);     
                typedDst.full_reliable_writer_cache = (DDSMonitoring.ReliableWriterCacheEventCount)DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.full_reliable_writer_cache, src, false, true, endpoint_plugin_qos);     
                typedDst.low_watermark_reliable_writer_cache = (DDSMonitoring.ReliableWriterCacheEventCount)DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.low_watermark_reliable_writer_cache, src, false, true, endpoint_plugin_qos);     
                typedDst.high_watermark_reliable_writer_cache = (DDSMonitoring.ReliableWriterCacheEventCount)DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.high_watermark_reliable_writer_cache, src, false, true, endpoint_plugin_qos);     
                typedDst.unacknowledged_sample_count = src.readInt();
                typedDst.unacknowledged_sample_count_peak = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        ReliableWriterCacheChangedStatus dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.ReliableWriterCacheEventCountTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReliableWriterCacheChangedStatus typedDst = (ReliableWriterCacheChangedStatus) sample;
    ...
    protected ReliableWriterCacheChangedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliableWriterCacheChangedStatusTypeCode.VALUE,ReliableWriterCacheChangedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReliableWriterCacheChangedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReliableWriterCacheChangedStatusTypeCode.VALUE,ReliableWriterCacheChangedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
