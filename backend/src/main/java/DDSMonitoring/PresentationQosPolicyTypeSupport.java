...
public class PresentationQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PresentationQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PresentationQosPolicyTypeSupport _singleton
    = new PresentationQosPolicyTypeSupport();
    ...
    */
    public static PresentationQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static PresentationQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PresentationQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return PresentationQosPolicy.create();
    }
    ...
    public Class get_type() {
        return PresentationQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>PresentationQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PresentationQosPolicy typedDst = (PresentationQosPolicy) destination;
        PresentationQosPolicy typedSrc = (PresentationQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.PresentationQosPolicyAccessScopeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.PresentationQosPolicyAccessScopeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PresentationQosPolicy typedSrc = (PresentationQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.PresentationQosPolicyAccessScopeKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.access_scope);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.PresentationQosPolicyAccessScopeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.access_scope, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeBoolean(typedSrc.coherent_access);

            dst.writeBoolean(typedSrc.ordered_access);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PresentationQosPolicy typedDst = (PresentationQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.access_scope = (DDSMonitoring.PresentationQosPolicyAccessScopeKind)DDSMonitoring.PresentationQosPolicyAccessScopeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.access_scope, src, false, true, endpoint_plugin_qos);     
                typedDst.coherent_access = src.readBoolean();
                typedDst.ordered_access = src.readBoolean();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.PresentationQosPolicyAccessScopeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PresentationQosPolicy typedDst = (PresentationQosPolicy) sample;
    ...
    protected PresentationQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PresentationQosPolicyTypeCode.VALUE,PresentationQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PresentationQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PresentationQosPolicyTypeCode.VALUE,PresentationQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
