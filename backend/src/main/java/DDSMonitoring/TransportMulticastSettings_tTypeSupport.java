...
public class TransportMulticastSettings_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportMulticastSettings_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportMulticastSettings_tTypeSupport _singleton
    = new TransportMulticastSettings_tTypeSupport();
    ...
    */
    public static TransportMulticastSettings_tTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportMulticastSettings_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportMulticastSettings_tTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportMulticastSettings_t.create();
    }
    ...
    public Object create_key() {
        return new TransportMulticastSettings_t();
    }
    ...
    public Class get_type() {
        return TransportMulticastSettings_t.class;
    }
    ...
    * <code>this</code> is not a <code>TransportMulticastSettings_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportMulticastSettings_t typedDst = (TransportMulticastSettings_t) destination;
        TransportMulticastSettings_t typedSrc = (TransportMulticastSettings_t) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (40)+1);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportMulticastSettings_t typedSrc = (TransportMulticastSettings_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.receive_address );
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.receive_address,40);

            dst.writeInt(typedSrc.receive_port);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportMulticastSettings_t typedDst = (TransportMulticastSettings_t) dst;
            src.readStringSequence(typedDst.transports, 128);
            typedDst.receive_address = src.readString(40);
            typedDst.receive_port = src.readInt();
        }
        if (deserialize_encapsulation) {
    ...
    public void deserialize_from_cdr_buffer(
        TransportMulticastSettings_t dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportMulticastSettings_t typedDst = (TransportMulticastSettings_t) sample;
    ...
    protected TransportMulticastSettings_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportMulticastSettings_tTypeCode.VALUE,TransportMulticastSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportMulticastSettings_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportMulticastSettings_tTypeCode.VALUE,TransportMulticastSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
