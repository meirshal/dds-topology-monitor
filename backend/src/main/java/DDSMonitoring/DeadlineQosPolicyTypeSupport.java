...
public class DeadlineQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DeadlineQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DeadlineQosPolicyTypeSupport _singleton
    = new DeadlineQosPolicyTypeSupport();
    ...
    */
    public static DeadlineQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DeadlineQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DeadlineQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DeadlineQosPolicy.create();
    }
    ...
    public Class get_type() {
        return DeadlineQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DeadlineQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DeadlineQosPolicy typedDst = (DeadlineQosPolicy) destination;
        DeadlineQosPolicy typedSrc = (DeadlineQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DeadlineQosPolicy typedSrc = (DeadlineQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.period);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DeadlineQosPolicy typedDst = (DeadlineQosPolicy) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DeadlineQosPolicy typedDst = (DeadlineQosPolicy) sample;
    ...
    protected DeadlineQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DeadlineQosPolicyTypeCode.VALUE,DeadlineQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DeadlineQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DeadlineQosPolicyTypeCode.VALUE,DeadlineQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
