...
public class TransportPriorityQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportPriorityQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportPriorityQosPolicyTypeSupport _singleton
    = new TransportPriorityQosPolicyTypeSupport();
    ...
    */
    public static TransportPriorityQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportPriorityQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportPriorityQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportPriorityQosPolicy.create();
    }
    ...
    public Class get_type() {
        return TransportPriorityQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TransportPriorityQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportPriorityQosPolicy typedDst = (TransportPriorityQosPolicy) destination;
        TransportPriorityQosPolicy typedSrc = (TransportPriorityQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportPriorityQosPolicy typedSrc = (TransportPriorityQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        TransportPriorityQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportPriorityQosPolicy typedDst = (TransportPriorityQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.value = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        TransportPriorityQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportPriorityQosPolicy typedDst = (TransportPriorityQosPolicy) sample;
    ...
    protected TransportPriorityQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportPriorityQosPolicyTypeCode.VALUE,TransportPriorityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportPriorityQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportPriorityQosPolicyTypeCode.VALUE,TransportPriorityQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
