...
public class DomainParticipantProtocolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DomainParticipantProtocolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DomainParticipantProtocolQosPolicyTypeSupport _singleton
    = new DomainParticipantProtocolQosPolicyTypeSupport();
    ...
    */
    public static DomainParticipantProtocolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DomainParticipantProtocolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DomainParticipantProtocolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DomainParticipantProtocolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new DomainParticipantProtocolQosPolicy();
    }
    ...
    public Class get_type() {
        return DomainParticipantProtocolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DomainParticipantProtocolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DomainParticipantProtocolQosPolicy typedDst = (DomainParticipantProtocolQosPolicy) destination;
        DomainParticipantProtocolQosPolicy typedSrc = (DomainParticipantProtocolQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DomainParticipantProtocolQosPolicy typedSrc = (DomainParticipantProtocolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DomainParticipantProtocolQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DomainParticipantProtocolQosPolicy typedDst = (DomainParticipantProtocolQosPolicy) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        DomainParticipantProtocolQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DomainParticipantProtocolQosPolicy typedDst = (DomainParticipantProtocolQosPolicy) sample;
    ...
    protected DomainParticipantProtocolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DomainParticipantProtocolQosPolicyTypeCode.VALUE,DomainParticipantProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DomainParticipantProtocolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DomainParticipantProtocolQosPolicyTypeCode.VALUE,DomainParticipantProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
