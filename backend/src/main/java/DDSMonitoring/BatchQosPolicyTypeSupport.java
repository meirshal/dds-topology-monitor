...
public class BatchQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::BatchQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatchQosPolicyTypeSupport _singleton
    = new BatchQosPolicyTypeSupport();
    ...
    */
    public static BatchQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static BatchQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatchQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return BatchQosPolicy.create();
    }
    ...
    * <code>this</code> is not a <code>BatchQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatchQosPolicy typedDst = (BatchQosPolicy) destination;
        BatchQosPolicy typedSrc = (BatchQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatchQosPolicy typedSrc = (BatchQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.max_flush_delay);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.source_timestamp_resolution);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.enable);

            dst.writeInt(typedSrc.max_data_bytes);

            dst.writeInt(typedSrc.max_meta_data_bytes);

            dst.writeInt(typedSrc.max_samples);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.max_flush_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.source_timestamp_resolution, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeBoolean(typedSrc.thread_safe_write);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatchQosPolicy typedDst = (BatchQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.enable = src.readBoolean();
                typedDst.max_data_bytes = src.readInt();
                typedDst.max_meta_data_bytes = src.readInt();
                typedDst.max_samples = src.readInt();
                typedDst.max_flush_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.max_flush_delay, src, false, true, endpoint_plugin_qos);     
                typedDst.source_timestamp_resolution = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.source_timestamp_resolution, src, false, true, endpoint_plugin_qos);     
                typedDst.thread_safe_write = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatchQosPolicy typedDst = (BatchQosPolicy) sample;
    ...
    protected BatchQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatchQosPolicyTypeCode.VALUE,BatchQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatchQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatchQosPolicyTypeCode.VALUE,BatchQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
