...
public class SampleRejectedStatusKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SampleRejectedStatusKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SampleRejectedStatusKindTypeSupport _singleton
    = new SampleRejectedStatusKindTypeSupport();
    ...
    */
    public static SampleRejectedStatusKindTypeSupport get_instance() {
        return _singleton;
    }

    public static SampleRejectedStatusKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SampleRejectedStatusKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return SampleRejectedStatusKind.class;
    }
    ...
    * <code>this</code> is not a <code>SampleRejectedStatusKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        SampleRejectedStatusKind typedSrc = (SampleRejectedStatusKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SampleRejectedStatusKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected SampleRejectedStatusKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SampleRejectedStatusKindTypeCode.VALUE,SampleRejectedStatusKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
