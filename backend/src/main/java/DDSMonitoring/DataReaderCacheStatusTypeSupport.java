...
public class DataReaderCacheStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DataReaderCacheStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataReaderCacheStatusTypeSupport _singleton
    = new DataReaderCacheStatusTypeSupport();
    ...
    */
    public static DataReaderCacheStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static DataReaderCacheStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataReaderCacheStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return DataReaderCacheStatus.create();
    }
    ...
    public Object create_key() {
        return new DataReaderCacheStatus();
    }
    ...
    public Class get_type() {
        return DataReaderCacheStatus.class;
    }
    ...
    * <code>this</code> is not a <code>DataReaderCacheStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataReaderCacheStatus typedDst = (DataReaderCacheStatus) destination;
        DataReaderCacheStatus typedSrc = (DataReaderCacheStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataReaderCacheStatus typedSrc = (DataReaderCacheStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.sample_count_peak);

            dst.writeLong(typedSrc.sample_count);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataReaderCacheStatus typedDst = (DataReaderCacheStatus) dst;
            typedDst.clear();      
            try{
                typedDst.sample_count_peak = src.readLong();
                typedDst.sample_count = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataReaderCacheStatus typedDst = (DataReaderCacheStatus) sample;
    ...
    protected DataReaderCacheStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataReaderCacheStatusTypeCode.VALUE,DataReaderCacheStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataReaderCacheStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataReaderCacheStatusTypeCode.VALUE,DataReaderCacheStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
