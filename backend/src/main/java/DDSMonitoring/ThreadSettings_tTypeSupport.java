...
public class ThreadSettings_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ThreadSettings_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThreadSettings_tTypeSupport _singleton
    = new ThreadSettings_tTypeSupport();
    ...
    */
    public static ThreadSettings_tTypeSupport get_instance() {
        return _singleton;
    }

    public static ThreadSettings_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ThreadSettings_tTypeCode.VALUE;
    }

    public Object create_data() {
        return ThreadSettings_t.create();
    }
    ...
    * <code>this</code> is not a <code>ThreadSettings_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ThreadSettings_t typedDst = (ThreadSettings_t) destination;
        ThreadSettings_t typedSrc = (ThreadSettings_t) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ThreadSettingsCpuRotationKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ThreadSettingsCpuRotationKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ThreadSettings_t typedSrc = (ThreadSettings_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.INT.getSequenceSerializedSize(
            currentAlignment , typedSrc.cpu_list );      
        currentAlignment += DDSMonitoring.ThreadSettingsCpuRotationKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.cpu_rotation);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.mask);

            dst.writeInt(typedSrc.priority);

            dst.writeInt(typedSrc.stack_size);

            dst.writeIntSeq(typedSrc.cpu_list,1024);

            DDSMonitoring.ThreadSettingsCpuRotationKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.cpu_rotation, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ThreadSettings_t typedDst = (ThreadSettings_t) dst;
            typedDst.clear();      
            try{
                typedDst.mask = src.readInt();
                typedDst.priority = src.readInt();
                typedDst.stack_size = src.readInt();
                src.readIntSequence(typedDst.cpu_list, 1024);
                typedDst.cpu_rotation = (DDSMonitoring.ThreadSettingsCpuRotationKind)DDSMonitoring.ThreadSettingsCpuRotationKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.cpu_rotation, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.ThreadSettingsCpuRotationKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ThreadSettings_t typedDst = (ThreadSettings_t) sample;
    ...
    protected ThreadSettings_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ThreadSettings_tTypeCode.VALUE,ThreadSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ThreadSettings_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ThreadSettings_tTypeCode.VALUE,ThreadSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
