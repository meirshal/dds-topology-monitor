...
/**
* A sequence of SampleInfo instances.
*/
public final class SampleInfoSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SampleInfoSeq (int initialMaximum) {
        super(SampleInfo.class, initialMaximum);
    }

    public SampleInfoSeq (Collection elements) {
        super(SampleInfo.class, elements);
    }
