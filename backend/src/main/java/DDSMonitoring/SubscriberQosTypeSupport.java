...
public class SubscriberQosTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SubscriberQos";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SubscriberQosTypeSupport _singleton
    = new SubscriberQosTypeSupport();
    ...
    */
    public static SubscriberQosTypeSupport get_instance() {
        return _singleton;
    }

    public static SubscriberQosTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SubscriberQosTypeCode.VALUE;
    }

    public Object create_data() {
        return SubscriberQos.create();
    }
    ...
    * <code>this</code> is not a <code>SubscriberQos</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SubscriberQos typedDst = (SubscriberQos) destination;
        SubscriberQos typedSrc = (SubscriberQos) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SubscriberProtocolQosPolicyTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SubscriberProtocolQosPolicyTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SubscriberQos typedSrc = (SubscriberQos) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SubscriberProtocolQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += DDSMonitoring.EntityNameQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.subscriber_name);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.SubscriberProtocolQosPolicyTypeSupport.get_instance().serialize(endpoint_data, typedSrc.protocol, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.EntityNameQosPolicyTypeSupport.get_instance().serialize(endpoint_data, typedSrc.subscriber_name, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SubscriberQos typedDst = (SubscriberQos) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 5:
                    typedDst.protocol = (DDSMonitoring.SubscriberProtocolQosPolicy)DDSMonitoring.SubscriberProtocolQosPolicyTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.protocol, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 6:
                    typedDst.subscriber_name = (DDSMonitoring.EntityNameQosPolicy)DDSMonitoring.EntityNameQosPolicyTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.subscriber_name, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 5:
                    DDSMonitoring.SubscriberProtocolQosPolicyTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SubscriberQos typedDst = (SubscriberQos) sample;
    ...
    protected SubscriberQosTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SubscriberQosTypeCode.VALUE,SubscriberQos.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SubscriberQosTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SubscriberQosTypeCode.VALUE,SubscriberQos.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
