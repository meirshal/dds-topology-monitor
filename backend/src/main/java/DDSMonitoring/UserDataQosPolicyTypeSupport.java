...
public class UserDataQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::UserDataQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UserDataQosPolicyTypeSupport _singleton
    = new UserDataQosPolicyTypeSupport();
    ...
    */
    public static UserDataQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static UserDataQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UserDataQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return UserDataQosPolicy.create();
    }
    ...
    public Class get_type() {
        return UserDataQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>UserDataQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UserDataQosPolicy typedDst = (UserDataQosPolicy) destination;
        UserDataQosPolicy typedSrc = (UserDataQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        UserDataQosPolicy typedSrc = (UserDataQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UserDataQosPolicy typedDst = (UserDataQosPolicy) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UserDataQosPolicy typedDst = (UserDataQosPolicy) sample;
    ...
    protected UserDataQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UserDataQosPolicyTypeCode.VALUE,UserDataQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UserDataQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UserDataQosPolicyTypeCode.VALUE,UserDataQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
