...
public class ProductVersion_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ProductVersion_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProductVersion_tTypeSupport _singleton
    = new ProductVersion_tTypeSupport();
    ...
    */
    public static ProductVersion_tTypeSupport get_instance() {
        return _singleton;
    }

    public static ProductVersion_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProductVersion_tTypeCode.VALUE;
    }

    public Object create_data() {
        return ProductVersion_t.create();
    }
    ...
    * <code>this</code> is not a <code>ProductVersion_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProductVersion_t typedDst = (ProductVersion_t) destination;
        ProductVersion_t typedSrc = (ProductVersion_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProductVersion_t typedSrc = (ProductVersion_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeChar(typedSrc.major);

            dst.writeChar(typedSrc.minor);

            dst.writeChar(typedSrc.release);

            dst.writeChar(typedSrc.revision);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProductVersion_t typedDst = (ProductVersion_t) dst;
            typedDst.clear();      
            try{
                typedDst.major = src.readChar();
                typedDst.minor = src.readChar();
                typedDst.release = src.readChar();
                typedDst.revision = src.readChar();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProductVersion_t typedDst = (ProductVersion_t) sample;
    ...
    protected ProductVersion_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProductVersion_tTypeCode.VALUE,ProductVersion_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProductVersion_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProductVersion_tTypeCode.VALUE,ProductVersion_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
