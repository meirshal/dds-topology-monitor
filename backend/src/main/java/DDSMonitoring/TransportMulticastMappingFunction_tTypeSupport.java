...
public class TransportMulticastMappingFunction_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportMulticastMappingFunction_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportMulticastMappingFunction_tTypeSupport _singleton
    = new TransportMulticastMappingFunction_tTypeSupport();
    ...
    */
    public static TransportMulticastMappingFunction_tTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportMulticastMappingFunction_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportMulticastMappingFunction_tTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportMulticastMappingFunction_t.create();
    }
    ...
    public Object create_key() {
        return new TransportMulticastMappingFunction_t();
    }
    ...
    public Class get_type() {
        return TransportMulticastMappingFunction_t.class;
    }
    ...
    * <code>this</code> is not a <code>TransportMulticastMappingFunction_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportMulticastMappingFunction_t typedDst = (TransportMulticastMappingFunction_t) destination;
        TransportMulticastMappingFunction_t typedSrc = (TransportMulticastMappingFunction_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportMulticastMappingFunction_t typedSrc = (TransportMulticastMappingFunction_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.dll );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.function_name );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.dll,(DDSMonitoring.TRANSPORT_MULICAST_MAPPING_STRING_MAX_LENGTH.VALUE));

            dst.writeString(typedSrc.function_name,(DDSMonitoring.TRANSPORT_MULICAST_MAPPING_STRING_MAX_LENGTH.VALUE));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportMulticastMappingFunction_t typedDst = (TransportMulticastMappingFunction_t) dst;
            typedDst.dll = src.readString((DDSMonitoring.TRANSPORT_MULICAST_MAPPING_STRING_MAX_LENGTH.VALUE));
            typedDst.function_name = src.readString((DDSMonitoring.TRANSPORT_MULICAST_MAPPING_STRING_MAX_LENGTH.VALUE));
        }
        if (deserialize_encapsulation) {
    ...
    public void deserialize_from_cdr_buffer(
        TransportMulticastMappingFunction_t dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportMulticastMappingFunction_t typedDst = (TransportMulticastMappingFunction_t) sample;
    ...
    protected TransportMulticastMappingFunction_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportMulticastMappingFunction_tTypeCode.VALUE,TransportMulticastMappingFunction_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportMulticastMappingFunction_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportMulticastMappingFunction_tTypeCode.VALUE,TransportMulticastMappingFunction_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
