...
/**
* A sequence of ProductVersion_t instances.
*/
public final class ProductVersion_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ProductVersion_tSeq() {
        super(ProductVersion_t.class);
    }

    public ProductVersion_tSeq (int initialMaximum) {
        super(ProductVersion_t.class, initialMaximum);
    }

    public ProductVersion_tSeq (Collection elements) {
        super(ProductVersion_t.class, elements);
    }
