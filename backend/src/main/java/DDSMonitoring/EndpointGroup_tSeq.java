...
/**
* A sequence of EndpointGroup_t instances.
*/
public final class EndpointGroup_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EndpointGroup_tSeq() {
        super(EndpointGroup_t.class);
    }

    public EndpointGroup_tSeq (int initialMaximum) {
        super(EndpointGroup_t.class, initialMaximum);
    }

    public EndpointGroup_tSeq (Collection elements) {
        super(EndpointGroup_t.class, elements);
    }
