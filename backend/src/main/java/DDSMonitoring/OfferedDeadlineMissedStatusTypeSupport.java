...
public class OfferedDeadlineMissedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::OfferedDeadlineMissedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OfferedDeadlineMissedStatusTypeSupport _singleton
    = new OfferedDeadlineMissedStatusTypeSupport();
    ...
    */
    public static OfferedDeadlineMissedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static OfferedDeadlineMissedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OfferedDeadlineMissedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return OfferedDeadlineMissedStatus.create();
    }
    ...
    public Class get_type() {
        return OfferedDeadlineMissedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>OfferedDeadlineMissedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OfferedDeadlineMissedStatus typedDst = (OfferedDeadlineMissedStatus) destination;
        OfferedDeadlineMissedStatus typedSrc = (OfferedDeadlineMissedStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OfferedDeadlineMissedStatus typedSrc = (OfferedDeadlineMissedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        OfferedDeadlineMissedStatus src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OfferedDeadlineMissedStatus typedDst = (OfferedDeadlineMissedStatus) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        OfferedDeadlineMissedStatus dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OfferedDeadlineMissedStatus typedDst = (OfferedDeadlineMissedStatus) sample;
    ...
    protected OfferedDeadlineMissedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OfferedDeadlineMissedStatusTypeCode.VALUE,OfferedDeadlineMissedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OfferedDeadlineMissedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OfferedDeadlineMissedStatusTypeCode.VALUE,OfferedDeadlineMissedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
