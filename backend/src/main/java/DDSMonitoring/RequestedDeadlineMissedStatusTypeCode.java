...
public class  RequestedDeadlineMissedStatusTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("DDSMonitoring::RequestedDeadlineMissedStatus",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
