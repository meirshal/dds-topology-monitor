...
public class AsynchronousPublisherQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::AsynchronousPublisherQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AsynchronousPublisherQosPolicyTypeSupport _singleton
    = new AsynchronousPublisherQosPolicyTypeSupport();
    ...
    */
    public static AsynchronousPublisherQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static AsynchronousPublisherQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AsynchronousPublisherQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return AsynchronousPublisherQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new AsynchronousPublisherQosPolicy();
    }
    ...
    public Class get_type() {
        return AsynchronousPublisherQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>AsynchronousPublisherQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AsynchronousPublisherQosPolicy typedDst = (AsynchronousPublisherQosPolicy) destination;
        AsynchronousPublisherQosPolicy typedSrc = (AsynchronousPublisherQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ThreadBlockingKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment += DDSMonitoring.ThreadBlockingKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        AsynchronousPublisherQosPolicy typedSrc = (AsynchronousPublisherQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.thread);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.asynchronous_batch_thread);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment += DDSMonitoring.ThreadBlockingKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.asynchronous_batch_blocking_kind);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.disable_asynchronous_write);
            ...
            DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.thread, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
            ...
            memberId = 2;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.disable_asynchronous_batch);
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.asynchronous_batch_thread, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberId = 4;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            DDSMonitoring.ThreadBlockingKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.asynchronous_batch_blocking_kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            dst.writeMemberLength(memberLengthPosition, false);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        AsynchronousPublisherQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AsynchronousPublisherQosPolicy typedDst = (AsynchronousPublisherQosPolicy) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.disable_asynchronous_write = src.readBoolean();
                    break;
                    case 1:
                    typedDst.thread = (DDSMonitoring.ThreadSettings_t)DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.thread, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 2:
                    typedDst.disable_asynchronous_batch = src.readBoolean();
                    break;
                    case 3:
                    typedDst.asynchronous_batch_thread = (DDSMonitoring.ThreadSettings_t)DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.asynchronous_batch_thread, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 4:
                    typedDst.asynchronous_batch_blocking_kind = (DDSMonitoring.ThreadBlockingKind)DDSMonitoring.ThreadBlockingKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.asynchronous_batch_blocking_kind, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        AsynchronousPublisherQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 1:
                    DDSMonitoring.ThreadSettings_tTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
                    ...
                    case 4:
                    DDSMonitoring.ThreadBlockingKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AsynchronousPublisherQosPolicy typedDst = (AsynchronousPublisherQosPolicy) sample;
    ...
    protected AsynchronousPublisherQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AsynchronousPublisherQosPolicyTypeCode.VALUE,AsynchronousPublisherQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AsynchronousPublisherQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AsynchronousPublisherQosPolicyTypeCode.VALUE,AsynchronousPublisherQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
