...
public class DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DomainParticipantResourceLimitsIgnoredEntityReplacementKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeSupport _singleton
    = new DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeSupport();
    ...
    */
    public static DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeSupport get_instance() {
        return _singleton;
    }

    public static DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return DomainParticipantResourceLimitsIgnoredEntityReplacementKind.class;
    }
    ...
    * <code>this</code> is not a <code>DomainParticipantResourceLimitsIgnoredEntityReplacementKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DomainParticipantResourceLimitsIgnoredEntityReplacementKind typedSrc = (DomainParticipantResourceLimitsIgnoredEntityReplacementKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = DomainParticipantResourceLimitsIgnoredEntityReplacementKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DomainParticipantResourceLimitsIgnoredEntityReplacementKindTypeCode.VALUE,DomainParticipantResourceLimitsIgnoredEntityReplacementKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
