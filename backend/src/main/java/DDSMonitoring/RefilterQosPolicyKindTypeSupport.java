...
public class RefilterQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::RefilterQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RefilterQosPolicyKindTypeSupport _singleton
    = new RefilterQosPolicyKindTypeSupport();
    ...
    */
    public static RefilterQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static RefilterQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RefilterQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RefilterQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>RefilterQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        RefilterQosPolicyKind typedSrc = (RefilterQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RefilterQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected RefilterQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RefilterQosPolicyKindTypeCode.VALUE,RefilterQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
