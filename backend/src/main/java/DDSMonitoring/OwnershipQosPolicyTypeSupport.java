...
public class OwnershipQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::OwnershipQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OwnershipQosPolicyTypeSupport _singleton
    = new OwnershipQosPolicyTypeSupport();
    ...
    */
    public static OwnershipQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static OwnershipQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OwnershipQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return OwnershipQosPolicy.create();
    }
    ...
    public Class get_type() {
        return OwnershipQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>OwnershipQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OwnershipQosPolicy typedDst = (OwnershipQosPolicy) destination;
        OwnershipQosPolicy typedSrc = (OwnershipQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.OwnershipQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.OwnershipQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OwnershipQosPolicy typedSrc = (OwnershipQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.OwnershipQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.OwnershipQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OwnershipQosPolicy typedDst = (OwnershipQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.OwnershipQosPolicyKind)DDSMonitoring.OwnershipQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.OwnershipQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OwnershipQosPolicy typedDst = (OwnershipQosPolicy) sample;
    ...
    protected OwnershipQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OwnershipQosPolicyTypeCode.VALUE,OwnershipQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OwnershipQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OwnershipQosPolicyTypeCode.VALUE,OwnershipQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
