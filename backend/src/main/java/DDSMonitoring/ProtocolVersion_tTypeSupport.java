...
public class ProtocolVersion_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ProtocolVersion_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProtocolVersion_tTypeSupport _singleton
    = new ProtocolVersion_tTypeSupport();
    ...
    */
    public static ProtocolVersion_tTypeSupport get_instance() {
        return _singleton;
    }

    public static ProtocolVersion_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProtocolVersion_tTypeCode.VALUE;
    }

    public Object create_data() {
        return ProtocolVersion_t.create();
    }
    ...
    public Class get_type() {
        return ProtocolVersion_t.class;
    }
    ...
    * <code>this</code> is not a <code>ProtocolVersion_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProtocolVersion_t typedDst = (ProtocolVersion_t) destination;
        ProtocolVersion_t typedSrc = (ProtocolVersion_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProtocolVersion_t typedSrc = (ProtocolVersion_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByte(typedSrc.major);

            dst.writeByte(typedSrc.minor);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProtocolVersion_t typedDst = (ProtocolVersion_t) dst;
            typedDst.clear();      
            try{
                typedDst.major = src.readByte();
                typedDst.minor = src.readByte();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProtocolVersion_t typedDst = (ProtocolVersion_t) sample;
    ...
    protected ProtocolVersion_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProtocolVersion_tTypeCode.VALUE,ProtocolVersion_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProtocolVersion_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProtocolVersion_tTypeCode.VALUE,ProtocolVersion_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
