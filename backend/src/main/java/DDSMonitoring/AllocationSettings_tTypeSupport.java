...
public class AllocationSettings_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::AllocationSettings_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final AllocationSettings_tTypeSupport _singleton
    = new AllocationSettings_tTypeSupport();
    ...
    */
    public static AllocationSettings_tTypeSupport get_instance() {
        return _singleton;
    }

    public static AllocationSettings_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return AllocationSettings_tTypeCode.VALUE;
    }

    public Object create_data() {
        return AllocationSettings_t.create();
    }
    ...
    public Object create_key() {
        return new AllocationSettings_t();
    }
    ...
    public Class get_type() {
        return AllocationSettings_t.class;
    }
    ...
    * <code>this</code> is not a <code>AllocationSettings_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        AllocationSettings_t typedDst = (AllocationSettings_t) destination;
        AllocationSettings_t typedSrc = (AllocationSettings_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        AllocationSettings_t typedSrc = (AllocationSettings_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.incremental_count);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            AllocationSettings_t typedDst = (AllocationSettings_t) dst;
            typedDst.initial_count = src.readInt();
            typedDst.max_count = src.readInt();
            typedDst.incremental_count = src.readInt();
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            AllocationSettings_t typedDst = (AllocationSettings_t) sample;
    ...
    protected AllocationSettings_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,AllocationSettings_tTypeCode.VALUE,AllocationSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected AllocationSettings_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,AllocationSettings_tTypeCode.VALUE,AllocationSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
