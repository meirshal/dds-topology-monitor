...
public class TransportEncapsulationSettings_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportEncapsulationSettings_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportEncapsulationSettings_tTypeSupport _singleton
    = new TransportEncapsulationSettings_tTypeSupport();
    ...
    */
    public static TransportEncapsulationSettings_tTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportEncapsulationSettings_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportEncapsulationSettings_tTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportEncapsulationSettings_t.create();
    }
    ...
    public Object create_key() {
        return new TransportEncapsulationSettings_t();
    }
    ...
    public Class get_type() {
        return TransportEncapsulationSettings_t.class;
    }
    ...
    * <code>this</code> is not a <code>TransportEncapsulationSettings_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportEncapsulationSettings_t typedDst = (TransportEncapsulationSettings_t) destination;
        TransportEncapsulationSettings_t typedSrc = (TransportEncapsulationSettings_t) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.SHORT.getSequenceMaxSizeSerialized(currentAlignment, 8);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportEncapsulationSettings_t typedSrc = (TransportEncapsulationSettings_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSeqSerializedSize(
            currentAlignment , typedSrc.transports );
        currentAlignment  +=   CdrPrimitiveType.SHORT.getSequenceSerializedSize(
            currentAlignment , typedSrc.encapsulations );      
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.transports,(128),128);

            dst.writeShortSeq(typedSrc.encapsulations,8);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        TransportEncapsulationSettings_t src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportEncapsulationSettings_t typedDst = (TransportEncapsulationSettings_t) dst;
            src.readStringSequence(typedDst.transports, 128);
            src.readShortSequence(typedDst.encapsulations, 8);
        }
        if (deserialize_encapsulation) {
    ...
    public void deserialize_from_cdr_buffer(
        TransportEncapsulationSettings_t dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportEncapsulationSettings_t typedDst = (TransportEncapsulationSettings_t) sample;
    ...
    protected TransportEncapsulationSettings_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportEncapsulationSettings_tTypeCode.VALUE,TransportEncapsulationSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportEncapsulationSettings_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportEncapsulationSettings_tTypeCode.VALUE,TransportEncapsulationSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
