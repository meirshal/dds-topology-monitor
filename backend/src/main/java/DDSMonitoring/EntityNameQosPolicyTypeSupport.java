...
public class EntityNameQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::EntityNameQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EntityNameQosPolicyTypeSupport _singleton
    = new EntityNameQosPolicyTypeSupport();
    ...
    */
    public static EntityNameQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static EntityNameQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EntityNameQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return EntityNameQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new EntityNameQosPolicy();
    }
    ...
    public Class get_type() {
        return EntityNameQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>EntityNameQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EntityNameQosPolicy typedDst = (EntityNameQosPolicy) destination;
        EntityNameQosPolicy typedSrc = (EntityNameQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EntityNameQosPolicy typedSrc = (EntityNameQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.role_name );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.role_name,255);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EntityNameQosPolicy typedDst = (EntityNameQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.name = src.readString(255);
                typedDst.role_name = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EntityNameQosPolicy typedDst = (EntityNameQosPolicy) sample;
    ...
    protected EntityNameQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EntityNameQosPolicyTypeCode.VALUE,EntityNameQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EntityNameQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EntityNameQosPolicyTypeCode.VALUE,EntityNameQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
