...
public class RtpsReliableReaderProtocol_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::RtpsReliableReaderProtocol_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RtpsReliableReaderProtocol_tTypeSupport _singleton
    = new RtpsReliableReaderProtocol_tTypeSupport();
    ...
    */
    public static RtpsReliableReaderProtocol_tTypeSupport get_instance() {
        return _singleton;
    }

    public static RtpsReliableReaderProtocol_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RtpsReliableReaderProtocol_tTypeCode.VALUE;
    }

    public Object create_data() {
        return RtpsReliableReaderProtocol_t.create();
    }
    ...
    public Object create_key() {
        return new RtpsReliableReaderProtocol_t();
    }
    ...
    public Class get_type() {
        return RtpsReliableReaderProtocol_t.class;
    }
    ...
    * <code>this</code> is not a <code>RtpsReliableReaderProtocol_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RtpsReliableReaderProtocol_t typedDst = (RtpsReliableReaderProtocol_t) destination;
        RtpsReliableReaderProtocol_t typedSrc = (RtpsReliableReaderProtocol_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RtpsReliableReaderProtocol_t typedSrc = (RtpsReliableReaderProtocol_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.min_heartbeat_response_delay);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.max_heartbeat_response_delay);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.heartbeat_suppression_duration);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.nack_period);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.round_trip_time);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.app_ack_period);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.min_app_ack_response_keep_duration);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.min_heartbeat_response_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.max_heartbeat_response_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.heartbeat_suppression_duration, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.nack_period, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.receive_window_size);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.round_trip_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.app_ack_period, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.min_app_ack_response_keep_duration, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.samples_per_app_ack);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RtpsReliableReaderProtocol_t src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RtpsReliableReaderProtocol_t typedDst = (RtpsReliableReaderProtocol_t) dst;
            typedDst.clear();      
            try{
                typedDst.min_heartbeat_response_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.min_heartbeat_response_delay, src, false, true, endpoint_plugin_qos);     
                typedDst.max_heartbeat_response_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.max_heartbeat_response_delay, src, false, true, endpoint_plugin_qos);     
                typedDst.heartbeat_suppression_duration = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.heartbeat_suppression_duration, src, false, true, endpoint_plugin_qos);     
                typedDst.nack_period = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.nack_period, src, false, true, endpoint_plugin_qos);     
                typedDst.receive_window_size = src.readInt();
                typedDst.round_trip_time = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.round_trip_time, src, false, true, endpoint_plugin_qos);     
                typedDst.app_ack_period = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.app_ack_period, src, false, true, endpoint_plugin_qos);     
                typedDst.min_app_ack_response_keep_duration = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.min_app_ack_response_keep_duration, src, false, true, endpoint_plugin_qos);     
                typedDst.samples_per_app_ack = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        RtpsReliableReaderProtocol_t dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RtpsReliableReaderProtocol_t typedDst = (RtpsReliableReaderProtocol_t) sample;
    ...
    protected RtpsReliableReaderProtocol_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RtpsReliableReaderProtocol_tTypeCode.VALUE,RtpsReliableReaderProtocol_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RtpsReliableReaderProtocol_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RtpsReliableReaderProtocol_tTypeCode.VALUE,RtpsReliableReaderProtocol_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
