...
public class DestinationOrderQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DestinationOrderQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DestinationOrderQosPolicyTypeSupport _singleton
    = new DestinationOrderQosPolicyTypeSupport();
    ...
    */
    public static DestinationOrderQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DestinationOrderQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DestinationOrderQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DestinationOrderQosPolicy.create();
    }
    ...
    public Class get_type() {
        return DestinationOrderQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DestinationOrderQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DestinationOrderQosPolicy typedDst = (DestinationOrderQosPolicy) destination;
        DestinationOrderQosPolicy typedSrc = (DestinationOrderQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.DestinationOrderQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.DestinationOrderQosPolicyScopeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.DestinationOrderQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.DestinationOrderQosPolicyScopeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DestinationOrderQosPolicy typedSrc = (DestinationOrderQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.DestinationOrderQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.kind);
        currentAlignment += DDSMonitoring.DestinationOrderQosPolicyScopeKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.scope);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.source_timestamp_tolerance);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.DestinationOrderQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.DestinationOrderQosPolicyScopeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.scope, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.source_timestamp_tolerance, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DestinationOrderQosPolicy typedDst = (DestinationOrderQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.DestinationOrderQosPolicyKind)DDSMonitoring.DestinationOrderQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
                typedDst.scope = (DDSMonitoring.DestinationOrderQosPolicyScopeKind)DDSMonitoring.DestinationOrderQosPolicyScopeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scope, src, false, true, endpoint_plugin_qos);     
                typedDst.source_timestamp_tolerance = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.source_timestamp_tolerance, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.DestinationOrderQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            DDSMonitoring.DestinationOrderQosPolicyScopeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DestinationOrderQosPolicy typedDst = (DestinationOrderQosPolicy) sample;
    ...
    protected DestinationOrderQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DestinationOrderQosPolicyTypeCode.VALUE,DestinationOrderQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DestinationOrderQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DestinationOrderQosPolicyTypeCode.VALUE,DestinationOrderQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
