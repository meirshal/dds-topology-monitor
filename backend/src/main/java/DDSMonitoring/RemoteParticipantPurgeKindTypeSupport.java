...
public class RemoteParticipantPurgeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::RemoteParticipantPurgeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RemoteParticipantPurgeKindTypeSupport _singleton
    = new RemoteParticipantPurgeKindTypeSupport();
    ...
    */
    public static RemoteParticipantPurgeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static RemoteParticipantPurgeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RemoteParticipantPurgeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return RemoteParticipantPurgeKind.class;
    }
    ...
    * <code>this</code> is not a <code>RemoteParticipantPurgeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        RemoteParticipantPurgeKind typedSrc = (RemoteParticipantPurgeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = RemoteParticipantPurgeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected RemoteParticipantPurgeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RemoteParticipantPurgeKindTypeCode.VALUE,RemoteParticipantPurgeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
