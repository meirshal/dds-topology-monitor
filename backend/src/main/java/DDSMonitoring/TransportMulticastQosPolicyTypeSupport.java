...
public class TransportMulticastQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportMulticastQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportMulticastQosPolicyTypeSupport _singleton
    = new TransportMulticastQosPolicyTypeSupport();
    ...
    */
    public static TransportMulticastQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportMulticastQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportMulticastQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportMulticastQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TransportMulticastQosPolicy();
    }
    ...
    public Class get_type() {
        return TransportMulticastQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TransportMulticastQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportMulticastQosPolicy typedDst = (TransportMulticastQosPolicy) destination;
        TransportMulticastQosPolicy typedSrc = (TransportMulticastQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        currentAlignment += DDSMonitoring.TransportMulticastQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
        currentAlignment += DDSMonitoring.TransportMulticastQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportMulticastQosPolicy typedSrc = (TransportMulticastQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.value);
        currentAlignment += DDSMonitoring.TransportMulticastQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.value,4, endpoint_plugin_qos);

            DDSMonitoring.TransportMulticastQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        TransportMulticastQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportMulticastQosPolicy typedDst = (TransportMulticastQosPolicy) dst;
            typedDst.clear();      
            try{
                DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.value, src, 4, endpoint_plugin_qos);            
                typedDst.kind = (DDSMonitoring.TransportMulticastQosPolicyKind)DDSMonitoring.TransportMulticastQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        TransportMulticastQosPolicy dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);

            DDSMonitoring.TransportMulticastQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportMulticastQosPolicy typedDst = (TransportMulticastQosPolicy) sample;
    ...
    protected TransportMulticastQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportMulticastQosPolicyTypeCode.VALUE,TransportMulticastQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportMulticastQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportMulticastQosPolicyTypeCode.VALUE,TransportMulticastQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
