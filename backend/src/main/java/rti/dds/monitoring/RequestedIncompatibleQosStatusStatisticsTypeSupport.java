...
* RequestedIncompatibleQosStatusStatistics
*/

public class RequestedIncompatibleQosStatusStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::RequestedIncompatibleQosStatusStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RequestedIncompatibleQosStatusStatisticsTypeSupport _singleton
    = new RequestedIncompatibleQosStatusStatisticsTypeSupport();
    ...
    */
    public static RequestedIncompatibleQosStatusStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static RequestedIncompatibleQosStatusStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RequestedIncompatibleQosStatusStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return RequestedIncompatibleQosStatusStatistics.create();
    }
    ...
    public Object create_key() {
        return new RequestedIncompatibleQosStatusStatistics();
    }
    ...
    public Class get_type() {
        return RequestedIncompatibleQosStatusStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>RequestedIncompatibleQosStatusStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RequestedIncompatibleQosStatusStatistics typedDst = (RequestedIncompatibleQosStatusStatistics) destination;
        RequestedIncompatibleQosStatusStatistics typedSrc = (RequestedIncompatibleQosStatusStatistics) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.RequestedIncompatibleQosStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.RequestedIncompatibleQosStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RequestedIncompatibleQosStatusStatistics typedSrc = (RequestedIncompatibleQosStatusStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.RequestedIncompatibleQosStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.RequestedIncompatibleQosStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RequestedIncompatibleQosStatusStatistics src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RequestedIncompatibleQosStatusStatistics typedDst = (RequestedIncompatibleQosStatusStatistics) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.status = (DDSMonitoring.RequestedIncompatibleQosStatus)DDSMonitoring.RequestedIncompatibleQosStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        RequestedIncompatibleQosStatusStatistics dst,
        byte[] buffer,
        long length) 
    {
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    DDSMonitoring.RequestedIncompatibleQosStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RequestedIncompatibleQosStatusStatistics typedDst = (RequestedIncompatibleQosStatusStatistics) sample;
    ...
    protected RequestedIncompatibleQosStatusStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RequestedIncompatibleQosStatusStatisticsTypeCode.VALUE,RequestedIncompatibleQosStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RequestedIncompatibleQosStatusStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RequestedIncompatibleQosStatusStatisticsTypeCode.VALUE,RequestedIncompatibleQosStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
