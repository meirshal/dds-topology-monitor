...
* ReliableReaderActivityChangedStatusStatistics
*/

public class ReliableReaderActivityChangedStatusStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::ReliableReaderActivityChangedStatusStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliableReaderActivityChangedStatusStatisticsTypeSupport _singleton
    = new ReliableReaderActivityChangedStatusStatisticsTypeSupport();
    ...
    */
    public static ReliableReaderActivityChangedStatusStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliableReaderActivityChangedStatusStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliableReaderActivityChangedStatusStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return ReliableReaderActivityChangedStatusStatistics.create();
    }
    ...
    public Object create_key() {
        return new ReliableReaderActivityChangedStatusStatistics();
    }
    ...
    public Class get_type() {
        return ReliableReaderActivityChangedStatusStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>ReliableReaderActivityChangedStatusStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReliableReaderActivityChangedStatusStatistics typedDst = (ReliableReaderActivityChangedStatusStatistics) destination;
        ReliableReaderActivityChangedStatusStatistics typedSrc = (ReliableReaderActivityChangedStatusStatistics) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ReliableReaderActivityChangedStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ReliableReaderActivityChangedStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReliableReaderActivityChangedStatusStatistics typedSrc = (ReliableReaderActivityChangedStatusStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ReliableReaderActivityChangedStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.status);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.ReliableReaderActivityChangedStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        ReliableReaderActivityChangedStatusStatistics src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReliableReaderActivityChangedStatusStatistics typedDst = (ReliableReaderActivityChangedStatusStatistics) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.status = (DDSMonitoring.ReliableReaderActivityChangedStatus)DDSMonitoring.ReliableReaderActivityChangedStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        ReliableReaderActivityChangedStatusStatistics dst,
        byte[] buffer,
        long length) 
    {
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    DDSMonitoring.ReliableReaderActivityChangedStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReliableReaderActivityChangedStatusStatistics typedDst = (ReliableReaderActivityChangedStatusStatistics) sample;
    ...
    protected ReliableReaderActivityChangedStatusStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliableReaderActivityChangedStatusStatisticsTypeCode.VALUE,ReliableReaderActivityChangedStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReliableReaderActivityChangedStatusStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReliableReaderActivityChangedStatusStatisticsTypeCode.VALUE,ReliableReaderActivityChangedStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
