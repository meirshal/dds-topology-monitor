...
public class ProcessStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::ProcessStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProcessStatisticsTypeSupport _singleton
    = new ProcessStatisticsTypeSupport();
    ...
    */
    public static ProcessStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static ProcessStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProcessStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return ProcessStatistics.create();
    }
    ...
    public Class get_type() {
        return ProcessStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>ProcessStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProcessStatistics typedDst = (ProcessStatistics) destination;
        ProcessStatistics typedSrc = (ProcessStatistics) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProcessStatistics typedSrc = (ProcessStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.user_cpu_time);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.user_cpu_time_change);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.kernel_cpu_time);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.kernel_cpu_time_change);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.user_cpu_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.user_cpu_time_change, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kernel_cpu_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kernel_cpu_time_change, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeLong(typedSrc.physical_memory_bytes);

            dst.writeLong(typedSrc.total_memory_bytes);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProcessStatistics typedDst = (ProcessStatistics) dst;
            typedDst.clear();      
            try{
                typedDst.user_cpu_time = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.user_cpu_time, src, false, true, endpoint_plugin_qos);     
                typedDst.user_cpu_time_change = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.user_cpu_time_change, src, false, true, endpoint_plugin_qos);     
                typedDst.kernel_cpu_time = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kernel_cpu_time, src, false, true, endpoint_plugin_qos);     
                typedDst.kernel_cpu_time_change = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kernel_cpu_time_change, src, false, true, endpoint_plugin_qos);     
                typedDst.physical_memory_bytes = src.readLong();
                typedDst.total_memory_bytes = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProcessStatistics typedDst = (ProcessStatistics) sample;
    ...
    protected ProcessStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProcessStatisticsTypeCode.VALUE,ProcessStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProcessStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProcessStatisticsTypeCode.VALUE,ProcessStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
