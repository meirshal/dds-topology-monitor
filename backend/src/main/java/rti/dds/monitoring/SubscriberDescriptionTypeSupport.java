...
public class SubscriberDescriptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::SubscriberDescription";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SubscriberDescriptionTypeSupport _singleton
    = new SubscriberDescriptionTypeSupport();
    ...
    */
    public static SubscriberDescriptionTypeSupport get_instance() {
        return _singleton;
    }

    public static SubscriberDescriptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SubscriberDescriptionTypeCode.VALUE;
    }

    public Object create_data() {
        return SubscriberDescription.create();
    }
    ...
    public Object create_key() {
        return new SubscriberDescription();
    }
    ...
    public Class get_type() {
        return SubscriberDescription.class;
    }
    ...
    * <code>this</code> is not a <code>SubscriberDescription</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SubscriberDescription typedDst = (SubscriberDescription) destination;
        SubscriberDescription typedSrc = (SubscriberDescription) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SubscriberQosTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SubscriberQosTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SubscriberDescription typedSrc = (SubscriberDescription) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SubscriberQosTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.SubscriberQosTypeSupport.get_instance().serialize(endpoint_data, typedSrc.qos, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SubscriberDescription typedDst = (SubscriberDescription) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 5:
                    typedDst.qos = (DDSMonitoring.SubscriberQos)DDSMonitoring.SubscriberQosTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.qos, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 5:
                    DDSMonitoring.SubscriberQosTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SubscriberDescription typedDst = (SubscriberDescription) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SubscriberDescription typedDst
        = (SubscriberDescription) instance;
        SubscriberDescription typedSrc
        = (SubscriberDescription) key;
    ...
    */
    ...
    int mask) {
        return new SubscriberDescriptionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SubscriberDescriptionDataReader(native_reader, listener, mask, this);   
    ...
    protected SubscriberDescriptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SubscriberDescriptionTypeCode.VALUE,SubscriberDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SubscriberDescriptionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SubscriberDescriptionTypeCode.VALUE,SubscriberDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
