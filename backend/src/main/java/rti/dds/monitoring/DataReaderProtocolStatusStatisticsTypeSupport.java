...
* DataReaderProtocolStatusStatistics
*/

public class DataReaderProtocolStatusStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::DataReaderProtocolStatusStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataReaderProtocolStatusStatisticsTypeSupport _singleton
    = new DataReaderProtocolStatusStatisticsTypeSupport();
    ...
    */
    public static DataReaderProtocolStatusStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static DataReaderProtocolStatusStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataReaderProtocolStatusStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return DataReaderProtocolStatusStatistics.create();
    }
    ...
    public Object create_key() {
        return new DataReaderProtocolStatusStatistics();
    }
    ...
    public Class get_type() {
        return DataReaderProtocolStatusStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>DataReaderProtocolStatusStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataReaderProtocolStatusStatistics typedDst = (DataReaderProtocolStatusStatistics) destination;
        DataReaderProtocolStatusStatistics typedSrc = (DataReaderProtocolStatusStatistics) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.DataReaderProtocolStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataReaderProtocolStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataReaderProtocolStatusStatistics typedSrc = (DataReaderProtocolStatusStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataReaderProtocolStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.DataReaderProtocolStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DataReaderProtocolStatusStatistics src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataReaderProtocolStatusStatistics typedDst = (DataReaderProtocolStatusStatistics) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.status = (DDSMonitoring.DataReaderProtocolStatus)DDSMonitoring.DataReaderProtocolStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        DataReaderProtocolStatusStatistics dst,
        byte[] buffer,
        long length) 
    {
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    DDSMonitoring.DataReaderProtocolStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataReaderProtocolStatusStatistics typedDst = (DataReaderProtocolStatusStatistics) sample;
    ...
    protected DataReaderProtocolStatusStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataReaderProtocolStatusStatisticsTypeCode.VALUE,DataReaderProtocolStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataReaderProtocolStatusStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataReaderProtocolStatusStatisticsTypeCode.VALUE,DataReaderProtocolStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
