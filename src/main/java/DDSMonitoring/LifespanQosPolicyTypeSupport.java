...
public class LifespanQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::LifespanQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LifespanQosPolicyTypeSupport _singleton
    = new LifespanQosPolicyTypeSupport();
    ...
    */
    public static LifespanQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static LifespanQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LifespanQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return LifespanQosPolicy.create();
    }
    ...
    public Class get_type() {
        return LifespanQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>LifespanQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LifespanQosPolicy typedDst = (LifespanQosPolicy) destination;
        LifespanQosPolicy typedSrc = (LifespanQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LifespanQosPolicy typedSrc = (LifespanQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LifespanQosPolicy typedDst = (LifespanQosPolicy) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LifespanQosPolicy typedDst = (LifespanQosPolicy) sample;
    ...
    protected LifespanQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LifespanQosPolicyTypeCode.VALUE,LifespanQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LifespanQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LifespanQosPolicyTypeCode.VALUE,LifespanQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
