...
/**
* A sequence of GUID_t instances.
*/
public final class GUID_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GUID_tSeq (int initialMaximum) {
        super(GUID_t.class, initialMaximum);
    }

    public GUID_tSeq (Collection elements) {
        super(GUID_t.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' GUID_t objects (beyond the original size of this object)
