...
public class DomainParticipantFactoryQosTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DomainParticipantFactoryQos";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DomainParticipantFactoryQosTypeSupport _singleton
    = new DomainParticipantFactoryQosTypeSupport();
    ...
    */
    public static DomainParticipantFactoryQosTypeSupport get_instance() {
        return _singleton;
    }

    public static DomainParticipantFactoryQosTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DomainParticipantFactoryQosTypeCode.VALUE;
    }

    public Object create_data() {
        return DomainParticipantFactoryQos.create();
    }
    ...
    public Object create_key() {
        return new DomainParticipantFactoryQos();
    }
    ...
    public Class get_type() {
        return DomainParticipantFactoryQos.class;
    }
    ...
    * <code>this</code> is not a <code>DomainParticipantFactoryQos</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DomainParticipantFactoryQos typedDst = (DomainParticipantFactoryQos) destination;
        DomainParticipantFactoryQos typedSrc = (DomainParticipantFactoryQos) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.EntityFactoryQosPolicyTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.SystemResourceLimitsQosPolicyTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ProfileQosPolicyTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.EntityFactoryQosPolicyTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.SystemResourceLimitsQosPolicyTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.ProfileQosPolicyTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DomainParticipantFactoryQos typedSrc = (DomainParticipantFactoryQos) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.EntityFactoryQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.entity_factory);
        currentAlignment += DDSMonitoring.SystemResourceLimitsQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.resource_limits);
        currentAlignment += DDSMonitoring.ProfileQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.profile);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.SystemResourceLimitsQosPolicyTypeSupport.get_instance().serialize(endpoint_data, typedSrc.resource_limits, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.ProfileQosPolicyTypeSupport.get_instance().serialize(endpoint_data, typedSrc.profile, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DomainParticipantFactoryQos src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DomainParticipantFactoryQos typedDst = (DomainParticipantFactoryQos) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.resource_limits = (DDSMonitoring.SystemResourceLimitsQosPolicy)DDSMonitoring.SystemResourceLimitsQosPolicyTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.resource_limits, src, false, true, endpoint_plugin_qos);     
                typedDst.profile = (DDSMonitoring.ProfileQosPolicy)DDSMonitoring.ProfileQosPolicyTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.profile, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        DomainParticipantFactoryQos dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.SystemResourceLimitsQosPolicyTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            DDSMonitoring.ProfileQosPolicyTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DomainParticipantFactoryQos typedDst = (DomainParticipantFactoryQos) sample;
    ...
    int mask) {
        return new DomainParticipantFactoryQosDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DomainParticipantFactoryQosDataReader(native_reader, listener, mask, this);   
    ...
    protected DomainParticipantFactoryQosTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DomainParticipantFactoryQosTypeCode.VALUE,DomainParticipantFactoryQos.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DomainParticipantFactoryQosTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DomainParticipantFactoryQosTypeCode.VALUE,DomainParticipantFactoryQos.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
