...
public class PartitionQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PartitionQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PartitionQosPolicyTypeSupport _singleton
    = new PartitionQosPolicyTypeSupport();
    ...
    */
    public static PartitionQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static PartitionQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PartitionQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return PartitionQosPolicy.create();
    }
    ...
    public Class get_type() {
        return PartitionQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>PartitionQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PartitionQosPolicy typedDst = (PartitionQosPolicy) destination;
        PartitionQosPolicy typedSrc = (PartitionQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PartitionQosPolicy typedSrc = (PartitionQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.name,(255),64);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PartitionQosPolicy typedDst = (PartitionQosPolicy) dst;
            typedDst.clear();      
            try{
                src.readStringSequence(typedDst.name, 64);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PartitionQosPolicy typedDst = (PartitionQosPolicy) sample;
    ...
    protected PartitionQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PartitionQosPolicyTypeCode.VALUE,PartitionQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PartitionQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PartitionQosPolicyTypeCode.VALUE,PartitionQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
