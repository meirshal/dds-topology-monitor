...
public class QosPolicyCountTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::QosPolicyCount";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final QosPolicyCountTypeSupport _singleton
    = new QosPolicyCountTypeSupport();
    ...
    */
    public static QosPolicyCountTypeSupport get_instance() {
        return _singleton;
    }

    public static QosPolicyCountTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return QosPolicyCountTypeCode.VALUE;
    }

    public Object create_data() {
        return QosPolicyCount.create();
    }
    ...
    * <code>this</code> is not a <code>QosPolicyCount</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        QosPolicyCount typedDst = (QosPolicyCount) destination;
        QosPolicyCount typedSrc = (QosPolicyCount) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        QosPolicyCount typedSrc = (QosPolicyCount) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.policy_id);

            dst.writeInt(typedSrc.count);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            QosPolicyCount typedDst = (QosPolicyCount) dst;
            typedDst.policy_id = src.readInt();
            typedDst.count = src.readInt();
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            QosPolicyCount typedDst = (QosPolicyCount) sample;
    ...
    protected QosPolicyCountTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,QosPolicyCountTypeCode.VALUE,QosPolicyCount.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected QosPolicyCountTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,QosPolicyCountTypeCode.VALUE,QosPolicyCount.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
