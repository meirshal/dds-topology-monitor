...
public class GroupDataQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::GroupDataQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GroupDataQosPolicyTypeSupport _singleton
    = new GroupDataQosPolicyTypeSupport();
    ...
    */
    public static GroupDataQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static GroupDataQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GroupDataQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return GroupDataQosPolicy.create();
    }
    ...
    public Class get_type() {
        return GroupDataQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>GroupDataQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GroupDataQosPolicy typedDst = (GroupDataQosPolicy) destination;
        GroupDataQosPolicy typedSrc = (GroupDataQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, 256);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GroupDataQosPolicy typedSrc = (GroupDataQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=   CdrPrimitiveType.BYTE.getSequenceSerializedSize(
            currentAlignment , typedSrc.value );      
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeByteSeq(typedSrc.value,256);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GroupDataQosPolicy typedDst = (GroupDataQosPolicy) dst;
            typedDst.clear();      
            try{
                src.readByteSequence(typedDst.value, 256);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GroupDataQosPolicy typedDst = (GroupDataQosPolicy) sample;
    ...
    protected GroupDataQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GroupDataQosPolicyTypeCode.VALUE,GroupDataQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GroupDataQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GroupDataQosPolicyTypeCode.VALUE,GroupDataQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
