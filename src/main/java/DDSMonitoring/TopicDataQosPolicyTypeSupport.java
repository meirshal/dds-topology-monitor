...
public class TopicDataQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TopicDataQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TopicDataQosPolicyTypeSupport _singleton
    = new TopicDataQosPolicyTypeSupport();
    ...
    */
    public static TopicDataQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TopicDataQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TopicDataQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TopicDataQosPolicy.create();
    }
    ...
    public Class get_type() {
        return TopicDataQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TopicDataQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TopicDataQosPolicy typedDst = (TopicDataQosPolicy) destination;
        TopicDataQosPolicy typedSrc = (TopicDataQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TopicDataQosPolicy typedSrc = (TopicDataQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TopicDataQosPolicy typedDst = (TopicDataQosPolicy) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TopicDataQosPolicy typedDst = (TopicDataQosPolicy) sample;
    ...
    protected TopicDataQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TopicDataQosPolicyTypeCode.VALUE,TopicDataQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TopicDataQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TopicDataQosPolicyTypeCode.VALUE,TopicDataQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
