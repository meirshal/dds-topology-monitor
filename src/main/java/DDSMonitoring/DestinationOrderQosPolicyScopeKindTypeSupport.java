...
public class DestinationOrderQosPolicyScopeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DestinationOrderQosPolicyScopeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DestinationOrderQosPolicyScopeKindTypeSupport _singleton
    = new DestinationOrderQosPolicyScopeKindTypeSupport();
    ...
    */
    public static DestinationOrderQosPolicyScopeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static DestinationOrderQosPolicyScopeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DestinationOrderQosPolicyScopeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return DestinationOrderQosPolicyScopeKind.class;
    }
    ...
    * <code>this</code> is not a <code>DestinationOrderQosPolicyScopeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DestinationOrderQosPolicyScopeKind typedSrc = (DestinationOrderQosPolicyScopeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = DestinationOrderQosPolicyScopeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected DestinationOrderQosPolicyScopeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DestinationOrderQosPolicyScopeKindTypeCode.VALUE,DestinationOrderQosPolicyScopeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
