...
public class ReliabilityQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReliabilityQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliabilityQosPolicyKindTypeSupport _singleton
    = new ReliabilityQosPolicyKindTypeSupport();
    ...
    */
    public static ReliabilityQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliabilityQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliabilityQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ReliabilityQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>ReliabilityQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ReliabilityQosPolicyKind typedSrc = (ReliabilityQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ReliabilityQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ReliabilityQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliabilityQosPolicyKindTypeCode.VALUE,ReliabilityQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
