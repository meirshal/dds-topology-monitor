...
public class  ReliableWriterCacheEventCountTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("DDSMonitoring::ReliableWriterCacheEventCount",ExtensibilityKind.FINAL_EXTENSIBILITY,  sm);        
        return tc;
    }
}
