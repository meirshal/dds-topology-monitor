...
public class Duration_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::Duration_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Duration_tTypeSupport _singleton
    = new Duration_tTypeSupport();
    ...
    */
    public static Duration_tTypeSupport get_instance() {
        return _singleton;
    }

    public static Duration_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Duration_tTypeCode.VALUE;
    }

    public Object create_data() {
        return Duration_t.create();
    }
    ...
    * <code>this</code> is not a <code>Duration_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Duration_t typedDst = (Duration_t) destination;
        Duration_t typedSrc = (Duration_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Duration_t typedSrc = (Duration_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Duration_t typedDst = (Duration_t) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Duration_t typedDst = (Duration_t) sample;
    ...
    protected Duration_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Duration_tTypeCode.VALUE,Duration_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Duration_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Duration_tTypeCode.VALUE,Duration_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
