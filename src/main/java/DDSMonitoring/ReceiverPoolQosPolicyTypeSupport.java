...
public class ReceiverPoolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReceiverPoolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReceiverPoolQosPolicyTypeSupport _singleton
    = new ReceiverPoolQosPolicyTypeSupport();
    ...
    */
    public static ReceiverPoolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static ReceiverPoolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReceiverPoolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return ReceiverPoolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new ReceiverPoolQosPolicy();
    }
    ...
    public Class get_type() {
        return ReceiverPoolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>ReceiverPoolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReceiverPoolQosPolicy typedDst = (ReceiverPoolQosPolicy) destination;
        ReceiverPoolQosPolicy typedSrc = (ReceiverPoolQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReceiverPoolQosPolicy typedSrc = (ReceiverPoolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            memberId = 1;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.initial_receive_threads);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 2;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.max_receive_threads);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 3;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.buffer_size);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 4;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.buffer_alignment);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 5;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.is_timestamp_enabled);
            dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReceiverPoolQosPolicy typedDst = (ReceiverPoolQosPolicy) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 1:
                    typedDst.initial_receive_threads = src.readInt();
                    break;
                    case 2:
                    typedDst.max_receive_threads = src.readInt();
                    break;
                    case 3:
                    typedDst.buffer_size = src.readInt();
                    break;
                    case 4:
                    typedDst.buffer_alignment = src.readInt();
                    break;
                    case 5:
                    typedDst.is_timestamp_enabled = src.readBoolean();
                    break;
                    default:
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReceiverPoolQosPolicy typedDst = (ReceiverPoolQosPolicy) sample;
    ...
    protected ReceiverPoolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReceiverPoolQosPolicyTypeCode.VALUE,ReceiverPoolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReceiverPoolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReceiverPoolQosPolicyTypeCode.VALUE,ReceiverPoolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
