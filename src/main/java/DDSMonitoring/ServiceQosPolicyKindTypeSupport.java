...
public class ServiceQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ServiceQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ServiceQosPolicyKindTypeSupport _singleton
    = new ServiceQosPolicyKindTypeSupport();
    ...
    */
    public static ServiceQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ServiceQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ServiceQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ServiceQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>ServiceQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ServiceQosPolicyKind typedSrc = (ServiceQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ServiceQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ServiceQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ServiceQosPolicyKindTypeCode.VALUE,ServiceQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
