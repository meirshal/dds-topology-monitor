...
/**
* A sequence of HistoryQosPolicy instances.
*/
public final class HistoryQosPolicySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HistoryQosPolicySeq() {
        super(HistoryQosPolicy.class);
    }

    public HistoryQosPolicySeq (int initialMaximum) {
        super(HistoryQosPolicy.class, initialMaximum);
    }

    public HistoryQosPolicySeq (Collection elements) {
        super(HistoryQosPolicy.class, elements);
    }
