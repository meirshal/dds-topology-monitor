...
public class PublisherProtocolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PublisherProtocolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PublisherProtocolQosPolicyTypeSupport _singleton
    = new PublisherProtocolQosPolicyTypeSupport();
    ...
    */
    public static PublisherProtocolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static PublisherProtocolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PublisherProtocolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return PublisherProtocolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new PublisherProtocolQosPolicy();
    }
    ...
    public Class get_type() {
        return PublisherProtocolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>PublisherProtocolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PublisherProtocolQosPolicy typedDst = (PublisherProtocolQosPolicy) destination;
        PublisherProtocolQosPolicy typedSrc = (PublisherProtocolQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PublisherProtocolQosPolicy typedSrc = (PublisherProtocolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        PublisherProtocolQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PublisherProtocolQosPolicy typedDst = (PublisherProtocolQosPolicy) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        PublisherProtocolQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PublisherProtocolQosPolicy typedDst = (PublisherProtocolQosPolicy) sample;
    ...
    protected PublisherProtocolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PublisherProtocolQosPolicyTypeCode.VALUE,PublisherProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PublisherProtocolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PublisherProtocolQosPolicyTypeCode.VALUE,PublisherProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
