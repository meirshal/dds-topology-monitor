...
public class DestinationOrderQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DestinationOrderQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DestinationOrderQosPolicyKindTypeSupport _singleton
    = new DestinationOrderQosPolicyKindTypeSupport();
    ...
    */
    public static DestinationOrderQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static DestinationOrderQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DestinationOrderQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return DestinationOrderQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>DestinationOrderQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DestinationOrderQosPolicyKind typedSrc = (DestinationOrderQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = DestinationOrderQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected DestinationOrderQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DestinationOrderQosPolicyKindTypeCode.VALUE,DestinationOrderQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
