...
public class OfferedIncompatibleQosStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::OfferedIncompatibleQosStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OfferedIncompatibleQosStatusTypeSupport _singleton
    = new OfferedIncompatibleQosStatusTypeSupport();
    ...
    */
    public static OfferedIncompatibleQosStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static OfferedIncompatibleQosStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OfferedIncompatibleQosStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return OfferedIncompatibleQosStatus.create();
    }
    ...
    public Class get_type() {
        return OfferedIncompatibleQosStatus.class;
    }
    ...
    * <code>this</code> is not a <code>OfferedIncompatibleQosStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OfferedIncompatibleQosStatus typedDst = (OfferedIncompatibleQosStatus) destination;
        OfferedIncompatibleQosStatus typedSrc = (OfferedIncompatibleQosStatus) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.QosPolicyCountTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 64);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.QosPolicyCountTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OfferedIncompatibleQosStatus typedSrc = (OfferedIncompatibleQosStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.QosPolicyCountTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.policies);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.last_policy_id);

            DDSMonitoring.QosPolicyCountTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.policies,64, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        OfferedIncompatibleQosStatus src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OfferedIncompatibleQosStatus typedDst = (OfferedIncompatibleQosStatus) dst;
            typedDst.clear();      
            try{
                typedDst.total_count = src.readInt();
                typedDst.total_count_change = src.readInt();
                typedDst.last_policy_id = src.readInt();
                DDSMonitoring.QosPolicyCountTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.policies, src, 64, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        OfferedIncompatibleQosStatus dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.QosPolicyCountTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OfferedIncompatibleQosStatus typedDst = (OfferedIncompatibleQosStatus) sample;
    ...
    protected OfferedIncompatibleQosStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OfferedIncompatibleQosStatusTypeCode.VALUE,OfferedIncompatibleQosStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OfferedIncompatibleQosStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OfferedIncompatibleQosStatusTypeCode.VALUE,OfferedIncompatibleQosStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
