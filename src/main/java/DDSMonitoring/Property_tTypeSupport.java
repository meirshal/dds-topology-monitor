...
public class Property_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::Property_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Property_tTypeSupport _singleton
    = new Property_tTypeSupport();
    ...
    */
    public static Property_tTypeSupport get_instance() {
        return _singleton;
    }

    public static Property_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Property_tTypeCode.VALUE;
    }

    public Object create_data() {
        return Property_t.create();
    }
    ...
    * <code>this</code> is not a <code>Property_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Property_t typedDst = (Property_t) destination;
        Property_t typedSrc = (Property_t) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (127)+1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, (511)+1);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Property_t typedSrc = (Property_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.name,127);

            dst.writeString(typedSrc.value,511);

            dst.writeBoolean(typedSrc.propagate);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Property_t typedDst = (Property_t) dst;
            typedDst.name = src.readString(127);
            typedDst.value = src.readString(511);
            typedDst.propagate = src.readBoolean();
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Property_t typedDst = (Property_t) sample;
    ...
    protected Property_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Property_tTypeCode.VALUE,Property_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Property_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Property_tTypeCode.VALUE,Property_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
