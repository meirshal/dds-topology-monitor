...
public class ReliableReaderActivityChangedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReliableReaderActivityChangedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliableReaderActivityChangedStatusTypeSupport _singleton
    = new ReliableReaderActivityChangedStatusTypeSupport();
    ...
    */
    public static ReliableReaderActivityChangedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliableReaderActivityChangedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliableReaderActivityChangedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return ReliableReaderActivityChangedStatus.create();
    }
    ...
    public Object create_key() {
        return new ReliableReaderActivityChangedStatus();
    }
    ...
    public Class get_type() {
        return ReliableReaderActivityChangedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>ReliableReaderActivityChangedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReliableReaderActivityChangedStatus typedDst = (ReliableReaderActivityChangedStatus) destination;
        ReliableReaderActivityChangedStatus typedSrc = (ReliableReaderActivityChangedStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReliableReaderActivityChangedStatus typedSrc = (ReliableReaderActivityChangedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.active_count);

            dst.writeInt(typedSrc.inactive_count);

            dst.writeInt(typedSrc.active_count_change);

            dst.writeInt(typedSrc.inactive_count_change);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReliableReaderActivityChangedStatus typedDst = (ReliableReaderActivityChangedStatus) dst;
            typedDst.clear();      
            try{
                typedDst.active_count = src.readInt();
                typedDst.inactive_count = src.readInt();
                typedDst.active_count_change = src.readInt();
                typedDst.inactive_count_change = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        ReliableReaderActivityChangedStatus dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReliableReaderActivityChangedStatus typedDst = (ReliableReaderActivityChangedStatus) sample;
    ...
    protected ReliableReaderActivityChangedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliableReaderActivityChangedStatusTypeCode.VALUE,ReliableReaderActivityChangedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReliableReaderActivityChangedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReliableReaderActivityChangedStatusTypeCode.VALUE,ReliableReaderActivityChangedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
