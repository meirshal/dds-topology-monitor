...
public class SubscriptionMatchedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SubscriptionMatchedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SubscriptionMatchedStatusTypeSupport _singleton
    = new SubscriptionMatchedStatusTypeSupport();
    ...
    */
    public static SubscriptionMatchedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static SubscriptionMatchedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SubscriptionMatchedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return SubscriptionMatchedStatus.create();
    }
    ...
    public Class get_type() {
        return SubscriptionMatchedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>SubscriptionMatchedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SubscriptionMatchedStatus typedDst = (SubscriptionMatchedStatus) destination;
        SubscriptionMatchedStatus typedSrc = (SubscriptionMatchedStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SubscriptionMatchedStatus typedSrc = (SubscriptionMatchedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.last_publication_handle);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.current_count);

            dst.writeInt(typedSrc.current_count_peak);

            dst.writeInt(typedSrc.current_count_change);

            DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().serialize(endpoint_data, typedSrc.last_publication_handle, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SubscriptionMatchedStatus typedDst = (SubscriptionMatchedStatus) dst;
            typedDst.clear();      
            try{
                typedDst.total_count = src.readInt();
                typedDst.total_count_change = src.readInt();
                typedDst.current_count = src.readInt();
                typedDst.current_count_peak = src.readInt();
                typedDst.current_count_change = src.readInt();
                typedDst.last_publication_handle = (DDSMonitoring.RTIInstanceHandle)DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.last_publication_handle, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SubscriptionMatchedStatus typedDst = (SubscriptionMatchedStatus) sample;
    ...
    protected SubscriptionMatchedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SubscriptionMatchedStatusTypeCode.VALUE,SubscriptionMatchedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SubscriptionMatchedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SubscriptionMatchedStatusTypeCode.VALUE,SubscriptionMatchedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
