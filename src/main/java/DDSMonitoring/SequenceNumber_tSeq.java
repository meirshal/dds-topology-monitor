...
/**
* A sequence of SequenceNumber_t instances.
*/
public final class SequenceNumber_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SequenceNumber_tSeq() {
        super(SequenceNumber_t.class);
    }

    public SequenceNumber_tSeq (int initialMaximum) {
        super(SequenceNumber_t.class, initialMaximum);
    }

    public SequenceNumber_tSeq (Collection elements) {
        super(SequenceNumber_t.class, elements);
    }
