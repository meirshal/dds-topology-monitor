...
public class DurabilityServiceQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DurabilityServiceQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DurabilityServiceQosPolicyTypeSupport _singleton
    = new DurabilityServiceQosPolicyTypeSupport();
    ...
    */
    public static DurabilityServiceQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DurabilityServiceQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DurabilityServiceQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DurabilityServiceQosPolicy.create();
    }
    ...
    public Class get_type() {
        return DurabilityServiceQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DurabilityServiceQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DurabilityServiceQosPolicy typedDst = (DurabilityServiceQosPolicy) destination;
        DurabilityServiceQosPolicy typedSrc = (DurabilityServiceQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DurabilityServiceQosPolicy typedSrc = (DurabilityServiceQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.service_cleanup_delay);
        currentAlignment += DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.history_kind);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.service_cleanup_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.history_kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.history_depth);

            dst.writeInt(typedSrc.max_samples);

            dst.writeInt(typedSrc.max_instances);

            dst.writeInt(typedSrc.max_samples_per_instance);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DurabilityServiceQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DurabilityServiceQosPolicy typedDst = (DurabilityServiceQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.service_cleanup_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.service_cleanup_delay, src, false, true, endpoint_plugin_qos);     
                typedDst.history_kind = (DDSMonitoring.HistoryQosPolicyKind)DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.history_kind, src, false, true, endpoint_plugin_qos);     
                typedDst.history_depth = src.readInt();
                typedDst.max_samples = src.readInt();
                typedDst.max_instances = src.readInt();
                typedDst.max_samples_per_instance = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        DurabilityServiceQosPolicy dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.HistoryQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DurabilityServiceQosPolicy typedDst = (DurabilityServiceQosPolicy) sample;
    ...
    protected DurabilityServiceQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DurabilityServiceQosPolicyTypeCode.VALUE,DurabilityServiceQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DurabilityServiceQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DurabilityServiceQosPolicyTypeCode.VALUE,DurabilityServiceQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
