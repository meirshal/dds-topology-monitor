...
public class DiscoveryPluginPromiscuityKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DiscoveryPluginPromiscuityKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiscoveryPluginPromiscuityKindTypeSupport _singleton
    = new DiscoveryPluginPromiscuityKindTypeSupport();
    ...
    */
    public static DiscoveryPluginPromiscuityKindTypeSupport get_instance() {
        return _singleton;
    }

    public static DiscoveryPluginPromiscuityKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiscoveryPluginPromiscuityKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return DiscoveryPluginPromiscuityKind.class;
    }
    ...
    * <code>this</code> is not a <code>DiscoveryPluginPromiscuityKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        DiscoveryPluginPromiscuityKind typedSrc = (DiscoveryPluginPromiscuityKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = DiscoveryPluginPromiscuityKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected DiscoveryPluginPromiscuityKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiscoveryPluginPromiscuityKindTypeCode.VALUE,DiscoveryPluginPromiscuityKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
