...
public class CdrPaddingKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::CdrPaddingKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CdrPaddingKindTypeSupport _singleton
    = new CdrPaddingKindTypeSupport();
    ...
    */
    public static CdrPaddingKindTypeSupport get_instance() {
        return _singleton;
    }

    public static CdrPaddingKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CdrPaddingKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CdrPaddingKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        CdrPaddingKind typedSrc = (CdrPaddingKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = CdrPaddingKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected CdrPaddingKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CdrPaddingKindTypeCode.VALUE,CdrPaddingKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
