...
public class TransportSelectionQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportSelectionQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportSelectionQosPolicyTypeSupport _singleton
    = new TransportSelectionQosPolicyTypeSupport();
    ...
    */
    public static TransportSelectionQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportSelectionQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportSelectionQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportSelectionQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TransportSelectionQosPolicy();
    }
    ...
    public Class get_type() {
        return TransportSelectionQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TransportSelectionQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportSelectionQosPolicy typedDst = (TransportSelectionQosPolicy) destination;
        TransportSelectionQosPolicy typedSrc = (TransportSelectionQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportSelectionQosPolicy typedSrc = (TransportSelectionQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        TransportSelectionQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportSelectionQosPolicy typedDst = (TransportSelectionQosPolicy) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        TransportSelectionQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportSelectionQosPolicy typedDst = (TransportSelectionQosPolicy) sample;
    ...
    protected TransportSelectionQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportSelectionQosPolicyTypeCode.VALUE,TransportSelectionQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportSelectionQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportSelectionQosPolicyTypeCode.VALUE,TransportSelectionQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
