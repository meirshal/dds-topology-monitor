...
public class DataReaderProtocolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DataReaderProtocolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataReaderProtocolQosPolicyTypeSupport _singleton
    = new DataReaderProtocolQosPolicyTypeSupport();
    ...
    */
    public static DataReaderProtocolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DataReaderProtocolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataReaderProtocolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DataReaderProtocolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new DataReaderProtocolQosPolicy();
    }
    ...
    public Class get_type() {
        return DataReaderProtocolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DataReaderProtocolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataReaderProtocolQosPolicy typedDst = (DataReaderProtocolQosPolicy) destination;
        DataReaderProtocolQosPolicy typedSrc = (DataReaderProtocolQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataReaderProtocolQosPolicy typedSrc = (DataReaderProtocolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.RtpsReliableReaderProtocol_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.rtps_reliable_reader);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            memberId = 2;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.expects_inline_qos);
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberId = 4;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.propagate_dispose_of_unregistered_instances);
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.RtpsReliableReaderProtocol_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.rtps_reliable_reader, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberId = 7;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.propagate_unregister_of_disposed_instances);
            dst.writeMemberLength(memberLengthPosition, false);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DataReaderProtocolQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataReaderProtocolQosPolicy typedDst = (DataReaderProtocolQosPolicy) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 2:
                    typedDst.expects_inline_qos = src.readBoolean();
                    break;
                    case 3:
                    typedDst.disable_positive_acks = src.readBoolean();
                    break;
                    case 4:
                    typedDst.propagate_dispose_of_unregistered_instances = src.readBoolean();
                    break;
                    case 5:
                    typedDst.rtps_reliable_reader = (DDSMonitoring.RtpsReliableReaderProtocol_t)DDSMonitoring.RtpsReliableReaderProtocol_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.rtps_reliable_reader, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 6:
                    typedDst.vendor_specific_entity = src.readBoolean();
                    break;
                    case 7:
                    typedDst.propagate_unregister_of_disposed_instances = src.readBoolean();
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        DataReaderProtocolQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataReaderProtocolQosPolicy typedDst = (DataReaderProtocolQosPolicy) sample;
    ...
    protected DataReaderProtocolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataReaderProtocolQosPolicyTypeCode.VALUE,DataReaderProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataReaderProtocolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataReaderProtocolQosPolicyTypeCode.VALUE,DataReaderProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
