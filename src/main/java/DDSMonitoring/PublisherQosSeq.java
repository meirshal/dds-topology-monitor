...
/**
* A sequence of PublisherQos instances.
*/
public final class PublisherQosSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PublisherQosSeq() {
        super(PublisherQos.class);
    }

    public PublisherQosSeq (int initialMaximum) {
        super(PublisherQos.class, initialMaximum);
    }

    public PublisherQosSeq (Collection elements) {
        super(PublisherQos.class, elements);
    }
