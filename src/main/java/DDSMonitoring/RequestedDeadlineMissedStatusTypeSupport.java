...
public class RequestedDeadlineMissedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::RequestedDeadlineMissedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RequestedDeadlineMissedStatusTypeSupport _singleton
    = new RequestedDeadlineMissedStatusTypeSupport();
    ...
    */
    public static RequestedDeadlineMissedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static RequestedDeadlineMissedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RequestedDeadlineMissedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return RequestedDeadlineMissedStatus.create();
    }
    ...
    public Class get_type() {
        return RequestedDeadlineMissedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>RequestedDeadlineMissedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RequestedDeadlineMissedStatus typedDst = (RequestedDeadlineMissedStatus) destination;
        RequestedDeadlineMissedStatus typedSrc = (RequestedDeadlineMissedStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RequestedDeadlineMissedStatus typedSrc = (RequestedDeadlineMissedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RequestedDeadlineMissedStatus src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RequestedDeadlineMissedStatus typedDst = (RequestedDeadlineMissedStatus) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        RequestedDeadlineMissedStatus dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RequestedDeadlineMissedStatus typedDst = (RequestedDeadlineMissedStatus) sample;
    ...
    protected RequestedDeadlineMissedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RequestedDeadlineMissedStatusTypeCode.VALUE,RequestedDeadlineMissedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RequestedDeadlineMissedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RequestedDeadlineMissedStatusTypeCode.VALUE,RequestedDeadlineMissedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
