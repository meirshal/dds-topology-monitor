...
/**
* A sequence of Duration_t instances.
*/
public final class Duration_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Duration_tSeq() {
        super(Duration_t.class);
    }

    public Duration_tSeq (int initialMaximum) {
        super(Duration_t.class, initialMaximum);
    }

    public Duration_tSeq (Collection elements) {
        super(Duration_t.class, elements);
    }
