...
public class TransportUnicastSettings_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportUnicastSettings_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportUnicastSettings_tTypeSupport _singleton
    = new TransportUnicastSettings_tTypeSupport();
    ...
    */
    public static TransportUnicastSettings_tTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportUnicastSettings_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportUnicastSettings_tTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportUnicastSettings_t.create();
    }
    ...
    public Object create_key() {
        return new TransportUnicastSettings_t();
    }
    ...
    public Class get_type() {
        return TransportUnicastSettings_t.class;
    }
    ...
    * <code>this</code> is not a <code>TransportUnicastSettings_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportUnicastSettings_t typedDst = (TransportUnicastSettings_t) destination;
        TransportUnicastSettings_t typedSrc = (TransportUnicastSettings_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportUnicastSettings_t typedSrc = (TransportUnicastSettings_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportUnicastSettings_t typedDst = (TransportUnicastSettings_t) dst;
    ...
    public void deserialize_from_cdr_buffer(
        TransportUnicastSettings_t dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportUnicastSettings_t typedDst = (TransportUnicastSettings_t) sample;
    ...
    protected TransportUnicastSettings_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportUnicastSettings_tTypeCode.VALUE,TransportUnicastSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportUnicastSettings_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportUnicastSettings_tTypeCode.VALUE,TransportUnicastSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
