...
public class DataWriterCacheStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DataWriterCacheStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataWriterCacheStatusTypeSupport _singleton
    = new DataWriterCacheStatusTypeSupport();
    ...
    */
    public static DataWriterCacheStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static DataWriterCacheStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataWriterCacheStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return DataWriterCacheStatus.create();
    }
    ...
    public Object create_key() {
        return new DataWriterCacheStatus();
    }
    ...
    public Class get_type() {
        return DataWriterCacheStatus.class;
    }
    ...
    * <code>this</code> is not a <code>DataWriterCacheStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataWriterCacheStatus typedDst = (DataWriterCacheStatus) destination;
        DataWriterCacheStatus typedSrc = (DataWriterCacheStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataWriterCacheStatus typedSrc = (DataWriterCacheStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataWriterCacheStatus typedDst = (DataWriterCacheStatus) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataWriterCacheStatus typedDst = (DataWriterCacheStatus) sample;
    ...
    protected DataWriterCacheStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataWriterCacheStatusTypeCode.VALUE,DataWriterCacheStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataWriterCacheStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataWriterCacheStatusTypeCode.VALUE,DataWriterCacheStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
