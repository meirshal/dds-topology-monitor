...
/**
* A sequence of EventQosPolicy instances.
*/
public final class EventQosPolicySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EventQosPolicySeq() {
        super(EventQosPolicy.class);
    }

    public EventQosPolicySeq (int initialMaximum) {
        super(EventQosPolicy.class, initialMaximum);
    }

    public EventQosPolicySeq (Collection elements) {
        super(EventQosPolicy.class, elements);
    }
