...
public class TopicProtocolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TopicProtocolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TopicProtocolQosPolicyTypeSupport _singleton
    = new TopicProtocolQosPolicyTypeSupport();
    ...
    */
    public static TopicProtocolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TopicProtocolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TopicProtocolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TopicProtocolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TopicProtocolQosPolicy();
    }
    ...
    public Class get_type() {
        return TopicProtocolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TopicProtocolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TopicProtocolQosPolicy typedDst = (TopicProtocolQosPolicy) destination;
        TopicProtocolQosPolicy typedSrc = (TopicProtocolQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TopicProtocolQosPolicy typedSrc = (TopicProtocolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TopicProtocolQosPolicy typedDst = (TopicProtocolQosPolicy) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TopicProtocolQosPolicy typedDst = (TopicProtocolQosPolicy) sample;
    ...
    protected TopicProtocolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TopicProtocolQosPolicyTypeCode.VALUE,TopicProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TopicProtocolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TopicProtocolQosPolicyTypeCode.VALUE,TopicProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
