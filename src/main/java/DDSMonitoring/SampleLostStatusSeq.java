...
/**
* A sequence of SampleLostStatus instances.
*/
public final class SampleLostStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SampleLostStatusSeq() {
        super(SampleLostStatus.class);
    }

    public SampleLostStatusSeq (int initialMaximum) {
        super(SampleLostStatus.class, initialMaximum);
    }

    public SampleLostStatusSeq (Collection elements) {
        super(SampleLostStatus.class, elements);
    }
