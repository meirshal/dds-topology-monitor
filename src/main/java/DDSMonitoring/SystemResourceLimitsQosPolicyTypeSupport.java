...
public class SystemResourceLimitsQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SystemResourceLimitsQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SystemResourceLimitsQosPolicyTypeSupport _singleton
    = new SystemResourceLimitsQosPolicyTypeSupport();
    ...
    */
    public static SystemResourceLimitsQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static SystemResourceLimitsQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SystemResourceLimitsQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return SystemResourceLimitsQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new SystemResourceLimitsQosPolicy();
    }
    ...
    public Class get_type() {
        return SystemResourceLimitsQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>SystemResourceLimitsQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SystemResourceLimitsQosPolicy typedDst = (SystemResourceLimitsQosPolicy) destination;
        SystemResourceLimitsQosPolicy typedSrc = (SystemResourceLimitsQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SystemResourceLimitsQosPolicy typedSrc = (SystemResourceLimitsQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.max_objects_per_thread);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        SystemResourceLimitsQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SystemResourceLimitsQosPolicy typedDst = (SystemResourceLimitsQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.max_objects_per_thread = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        SystemResourceLimitsQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SystemResourceLimitsQosPolicy typedDst = (SystemResourceLimitsQosPolicy) sample;
    ...
    protected SystemResourceLimitsQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SystemResourceLimitsQosPolicyTypeCode.VALUE,SystemResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SystemResourceLimitsQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SystemResourceLimitsQosPolicyTypeCode.VALUE,SystemResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
