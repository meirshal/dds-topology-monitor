...
/**
* A sequence of CdrPaddingKind instances.
*/
public final class CdrPaddingKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CdrPaddingKindSeq() {
        super(CdrPaddingKind.class);
    }

    public CdrPaddingKindSeq (int initialMaximum) {
        super(CdrPaddingKind.class, initialMaximum);
    }

    public CdrPaddingKindSeq (Collection elements) {
        super(CdrPaddingKind.class, elements);
    }
