...
public class ReliabilityQosPolicyAcknowledgementModeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReliabilityQosPolicyAcknowledgementModeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliabilityQosPolicyAcknowledgementModeKindTypeSupport _singleton
    = new ReliabilityQosPolicyAcknowledgementModeKindTypeSupport();
    ...
    */
    public static ReliabilityQosPolicyAcknowledgementModeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliabilityQosPolicyAcknowledgementModeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliabilityQosPolicyAcknowledgementModeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ReliabilityQosPolicyAcknowledgementModeKind.class;
    }
    ...
    * <code>this</code> is not a <code>ReliabilityQosPolicyAcknowledgementModeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ReliabilityQosPolicyAcknowledgementModeKind typedSrc = (ReliabilityQosPolicyAcknowledgementModeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ReliabilityQosPolicyAcknowledgementModeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ReliabilityQosPolicyAcknowledgementModeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliabilityQosPolicyAcknowledgementModeKindTypeCode.VALUE,ReliabilityQosPolicyAcknowledgementModeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
