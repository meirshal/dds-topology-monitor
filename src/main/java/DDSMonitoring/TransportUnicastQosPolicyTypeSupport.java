...
public class TransportUnicastQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportUnicastQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportUnicastQosPolicyTypeSupport _singleton
    = new TransportUnicastQosPolicyTypeSupport();
    ...
    */
    public static TransportUnicastQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportUnicastQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportUnicastQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportUnicastQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TransportUnicastQosPolicy();
    }
    ...
    public Class get_type() {
        return TransportUnicastQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TransportUnicastQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportUnicastQosPolicy typedDst = (TransportUnicastQosPolicy) destination;
        TransportUnicastQosPolicy typedSrc = (TransportUnicastQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportUnicastSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportUnicastSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportUnicastQosPolicy typedSrc = (TransportUnicastQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.TransportUnicastSettings_tTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.TransportUnicastSettings_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.value,4, endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportUnicastQosPolicy typedDst = (TransportUnicastQosPolicy) dst;
            typedDst.clear();      
            try{
                DDSMonitoring.TransportUnicastSettings_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.value, src, 4, endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.TransportUnicastSettings_tTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportUnicastQosPolicy typedDst = (TransportUnicastQosPolicy) sample;
    ...
    protected TransportUnicastQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportUnicastQosPolicyTypeCode.VALUE,TransportUnicastQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportUnicastQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportUnicastQosPolicyTypeCode.VALUE,TransportUnicastQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
