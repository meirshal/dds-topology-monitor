...
public class MultiChannelQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::MultiChannelQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MultiChannelQosPolicyTypeSupport _singleton
    = new MultiChannelQosPolicyTypeSupport();
    ...
    */
    public static MultiChannelQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static MultiChannelQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MultiChannelQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return MultiChannelQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new MultiChannelQosPolicy();
    }
    ...
    public Class get_type() {
        return MultiChannelQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>MultiChannelQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MultiChannelQosPolicy typedDst = (MultiChannelQosPolicy) destination;
        MultiChannelQosPolicy typedSrc = (MultiChannelQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ChannelSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, 0, 32);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ChannelSettings_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, 0, 0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MultiChannelQosPolicy typedSrc = (MultiChannelQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ChannelSettings_tTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, 0, typedSrc.channels);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(0 , typedSrc.filter_name );
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.ChannelSettings_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.channels,32, endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
            ...
            dst.writeString(typedSrc.filter_name,255);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MultiChannelQosPolicy typedDst = (MultiChannelQosPolicy) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    DDSMonitoring.ChannelSettings_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.channels, src, 32, endpoint_plugin_qos);            
                    break;
                    case 1:
                    typedDst.filter_name = src.readString(255);
                    break;
                    default:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    DDSMonitoring.ChannelSettings_tTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MultiChannelQosPolicy typedDst = (MultiChannelQosPolicy) sample;
    ...
    protected MultiChannelQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MultiChannelQosPolicyTypeCode.VALUE,MultiChannelQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MultiChannelQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MultiChannelQosPolicyTypeCode.VALUE,MultiChannelQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
