...
public class PropertyQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PropertyQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PropertyQosPolicyTypeSupport _singleton
    = new PropertyQosPolicyTypeSupport();
    ...
    */
    public static PropertyQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static PropertyQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PropertyQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return PropertyQosPolicy.create();
    }
    ...
    public Class get_type() {
        return PropertyQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>PropertyQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PropertyQosPolicy typedDst = (PropertyQosPolicy) destination;
        PropertyQosPolicy typedSrc = (PropertyQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.Property_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, (DDSMonitoring.PROPERTY_LIST_MAX_LENGTH.VALUE));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.Property_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PropertyQosPolicy typedSrc = (PropertyQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Property_tTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Property_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.value,(DDSMonitoring.PROPERTY_LIST_MAX_LENGTH.VALUE), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PropertyQosPolicy typedDst = (PropertyQosPolicy) dst;
            typedDst.clear();      
            try{
                DDSMonitoring.Property_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.value, src, (DDSMonitoring.PROPERTY_LIST_MAX_LENGTH.VALUE), endpoint_plugin_qos);            
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.Property_tTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PropertyQosPolicy typedDst = (PropertyQosPolicy) sample;
    ...
    protected PropertyQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PropertyQosPolicyTypeCode.VALUE,PropertyQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PropertyQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PropertyQosPolicyTypeCode.VALUE,PropertyQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
