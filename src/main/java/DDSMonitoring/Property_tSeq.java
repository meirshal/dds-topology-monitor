...
/**
* A sequence of Property_t instances.
*/
public final class Property_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Property_tSeq() {
        super(Property_t.class);
    }

    public Property_tSeq (int initialMaximum) {
        super(Property_t.class, initialMaximum);
    }

    public Property_tSeq (Collection elements) {
        super(Property_t.class, elements);
    }
