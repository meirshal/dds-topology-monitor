...
public class WireProtocolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::WireProtocolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WireProtocolQosPolicyTypeSupport _singleton
    = new WireProtocolQosPolicyTypeSupport();
    ...
    */
    public static WireProtocolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static WireProtocolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WireProtocolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return WireProtocolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new WireProtocolQosPolicy();
    }
    ...
    public Class get_type() {
        return WireProtocolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>WireProtocolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WireProtocolQosPolicy typedDst = (WireProtocolQosPolicy) destination;
        WireProtocolQosPolicy typedSrc = (WireProtocolQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.RtpsWellKnownPorts_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.WireProtocolQosPolicyAutoKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.RtpsWellKnownPorts_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.WireProtocolQosPolicyAutoKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WireProtocolQosPolicy typedSrc = (WireProtocolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.RtpsWellKnownPorts_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.rtps_well_known_ports);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.WireProtocolQosPolicyAutoKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.rtps_auto_id_kind);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.participant_id);

            dst.writeInt(typedSrc.rtps_host_id);

            dst.writeInt(typedSrc.rtps_app_id);

            dst.writeInt(typedSrc.rtps_instance_id);

            DDSMonitoring.RtpsWellKnownPorts_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.rtps_well_known_ports, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.rtps_reserved_port_mask);

            DDSMonitoring.WireProtocolQosPolicyAutoKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.rtps_auto_id_kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WireProtocolQosPolicy typedDst = (WireProtocolQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.participant_id = src.readInt();
                typedDst.rtps_host_id = src.readInt();
                typedDst.rtps_app_id = src.readInt();
                typedDst.rtps_instance_id = src.readInt();
                typedDst.rtps_well_known_ports = (DDSMonitoring.RtpsWellKnownPorts_t)DDSMonitoring.RtpsWellKnownPorts_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.rtps_well_known_ports, src, false, true, endpoint_plugin_qos);     
                typedDst.rtps_reserved_port_mask = src.readInt();
                typedDst.rtps_auto_id_kind = (DDSMonitoring.WireProtocolQosPolicyAutoKind)DDSMonitoring.WireProtocolQosPolicyAutoKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.rtps_auto_id_kind, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.RtpsWellKnownPorts_tTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            src.skipInt();

            DDSMonitoring.WireProtocolQosPolicyAutoKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WireProtocolQosPolicy typedDst = (WireProtocolQosPolicy) sample;
    ...
    protected WireProtocolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WireProtocolQosPolicyTypeCode.VALUE,WireProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WireProtocolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WireProtocolQosPolicyTypeCode.VALUE,WireProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
