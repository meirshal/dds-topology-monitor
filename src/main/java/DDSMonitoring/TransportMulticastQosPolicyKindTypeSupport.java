...
public class TransportMulticastQosPolicyKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportMulticastQosPolicyKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportMulticastQosPolicyKindTypeSupport _singleton
    = new TransportMulticastQosPolicyKindTypeSupport();
    ...
    */
    public static TransportMulticastQosPolicyKindTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportMulticastQosPolicyKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportMulticastQosPolicyKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return TransportMulticastQosPolicyKind.class;
    }
    ...
    * <code>this</code> is not a <code>TransportMulticastQosPolicyKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        TransportMulticastQosPolicyKind typedSrc = (TransportMulticastQosPolicyKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = TransportMulticastQosPolicyKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected TransportMulticastQosPolicyKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportMulticastQosPolicyKindTypeCode.VALUE,TransportMulticastQosPolicyKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
