...
/**
* A sequence of ServiceQosPolicy instances.
*/
public final class ServiceQosPolicySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ServiceQosPolicySeq() {
        super(ServiceQosPolicy.class);
    }

    public ServiceQosPolicySeq (int initialMaximum) {
        super(ServiceQosPolicy.class, initialMaximum);
    }

    public ServiceQosPolicySeq (Collection elements) {
        super(ServiceQosPolicy.class, elements);
    }
