...
public class LivelinessLostStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::LivelinessLostStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LivelinessLostStatusTypeSupport _singleton
    = new LivelinessLostStatusTypeSupport();
    ...
    */
    public static LivelinessLostStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static LivelinessLostStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LivelinessLostStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return LivelinessLostStatus.create();
    }
    ...
    public Object create_key() {
        return new LivelinessLostStatus();
    }
    ...
    public Class get_type() {
        return LivelinessLostStatus.class;
    }
    ...
    * <code>this</code> is not a <code>LivelinessLostStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LivelinessLostStatus typedDst = (LivelinessLostStatus) destination;
        LivelinessLostStatus typedSrc = (LivelinessLostStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LivelinessLostStatus typedSrc = (LivelinessLostStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LivelinessLostStatus typedDst = (LivelinessLostStatus) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LivelinessLostStatus typedDst = (LivelinessLostStatus) sample;
    ...
    protected LivelinessLostStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LivelinessLostStatusTypeCode.VALUE,LivelinessLostStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LivelinessLostStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LivelinessLostStatusTypeCode.VALUE,LivelinessLostStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
