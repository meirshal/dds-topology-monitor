...
public class ReliableWriterCacheEventCountTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReliableWriterCacheEventCount";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliableWriterCacheEventCountTypeSupport _singleton
    = new ReliableWriterCacheEventCountTypeSupport();
    ...
    */
    public static ReliableWriterCacheEventCountTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliableWriterCacheEventCountTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliableWriterCacheEventCountTypeCode.VALUE;
    }

    public Object create_data() {
        return ReliableWriterCacheEventCount.create();
    }
    ...
    public Object create_key() {
        return new ReliableWriterCacheEventCount();
    }
    ...
    public Class get_type() {
        return ReliableWriterCacheEventCount.class;
    }
    ...
    * <code>this</code> is not a <code>ReliableWriterCacheEventCount</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReliableWriterCacheEventCount typedDst = (ReliableWriterCacheEventCount) destination;
        ReliableWriterCacheEventCount typedSrc = (ReliableWriterCacheEventCount) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReliableWriterCacheEventCount typedSrc = (ReliableWriterCacheEventCount) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        ReliableWriterCacheEventCount src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReliableWriterCacheEventCount typedDst = (ReliableWriterCacheEventCount) dst;
    ...
    public void deserialize_from_cdr_buffer(
        ReliableWriterCacheEventCount dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReliableWriterCacheEventCount typedDst = (ReliableWriterCacheEventCount) sample;
    ...
    protected ReliableWriterCacheEventCountTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliableWriterCacheEventCountTypeCode.VALUE,ReliableWriterCacheEventCount.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReliableWriterCacheEventCountTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReliableWriterCacheEventCountTypeCode.VALUE,ReliableWriterCacheEventCount.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
