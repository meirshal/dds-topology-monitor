...
public class SubscriberProtocolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SubscriberProtocolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SubscriberProtocolQosPolicyTypeSupport _singleton
    = new SubscriberProtocolQosPolicyTypeSupport();
    ...
    */
    public static SubscriberProtocolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static SubscriberProtocolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SubscriberProtocolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return SubscriberProtocolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new SubscriberProtocolQosPolicy();
    }
    ...
    public Class get_type() {
        return SubscriberProtocolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>SubscriberProtocolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SubscriberProtocolQosPolicy typedDst = (SubscriberProtocolQosPolicy) destination;
        SubscriberProtocolQosPolicy typedSrc = (SubscriberProtocolQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SubscriberProtocolQosPolicy typedSrc = (SubscriberProtocolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        SubscriberProtocolQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SubscriberProtocolQosPolicy typedDst = (SubscriberProtocolQosPolicy) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        SubscriberProtocolQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SubscriberProtocolQosPolicy typedDst = (SubscriberProtocolQosPolicy) sample;
    ...
    protected SubscriberProtocolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SubscriberProtocolQosPolicyTypeCode.VALUE,SubscriberProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SubscriberProtocolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SubscriberProtocolQosPolicyTypeCode.VALUE,SubscriberProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
