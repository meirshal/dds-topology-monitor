...
public class LatencyBudgetQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::LatencyBudgetQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LatencyBudgetQosPolicyTypeSupport _singleton
    = new LatencyBudgetQosPolicyTypeSupport();
    ...
    */
    public static LatencyBudgetQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static LatencyBudgetQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LatencyBudgetQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return LatencyBudgetQosPolicy.create();
    }
    ...
    public Class get_type() {
        return LatencyBudgetQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>LatencyBudgetQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LatencyBudgetQosPolicy typedDst = (LatencyBudgetQosPolicy) destination;
        LatencyBudgetQosPolicy typedSrc = (LatencyBudgetQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LatencyBudgetQosPolicy typedSrc = (LatencyBudgetQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.duration);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.duration, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LatencyBudgetQosPolicy typedDst = (LatencyBudgetQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.duration = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.duration, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LatencyBudgetQosPolicy typedDst = (LatencyBudgetQosPolicy) sample;
    ...
    protected LatencyBudgetQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LatencyBudgetQosPolicyTypeCode.VALUE,LatencyBudgetQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LatencyBudgetQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LatencyBudgetQosPolicyTypeCode.VALUE,LatencyBudgetQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
