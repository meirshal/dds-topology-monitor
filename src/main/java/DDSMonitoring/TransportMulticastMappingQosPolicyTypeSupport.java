...
public class TransportMulticastMappingQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TransportMulticastMappingQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TransportMulticastMappingQosPolicyTypeSupport _singleton
    = new TransportMulticastMappingQosPolicyTypeSupport();
    ...
    */
    public static TransportMulticastMappingQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TransportMulticastMappingQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TransportMulticastMappingQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TransportMulticastMappingQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new TransportMulticastMappingQosPolicy();
    }
    ...
    public Class get_type() {
        return TransportMulticastMappingQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TransportMulticastMappingQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TransportMulticastMappingQosPolicy typedDst = (TransportMulticastMappingQosPolicy) destination;
        TransportMulticastMappingQosPolicy typedSrc = (TransportMulticastMappingQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportMulticastMapping_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 4);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.TransportMulticastMapping_tTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TransportMulticastMappingQosPolicy typedSrc = (TransportMulticastMappingQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.TransportMulticastMapping_tTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.TransportMulticastMapping_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.value,4, endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        TransportMulticastMappingQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TransportMulticastMappingQosPolicy typedDst = (TransportMulticastMappingQosPolicy) dst;
            typedDst.clear();      
            try{
                DDSMonitoring.TransportMulticastMapping_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.value, src, 4, endpoint_plugin_qos);            
    ...
    public void deserialize_from_cdr_buffer(
        TransportMulticastMappingQosPolicy dst,
        byte[] buffer,
        long length) 
    {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.TransportMulticastMapping_tTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TransportMulticastMappingQosPolicy typedDst = (TransportMulticastMappingQosPolicy) sample;
    ...
    protected TransportMulticastMappingQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TransportMulticastMappingQosPolicyTypeCode.VALUE,TransportMulticastMappingQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TransportMulticastMappingQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TransportMulticastMappingQosPolicyTypeCode.VALUE,TransportMulticastMappingQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
