...
public class DataReaderResourceLimitsQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DataReaderResourceLimitsQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataReaderResourceLimitsQosPolicyTypeSupport _singleton
    = new DataReaderResourceLimitsQosPolicyTypeSupport();
    ...
    */
    public static DataReaderResourceLimitsQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DataReaderResourceLimitsQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataReaderResourceLimitsQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DataReaderResourceLimitsQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new DataReaderResourceLimitsQosPolicy();
    }
    ...
    public Class get_type() {
        return DataReaderResourceLimitsQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DataReaderResourceLimitsQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataReaderResourceLimitsQosPolicy typedDst = (DataReaderResourceLimitsQosPolicy) destination;
        DataReaderResourceLimitsQosPolicy typedSrc = (DataReaderResourceLimitsQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataReaderResourceLimitsQosPolicy typedSrc = (DataReaderResourceLimitsQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.max_remote_writers);

            dst.writeInt(typedSrc.max_remote_writers_per_instance);

            dst.writeInt(typedSrc.max_samples_per_remote_writer);

            dst.writeInt(typedSrc.max_infos);

            dst.writeInt(typedSrc.initial_remote_writers);

            dst.writeInt(typedSrc.initial_remote_writers_per_instance);

            dst.writeInt(typedSrc.initial_infos);

            dst.writeInt(typedSrc.initial_outstanding_reads);

            dst.writeInt(typedSrc.max_outstanding_reads);

            dst.writeInt(typedSrc.max_samples_per_read);

            dst.writeBoolean(typedSrc.disable_fragmentation_support);

            dst.writeInt(typedSrc.max_fragmented_samples);

            dst.writeInt(typedSrc.initial_fragmented_samples);

            dst.writeInt(typedSrc.max_fragmented_samples_per_remote_writer);

            dst.writeInt(typedSrc.max_fragments_per_sample);

            dst.writeBoolean(typedSrc.dynamically_allocate_fragmented_samples);

            dst.writeInt(typedSrc.max_total_instances);

            dst.writeInt(typedSrc.max_remote_virtual_writers);

            dst.writeInt(typedSrc.intial_remote_virtual_writers);

            dst.writeInt(typedSrc.max_remote_virtual_writers_per_instance);

            dst.writeInt(typedSrc.initial_remote_virtual_writers_per_instance);

            dst.writeInt(typedSrc.max_remote_writers_per_sample);

            dst.writeInt(typedSrc.max_query_condition_filters);

            dst.writeInt(typedSrc.max_app_ack_response_length);

            dst.writeBoolean(typedSrc.keep_minimum_state_for_instances);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DataReaderResourceLimitsQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataReaderResourceLimitsQosPolicy typedDst = (DataReaderResourceLimitsQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.max_remote_writers = src.readInt();
                typedDst.max_remote_writers_per_instance = src.readInt();
                typedDst.max_samples_per_remote_writer = src.readInt();
                typedDst.max_infos = src.readInt();
                typedDst.initial_remote_writers = src.readInt();
                typedDst.initial_remote_writers_per_instance = src.readInt();
                typedDst.initial_infos = src.readInt();
                typedDst.initial_outstanding_reads = src.readInt();
                typedDst.max_outstanding_reads = src.readInt();
                typedDst.max_samples_per_read = src.readInt();
                typedDst.disable_fragmentation_support = src.readBoolean();
                typedDst.max_fragmented_samples = src.readInt();
                typedDst.initial_fragmented_samples = src.readInt();
                typedDst.max_fragmented_samples_per_remote_writer = src.readInt();
                typedDst.max_fragments_per_sample = src.readInt();
                typedDst.dynamically_allocate_fragmented_samples = src.readBoolean();
                typedDst.max_total_instances = src.readInt();
                typedDst.max_remote_virtual_writers = src.readInt();
                typedDst.intial_remote_virtual_writers = src.readInt();
                typedDst.max_remote_virtual_writers_per_instance = src.readInt();
                typedDst.initial_remote_virtual_writers_per_instance = src.readInt();
                typedDst.max_remote_writers_per_sample = src.readInt();
                typedDst.max_query_condition_filters = src.readInt();
                typedDst.max_app_ack_response_length = src.readInt();
                typedDst.keep_minimum_state_for_instances = src.readBoolean();
    ...
    public void deserialize_from_cdr_buffer(
        DataReaderResourceLimitsQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataReaderResourceLimitsQosPolicy typedDst = (DataReaderResourceLimitsQosPolicy) sample;
    ...
    protected DataReaderResourceLimitsQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataReaderResourceLimitsQosPolicyTypeCode.VALUE,DataReaderResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataReaderResourceLimitsQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataReaderResourceLimitsQosPolicyTypeCode.VALUE,DataReaderResourceLimitsQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
