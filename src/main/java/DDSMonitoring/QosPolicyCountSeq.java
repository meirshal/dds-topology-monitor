...
/**
* A sequence of QosPolicyCount instances.
*/
public final class QosPolicyCountSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public QosPolicyCountSeq() {
        super(QosPolicyCount.class);
    }

    public QosPolicyCountSeq (int initialMaximum) {
        super(QosPolicyCount.class, initialMaximum);
    }

    public QosPolicyCountSeq (Collection elements) {
        super(QosPolicyCount.class, elements);
    }
