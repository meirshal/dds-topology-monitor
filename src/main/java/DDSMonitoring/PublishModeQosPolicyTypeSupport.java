...
public class PublishModeQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PublishModeQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PublishModeQosPolicyTypeSupport _singleton
    = new PublishModeQosPolicyTypeSupport();
    ...
    */
    public static PublishModeQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static PublishModeQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PublishModeQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return PublishModeQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new PublishModeQosPolicy();
    }
    ...
    public Class get_type() {
        return PublishModeQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>PublishModeQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PublishModeQosPolicy typedDst = (PublishModeQosPolicy) destination;
        PublishModeQosPolicy typedSrc = (PublishModeQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.PublishModeQosPolicyKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.PublishModeQosPolicyKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PublishModeQosPolicy typedSrc = (PublishModeQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.PublishModeQosPolicyKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.kind);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.flow_controller_name );
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.PublishModeQosPolicyKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.kind, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.flow_controller_name,255);

            dst.writeInt(typedSrc.priority);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PublishModeQosPolicy typedDst = (PublishModeQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.kind = (DDSMonitoring.PublishModeQosPolicyKind)DDSMonitoring.PublishModeQosPolicyKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.kind, src, false, true, endpoint_plugin_qos);     
                typedDst.flow_controller_name = src.readString(255);
                typedDst.priority = src.readInt();
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.PublishModeQosPolicyKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PublishModeQosPolicy typedDst = (PublishModeQosPolicy) sample;
    ...
    protected PublishModeQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PublishModeQosPolicyTypeCode.VALUE,PublishModeQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PublishModeQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PublishModeQosPolicyTypeCode.VALUE,PublishModeQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
