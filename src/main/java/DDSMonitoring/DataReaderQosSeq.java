...
/**
* A sequence of DataReaderQos instances.
*/
public final class DataReaderQosSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DataReaderQosSeq() {
        super(DataReaderQos.class);
    }

    public DataReaderQosSeq (int initialMaximum) {
        super(DataReaderQos.class, initialMaximum);
    }

    public DataReaderQosSeq (Collection elements) {
        super(DataReaderQos.class, elements);
    }
