...
public class ParticipantBuiltinTopicDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ParticipantBuiltinTopicData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ParticipantBuiltinTopicDataTypeSupport _singleton
    ...
    */
    public static ParticipantBuiltinTopicDataTypeSupport get_instance() {
        return _singleton;
    }

    public static ParticipantBuiltinTopicDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ParticipantBuiltinTopicDataTypeCode.VALUE;
    }

    public Object create_data() {
        return ParticipantBuiltinTopicData.create();
    }
    ...
    public Class get_type() {
        return ParticipantBuiltinTopicData.class;
    }
    ...
    * <code>this</code> is not a <code>ParticipantBuiltinTopicData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ParticipantBuiltinTopicData typedDst = (ParticipantBuiltinTopicData) destination;
        ParticipantBuiltinTopicData typedSrc = (ParticipantBuiltinTopicData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.UserDataQosPolicyTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += DDSMonitoring.UserDataQosPolicyTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ParticipantBuiltinTopicData typedSrc = (ParticipantBuiltinTopicData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.key);
        currentAlignment += DDSMonitoring.UserDataQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.user_data);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        ParticipantBuiltinTopicData src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ParticipantBuiltinTopicData typedDst = (ParticipantBuiltinTopicData) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        ParticipantBuiltinTopicData dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ParticipantBuiltinTopicData typedDst = (ParticipantBuiltinTopicData) sample;
    ...
    protected ParticipantBuiltinTopicDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ParticipantBuiltinTopicDataTypeCode.VALUE,ParticipantBuiltinTopicData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ParticipantBuiltinTopicDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ParticipantBuiltinTopicDataTypeCode.VALUE,ParticipantBuiltinTopicData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
