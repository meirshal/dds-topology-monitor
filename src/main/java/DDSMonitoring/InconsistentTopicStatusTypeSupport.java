...
public class InconsistentTopicStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::InconsistentTopicStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InconsistentTopicStatusTypeSupport _singleton
    = new InconsistentTopicStatusTypeSupport();
    ...
    */
    public static InconsistentTopicStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static InconsistentTopicStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InconsistentTopicStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return InconsistentTopicStatus.create();
    }
    ...
    public Object create_key() {
        return new InconsistentTopicStatus();
    }
    ...
    public Class get_type() {
        return InconsistentTopicStatus.class;
    }
    ...
    * <code>this</code> is not a <code>InconsistentTopicStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InconsistentTopicStatus typedDst = (InconsistentTopicStatus) destination;
        InconsistentTopicStatus typedSrc = (InconsistentTopicStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        InconsistentTopicStatus typedSrc = (InconsistentTopicStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InconsistentTopicStatus typedDst = (InconsistentTopicStatus) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InconsistentTopicStatus typedDst = (InconsistentTopicStatus) sample;
    ...
    protected InconsistentTopicStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,InconsistentTopicStatusTypeCode.VALUE,InconsistentTopicStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InconsistentTopicStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InconsistentTopicStatusTypeCode.VALUE,InconsistentTopicStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
