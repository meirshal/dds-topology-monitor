...
public class DataWriterProtocolQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::DataWriterProtocolQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataWriterProtocolQosPolicyTypeSupport _singleton
    = new DataWriterProtocolQosPolicyTypeSupport();
    ...
    */
    public static DataWriterProtocolQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static DataWriterProtocolQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataWriterProtocolQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return DataWriterProtocolQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new DataWriterProtocolQosPolicy();
    }
    ...
    public Class get_type() {
        return DataWriterProtocolQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>DataWriterProtocolQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataWriterProtocolQosPolicy typedDst = (DataWriterProtocolQosPolicy) destination;
        DataWriterProtocolQosPolicy typedSrc = (DataWriterProtocolQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.GUID_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SequenceNumber_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0 );
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.GUID_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SequenceNumber_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment += CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0 );
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataWriterProtocolQosPolicy typedSrc = (DataWriterProtocolQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.GUID_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.virtual_guid);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0);
        ...
        currentAlignment += DDSMonitoring.RtpsReliableWriterProtocol_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.rtps_reliable_writer);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.SequenceNumber_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.initial_virtual_sequence_number);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.GUID_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.virtual_guid, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
            ...
            memberId = 1;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.rtps_object_id);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 2;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.push_on_write);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 3;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.disable_positive_acks);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 4;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.disable_inline_keyhash);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 5;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.serialize_key_with_dispose);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 9;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.propagate_app_ack_with_no_response);
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.RtpsReliableWriterProtocol_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.rtps_reliable_writer, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.SequenceNumber_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.initial_virtual_sequence_number, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberId = 8;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeBoolean(typedSrc.vendor_specific_entity);
            dst.writeMemberLength(memberLengthPosition, false);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DataWriterProtocolQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataWriterProtocolQosPolicy typedDst = (DataWriterProtocolQosPolicy) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.virtual_guid = (DDSMonitoring.GUID_t)DDSMonitoring.GUID_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.virtual_guid, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 1:
                    typedDst.rtps_object_id = src.readInt();
                    break;
                    case 2:
                    typedDst.push_on_write = src.readBoolean();
                    break;
                    case 3:
                    typedDst.disable_positive_acks = src.readBoolean();
                    break;
                    case 4:
                    typedDst.disable_inline_keyhash = src.readBoolean();
                    break;
                    case 5:
                    typedDst.serialize_key_with_dispose = src.readBoolean();
                    break;
                    case 9:
                    typedDst.propagate_app_ack_with_no_response = src.readBoolean();
                    break;
                    case 6:
                    typedDst.rtps_reliable_writer = (DDSMonitoring.RtpsReliableWriterProtocol_t)DDSMonitoring.RtpsReliableWriterProtocol_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.rtps_reliable_writer, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 7:
                    typedDst.initial_virtual_sequence_number = (DDSMonitoring.SequenceNumber_t)DDSMonitoring.SequenceNumber_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.initial_virtual_sequence_number, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 8:
                    typedDst.vendor_specific_entity = src.readBoolean();
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        DataWriterProtocolQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataWriterProtocolQosPolicy typedDst = (DataWriterProtocolQosPolicy) sample;
    ...
    protected DataWriterProtocolQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DataWriterProtocolQosPolicyTypeCode.VALUE,DataWriterProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataWriterProtocolQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataWriterProtocolQosPolicyTypeCode.VALUE,DataWriterProtocolQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
