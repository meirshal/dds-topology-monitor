...
public class Locator_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::Locator_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final Locator_tTypeSupport _singleton
    = new Locator_tTypeSupport();
    ...
    */
    public static Locator_tTypeSupport get_instance() {
        return _singleton;
    }

    public static Locator_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return Locator_tTypeCode.VALUE;
    }

    public Object create_data() {
        return Locator_t.create();
    }
    ...
    * <code>this</code> is not a <code>Locator_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Locator_t typedDst = (Locator_t) destination;
        Locator_t typedSrc = (Locator_t) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.BYTE.getArrayMaxSizeSerialized(currentAlignment,  ((DDSMonitoring.LOCATOR_ADDRESS_LENGTH_MAX.VALUE)));
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Locator_t typedSrc = (Locator_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.kind);

            dst.writeInt(typedSrc.port);

            for(int i1__ = 0; i1__< (DDSMonitoring.LOCATOR_ADDRESS_LENGTH_MAX.VALUE); ++i1__){

                dst.writeByte(typedSrc.address[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Locator_t typedDst = (Locator_t) dst;
            typedDst.clear();      
            try{
                typedDst.kind = src.readInt();
                typedDst.port = src.readInt();
                for(int i1__ = 0; i1__< (DDSMonitoring.LOCATOR_ADDRESS_LENGTH_MAX.VALUE); ++i1__){

                    typedDst.address[i1__] = src.readByte();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Locator_t typedDst = (Locator_t) sample;
    ...
    protected Locator_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Locator_tTypeCode.VALUE,Locator_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected Locator_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,Locator_tTypeCode.VALUE,Locator_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
