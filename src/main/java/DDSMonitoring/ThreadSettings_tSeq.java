...
/**
* A sequence of ThreadSettings_t instances.
*/
public final class ThreadSettings_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ThreadSettings_tSeq() {
        super(ThreadSettings_t.class);
    }

    public ThreadSettings_tSeq (int initialMaximum) {
        super(ThreadSettings_t.class, initialMaximum);
    }

    public ThreadSettings_tSeq (Collection elements) {
        super(ThreadSettings_t.class, elements);
    }
