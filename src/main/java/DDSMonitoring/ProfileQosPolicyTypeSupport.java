...
public class ProfileQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ProfileQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ProfileQosPolicyTypeSupport _singleton
    = new ProfileQosPolicyTypeSupport();
    ...
    */
    public static ProfileQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static ProfileQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ProfileQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return ProfileQosPolicy.create();
    }
    ...
    * <code>this</code> is not a <code>ProfileQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ProfileQosPolicy typedDst = (ProfileQosPolicy) destination;
        ProfileQosPolicy typedSrc = (ProfileQosPolicy) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringSeqMaxSizeSerialized(
            currentAlignment, (2000)+1,(256));
        currentAlignment += CdrPrimitiveType.getStringSeqMaxSizeSerialized(
            currentAlignment, (255)+1,(256));
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ProfileQosPolicy typedSrc = (ProfileQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSeqSerializedSize(
            currentAlignment , typedSrc.string_profile );
        currentAlignment  +=  CdrPrimitiveType.getStringSeqSerializedSize(
            currentAlignment , typedSrc.url_profile );
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSeqSerializedSize(
            currentAlignment , typedSrc.string_profile_dtd );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeStringSeq(typedSrc.string_profile,(2000),256);

            dst.writeStringSeq(typedSrc.url_profile,(255),256);

            dst.writeBoolean(typedSrc.ignore_user_profile);

            dst.writeBoolean(typedSrc.ignore_environment_profile);

            dst.writeBoolean(typedSrc.ignore_resource_profile);

            dst.writeStringSeq(typedSrc.string_profile_dtd,(2000),256);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ProfileQosPolicy typedDst = (ProfileQosPolicy) dst;
            typedDst.clear();      
            try{
                src.readStringSequence(typedDst.string_profile, 256);
                src.readStringSequence(typedDst.url_profile, 256);
                typedDst.ignore_user_profile = src.readBoolean();
                typedDst.ignore_environment_profile = src.readBoolean();
                typedDst.ignore_resource_profile = src.readBoolean();
                src.readStringSequence(typedDst.string_profile_dtd, 256);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ProfileQosPolicy typedDst = (ProfileQosPolicy) sample;
    ...
    protected ProfileQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ProfileQosPolicyTypeCode.VALUE,ProfileQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ProfileQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ProfileQosPolicyTypeCode.VALUE,ProfileQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
