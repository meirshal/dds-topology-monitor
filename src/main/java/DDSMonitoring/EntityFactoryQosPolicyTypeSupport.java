...
public class EntityFactoryQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::EntityFactoryQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EntityFactoryQosPolicyTypeSupport _singleton
    = new EntityFactoryQosPolicyTypeSupport();
    ...
    */
    public static EntityFactoryQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static EntityFactoryQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EntityFactoryQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return EntityFactoryQosPolicy.create();
    }
    ...
    public Class get_type() {
        return EntityFactoryQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>EntityFactoryQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EntityFactoryQosPolicy typedDst = (EntityFactoryQosPolicy) destination;
        EntityFactoryQosPolicy typedSrc = (EntityFactoryQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EntityFactoryQosPolicy typedSrc = (EntityFactoryQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.autoenable_created_entities);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EntityFactoryQosPolicy typedDst = (EntityFactoryQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.autoenable_created_entities = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EntityFactoryQosPolicy typedDst = (EntityFactoryQosPolicy) sample;
    ...
    protected EntityFactoryQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EntityFactoryQosPolicyTypeCode.VALUE,EntityFactoryQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EntityFactoryQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EntityFactoryQosPolicyTypeCode.VALUE,EntityFactoryQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
