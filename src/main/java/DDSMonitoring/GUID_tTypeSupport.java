...
public class GUID_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::GUID_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GUID_tTypeSupport _singleton
    = new GUID_tTypeSupport();
    ...
    */
    public static GUID_tTypeSupport get_instance() {
        return _singleton;
    }

    public static GUID_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GUID_tTypeCode.VALUE;
    }

    public Object create_data() {
        return GUID_t.create();
    }
    ...
    * <code>this</code> is not a <code>GUID_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GUID_t typedDst = (GUID_t) destination;
        GUID_t typedSrc = (GUID_t) source;
    ...
    protected GUID_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GUID_tTypeCode.VALUE,GUID_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GUID_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GUID_tTypeCode.VALUE,GUID_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
