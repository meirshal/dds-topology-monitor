...
public class ReaderDataLifecycleQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ReaderDataLifecycleQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReaderDataLifecycleQosPolicyTypeSupport _singleton
    = new ReaderDataLifecycleQosPolicyTypeSupport();
    ...
    */
    public static ReaderDataLifecycleQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static ReaderDataLifecycleQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReaderDataLifecycleQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return ReaderDataLifecycleQosPolicy.create();
    }
    ...
    public Class get_type() {
        return ReaderDataLifecycleQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>ReaderDataLifecycleQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReaderDataLifecycleQosPolicy typedDst = (ReaderDataLifecycleQosPolicy) destination;
        ReaderDataLifecycleQosPolicy typedSrc = (ReaderDataLifecycleQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReaderDataLifecycleQosPolicy typedSrc = (ReaderDataLifecycleQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.autopurge_nowriter_samples_delay);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.autopurge_disposed_samples_delay);
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.autopurge_disposed_instances_delay);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.autopurge_nowriter_samples_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.autopurge_disposed_samples_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.autopurge_disposed_instances_delay, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        ReaderDataLifecycleQosPolicy src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReaderDataLifecycleQosPolicy typedDst = (ReaderDataLifecycleQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.autopurge_nowriter_samples_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.autopurge_nowriter_samples_delay, src, false, true, endpoint_plugin_qos);     
                typedDst.autopurge_disposed_samples_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.autopurge_disposed_samples_delay, src, false, true, endpoint_plugin_qos);     
                typedDst.autopurge_disposed_instances_delay = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.autopurge_disposed_instances_delay, src, false, true, endpoint_plugin_qos);     
    ...
    public void deserialize_from_cdr_buffer(
        ReaderDataLifecycleQosPolicy dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReaderDataLifecycleQosPolicy typedDst = (ReaderDataLifecycleQosPolicy) sample;
    ...
    protected ReaderDataLifecycleQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReaderDataLifecycleQosPolicyTypeCode.VALUE,ReaderDataLifecycleQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReaderDataLifecycleQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReaderDataLifecycleQosPolicyTypeCode.VALUE,ReaderDataLifecycleQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
