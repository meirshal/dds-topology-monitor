...
public class ChannelSettings_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ChannelSettings_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ChannelSettings_tTypeSupport _singleton
    = new ChannelSettings_tTypeSupport();
    ...
    */
    public static ChannelSettings_tTypeSupport get_instance() {
        return _singleton;
    }

    public static ChannelSettings_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ChannelSettings_tTypeCode.VALUE;
    }

    public Object create_data() {
        return ChannelSettings_t.create();
    }
    ...
    public Class get_type() {
        return ChannelSettings_t.class;
    }
    ...
    * <code>this</code> is not a <code>ChannelSettings_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ChannelSettings_t typedDst = (ChannelSettings_t) destination;
        ChannelSettings_t typedSrc = (ChannelSettings_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ChannelSettings_t typedSrc = (ChannelSettings_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().get_sequence_serialized_size(
            endpoint_data, currentAlignment, typedSrc.multicast_settings);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.filter_expression );
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.multicast_settings,4, endpoint_plugin_qos);

            dst.writeString(typedSrc.filter_expression,255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ChannelSettings_t typedDst = (ChannelSettings_t) dst;
            typedDst.clear();      
            try{
                DDSMonitoring.TransportMulticastSettings_tTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.multicast_settings, src, 4, endpoint_plugin_qos);            
                typedDst.filter_expression = src.readString(255);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ChannelSettings_t typedDst = (ChannelSettings_t) sample;
    ...
    protected ChannelSettings_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ChannelSettings_tTypeCode.VALUE,ChannelSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ChannelSettings_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ChannelSettings_tTypeCode.VALUE,ChannelSettings_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
