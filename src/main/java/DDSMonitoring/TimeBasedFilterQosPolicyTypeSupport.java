...
public class TimeBasedFilterQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::TimeBasedFilterQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TimeBasedFilterQosPolicyTypeSupport _singleton
    = new TimeBasedFilterQosPolicyTypeSupport();
    ...
    */
    public static TimeBasedFilterQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static TimeBasedFilterQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TimeBasedFilterQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return TimeBasedFilterQosPolicy.create();
    }
    ...
    public Class get_type() {
        return TimeBasedFilterQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>TimeBasedFilterQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TimeBasedFilterQosPolicy typedDst = (TimeBasedFilterQosPolicy) destination;
        TimeBasedFilterQosPolicy typedSrc = (TimeBasedFilterQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TimeBasedFilterQosPolicy typedSrc = (TimeBasedFilterQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.Duration_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.minimum_separation);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.Duration_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.minimum_separation, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TimeBasedFilterQosPolicy typedDst = (TimeBasedFilterQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.minimum_separation = (DDSMonitoring.Duration_t)DDSMonitoring.Duration_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.minimum_separation, src, false, true, endpoint_plugin_qos);     
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TimeBasedFilterQosPolicy typedDst = (TimeBasedFilterQosPolicy) sample;
    ...
    protected TimeBasedFilterQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TimeBasedFilterQosPolicyTypeCode.VALUE,TimeBasedFilterQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TimeBasedFilterQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TimeBasedFilterQosPolicyTypeCode.VALUE,TimeBasedFilterQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
