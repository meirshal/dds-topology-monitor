...
/**
* A sequence of Locator_t instances.
*/
public final class Locator_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public Locator_tSeq() {
        super(Locator_t.class);
    }

    public Locator_tSeq (int initialMaximum) {
        super(Locator_t.class, initialMaximum);
    }

    public Locator_tSeq (Collection elements) {
        super(Locator_t.class, elements);
    }
