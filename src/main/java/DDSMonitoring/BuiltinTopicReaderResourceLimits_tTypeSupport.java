...
public class BuiltinTopicReaderResourceLimits_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::BuiltinTopicReaderResourceLimits_t";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BuiltinTopicReaderResourceLimits_tTypeSupport _singleton
    = new BuiltinTopicReaderResourceLimits_tTypeSupport();
    ...
    */
    public static BuiltinTopicReaderResourceLimits_tTypeSupport get_instance() {
        return _singleton;
    }

    public static BuiltinTopicReaderResourceLimits_tTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BuiltinTopicReaderResourceLimits_tTypeCode.VALUE;
    }

    public Object create_data() {
        return BuiltinTopicReaderResourceLimits_t.create();
    }
    ...
    public Object create_key() {
        return new BuiltinTopicReaderResourceLimits_t();
    }
    ...
    public Class get_type() {
        return BuiltinTopicReaderResourceLimits_t.class;
    }
    ...
    * <code>this</code> is not a <code>BuiltinTopicReaderResourceLimits_t</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BuiltinTopicReaderResourceLimits_t typedDst = (BuiltinTopicReaderResourceLimits_t) destination;
        BuiltinTopicReaderResourceLimits_t typedSrc = (BuiltinTopicReaderResourceLimits_t) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BuiltinTopicReaderResourceLimits_t typedSrc = (BuiltinTopicReaderResourceLimits_t) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.initial_samples);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        BuiltinTopicReaderResourceLimits_t src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BuiltinTopicReaderResourceLimits_t typedDst = (BuiltinTopicReaderResourceLimits_t) dst;
            typedDst.clear();      
            try{
                typedDst.initial_samples = src.readInt();
    ...
    public void deserialize_from_cdr_buffer(
        BuiltinTopicReaderResourceLimits_t dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BuiltinTopicReaderResourceLimits_t typedDst = (BuiltinTopicReaderResourceLimits_t) sample;
    ...
    protected BuiltinTopicReaderResourceLimits_tTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BuiltinTopicReaderResourceLimits_tTypeCode.VALUE,BuiltinTopicReaderResourceLimits_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BuiltinTopicReaderResourceLimits_tTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BuiltinTopicReaderResourceLimits_tTypeCode.VALUE,BuiltinTopicReaderResourceLimits_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
