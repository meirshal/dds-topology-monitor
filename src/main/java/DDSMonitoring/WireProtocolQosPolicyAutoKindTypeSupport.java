...
public class WireProtocolQosPolicyAutoKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::WireProtocolQosPolicyAutoKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WireProtocolQosPolicyAutoKindTypeSupport _singleton
    = new WireProtocolQosPolicyAutoKindTypeSupport();
    ...
    */
    public static WireProtocolQosPolicyAutoKindTypeSupport get_instance() {
        return _singleton;
    }

    public static WireProtocolQosPolicyAutoKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WireProtocolQosPolicyAutoKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return WireProtocolQosPolicyAutoKind.class;
    }
    ...
    * <code>this</code> is not a <code>WireProtocolQosPolicyAutoKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        WireProtocolQosPolicyAutoKind typedSrc = (WireProtocolQosPolicyAutoKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = WireProtocolQosPolicyAutoKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected WireProtocolQosPolicyAutoKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WireProtocolQosPolicyAutoKindTypeCode.VALUE,WireProtocolQosPolicyAutoKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
