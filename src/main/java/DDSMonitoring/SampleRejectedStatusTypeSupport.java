...
public class SampleRejectedStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SampleRejectedStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SampleRejectedStatusTypeSupport _singleton
    = new SampleRejectedStatusTypeSupport();
    ...
    */
    public static SampleRejectedStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static SampleRejectedStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SampleRejectedStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return SampleRejectedStatus.create();
    }
    ...
    public Class get_type() {
        return SampleRejectedStatus.class;
    }
    ...
    * <code>this</code> is not a <code>SampleRejectedStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SampleRejectedStatus typedDst = (SampleRejectedStatus) destination;
        SampleRejectedStatus typedSrc = (SampleRejectedStatus) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.SampleRejectedStatusKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += DDSMonitoring.SampleRejectedStatusKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SampleRejectedStatus typedSrc = (SampleRejectedStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += DDSMonitoring.SampleRejectedStatusKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.last_reason);
        currentAlignment += DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.last_instance_handle);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.total_count);

            dst.writeInt(typedSrc.total_count_change);

            DDSMonitoring.SampleRejectedStatusKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.last_reason, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().serialize(endpoint_data, typedSrc.last_instance_handle, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SampleRejectedStatus typedDst = (SampleRejectedStatus) dst;
            typedDst.clear();      
            try{
                typedDst.total_count = src.readInt();
                typedDst.total_count_change = src.readInt();
                typedDst.last_reason = (DDSMonitoring.SampleRejectedStatusKind)DDSMonitoring.SampleRejectedStatusKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.last_reason, src, false, true, endpoint_plugin_qos);     
                typedDst.last_instance_handle = (DDSMonitoring.RTIInstanceHandle)DDSMonitoring.RTIInstanceHandleTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.last_instance_handle, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            DDSMonitoring.SampleRejectedStatusKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SampleRejectedStatus typedDst = (SampleRejectedStatus) sample;
    ...
    protected SampleRejectedStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SampleRejectedStatusTypeCode.VALUE,SampleRejectedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SampleRejectedStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SampleRejectedStatusTypeCode.VALUE,SampleRejectedStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
