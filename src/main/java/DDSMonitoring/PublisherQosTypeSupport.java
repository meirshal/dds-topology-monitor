...
public class PublisherQosTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::PublisherQos";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PublisherQosTypeSupport _singleton
    = new PublisherQosTypeSupport();
    ...
    */
    public static PublisherQosTypeSupport get_instance() {
        return _singleton;
    }

    public static PublisherQosTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PublisherQosTypeCode.VALUE;
    }

    public Object create_data() {
        return PublisherQos.create();
    }
    ...
    * <code>this</code> is not a <code>PublisherQos</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PublisherQos typedDst = (PublisherQos) destination;
        PublisherQos typedSrc = (PublisherQos) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.PublisherProtocolQosPolicyTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.PublisherProtocolQosPolicyTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PublisherQos typedSrc = (PublisherQos) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.PublisherProtocolQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment += DDSMonitoring.EntityNameQosPolicyTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.publisher_name);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.PublisherProtocolQosPolicyTypeSupport.get_instance().serialize(endpoint_data, typedSrc.protocol, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.EntityNameQosPolicyTypeSupport.get_instance().serialize(endpoint_data, typedSrc.publisher_name, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PublisherQos typedDst = (PublisherQos) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 6:
                    typedDst.protocol = (DDSMonitoring.PublisherProtocolQosPolicy)DDSMonitoring.PublisherProtocolQosPolicyTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.protocol, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 7:
                    typedDst.publisher_name = (DDSMonitoring.EntityNameQosPolicy)DDSMonitoring.EntityNameQosPolicyTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.publisher_name, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 6:
                    DDSMonitoring.PublisherProtocolQosPolicyTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PublisherQos typedDst = (PublisherQos) sample;
    ...
    protected PublisherQosTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PublisherQosTypeCode.VALUE,PublisherQos.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PublisherQosTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PublisherQosTypeCode.VALUE,PublisherQos.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
