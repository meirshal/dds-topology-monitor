...
public class RTIInstanceHandleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::RTIInstanceHandle";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RTIInstanceHandleTypeSupport _singleton
    = new RTIInstanceHandleTypeSupport();
    ...
    */
    public static RTIInstanceHandleTypeSupport get_instance() {
        return _singleton;
    }

    public static RTIInstanceHandleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RTIInstanceHandleTypeCode.VALUE;
    }

    public Object create_data() {
        return RTIInstanceHandle.create();
    }
    ...
    public Class get_type() {
        return RTIInstanceHandle.class;
    }
    ...
    * <code>this</code> is not a <code>RTIInstanceHandle</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RTIInstanceHandle typedDst = (RTIInstanceHandle) destination;
        RTIInstanceHandle typedSrc = (RTIInstanceHandle) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.BYTE.getArrayMaxSizeSerialized(currentAlignment,  (16));
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RTIInstanceHandle typedSrc = (RTIInstanceHandle) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 16; ++i1__){
                ...
                dst.writeByte(typedSrc.value[i1__]);
            }

            dst.writeInt(typedSrc.length);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RTIInstanceHandle typedDst = (RTIInstanceHandle) dst;
            for(int i1__ = 0; i1__< 16; ++i1__){

                typedDst.value[i1__] = src.readByte();
            }

            typedDst.length = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RTIInstanceHandle typedDst = (RTIInstanceHandle) sample;
    ...
    protected RTIInstanceHandleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RTIInstanceHandleTypeCode.VALUE,RTIInstanceHandle.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RTIInstanceHandleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RTIInstanceHandleTypeCode.VALUE,RTIInstanceHandle.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
