...
/**
* A sequence of BatchQosPolicy instances.
*/
public final class BatchQosPolicySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BatchQosPolicySeq() {
        super(BatchQosPolicy.class);
    }

    public BatchQosPolicySeq (int initialMaximum) {
        super(BatchQosPolicy.class, initialMaximum);
    }

    public BatchQosPolicySeq (Collection elements) {
        super(BatchQosPolicy.class, elements);
    }
