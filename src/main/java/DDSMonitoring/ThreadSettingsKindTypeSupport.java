...
public class ThreadSettingsKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ThreadSettingsKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ThreadSettingsKindTypeSupport _singleton
    = new ThreadSettingsKindTypeSupport();
    ...
    */
    public static ThreadSettingsKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ThreadSettingsKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ThreadSettingsKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ThreadSettingsKind.class;
    }
    ...
    * <code>this</code> is not a <code>ThreadSettingsKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ThreadSettingsKind typedSrc = (ThreadSettingsKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ThreadSettingsKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ThreadSettingsKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ThreadSettingsKindTypeCode.VALUE,ThreadSettingsKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
