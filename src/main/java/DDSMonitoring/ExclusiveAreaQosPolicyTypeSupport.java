...
public class ExclusiveAreaQosPolicyTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::ExclusiveAreaQosPolicy";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ExclusiveAreaQosPolicyTypeSupport _singleton
    = new ExclusiveAreaQosPolicyTypeSupport();
    ...
    */
    public static ExclusiveAreaQosPolicyTypeSupport get_instance() {
        return _singleton;
    }

    public static ExclusiveAreaQosPolicyTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ExclusiveAreaQosPolicyTypeCode.VALUE;
    }

    public Object create_data() {
        return ExclusiveAreaQosPolicy.create();
    }
    ...
    public Object create_key() {
        return new ExclusiveAreaQosPolicy();
    }
    ...
    public Class get_type() {
        return ExclusiveAreaQosPolicy.class;
    }
    ...
    * <code>this</code> is not a <code>ExclusiveAreaQosPolicy</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ExclusiveAreaQosPolicy typedDst = (ExclusiveAreaQosPolicy) destination;
        ExclusiveAreaQosPolicy typedSrc = (ExclusiveAreaQosPolicy) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ExclusiveAreaQosPolicy typedSrc = (ExclusiveAreaQosPolicy) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.use_shared_exclusive_area);

            dst.writeInt(typedSrc.level);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ExclusiveAreaQosPolicy typedDst = (ExclusiveAreaQosPolicy) dst;
            typedDst.clear();      
            try{
                typedDst.use_shared_exclusive_area = src.readBoolean();
                typedDst.level = src.readInt();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ExclusiveAreaQosPolicy typedDst = (ExclusiveAreaQosPolicy) sample;
    ...
    protected ExclusiveAreaQosPolicyTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ExclusiveAreaQosPolicyTypeCode.VALUE,ExclusiveAreaQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ExclusiveAreaQosPolicyTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ExclusiveAreaQosPolicyTypeCode.VALUE,ExclusiveAreaQosPolicy.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
