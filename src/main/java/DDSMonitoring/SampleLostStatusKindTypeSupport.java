...
public class SampleLostStatusKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "DDSMonitoring::SampleLostStatusKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SampleLostStatusKindTypeSupport _singleton
    = new SampleLostStatusKindTypeSupport();
    ...
    */
    public static SampleLostStatusKindTypeSupport get_instance() {
        return _singleton;
    }

    public static SampleLostStatusKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SampleLostStatusKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return SampleLostStatusKind.class;
    }
    ...
    * <code>this</code> is not a <code>SampleLostStatusKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        SampleLostStatusKind typedSrc = (SampleLostStatusKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SampleLostStatusKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected SampleLostStatusKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SampleLostStatusKindTypeCode.VALUE,SampleLostStatusKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
