...
/**
* A sequence of StringSequence instances.
*/
public final class StringSequenceSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public StringSequenceSeq() {
        super(StringSequence.class);
    }

    public StringSequenceSeq (int initialMaximum) {
        super(StringSequence.class, initialMaximum);
    }

    public StringSequenceSeq (Collection elements) {
        super(StringSequence.class, elements);
    }
