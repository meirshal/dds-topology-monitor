...
* DiscreteVariableStatistics
*/

public class DiscreteVariableStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::monitoring::DiscreteVariableStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DiscreteVariableStatisticsTypeSupport _singleton
    = new DiscreteVariableStatisticsTypeSupport();
    ...
    */
    public static DiscreteVariableStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static DiscreteVariableStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DiscreteVariableStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return DiscreteVariableStatistics.create();
    }
    ...
    public Object create_key() {
        return new DiscreteVariableStatistics();
    }
    ...
    public Class get_type() {
        return DiscreteVariableStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>DiscreteVariableStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DiscreteVariableStatistics typedDst = (DiscreteVariableStatistics) destination;
        DiscreteVariableStatistics typedSrc = (DiscreteVariableStatistics) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DiscreteVariableStatistics typedSrc = (DiscreteVariableStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeDouble(typedSrc.mean);

            dst.writeLong(typedSrc.minimum);

            dst.writeLong(typedSrc.maximum);

            dst.writeDouble(typedSrc.variance);
        }
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DiscreteVariableStatistics src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DiscreteVariableStatistics typedDst = (DiscreteVariableStatistics) dst;
            typedDst.clear();      
            try{
                typedDst.mean = src.readDouble();
                typedDst.minimum = src.readLong();
                typedDst.maximum = src.readLong();
                typedDst.variance = src.readDouble();
    ...
    public void deserialize_from_cdr_buffer(
        DiscreteVariableStatistics dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DiscreteVariableStatistics typedDst = (DiscreteVariableStatistics) sample;
    ...
    protected DiscreteVariableStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DiscreteVariableStatisticsTypeCode.VALUE,DiscreteVariableStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DiscreteVariableStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DiscreteVariableStatisticsTypeCode.VALUE,DiscreteVariableStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
