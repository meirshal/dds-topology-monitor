...
public class SubscriberDescription   implements Copyable, Serializable{
    ...
    public DDSMonitoring.SubscriberQos qos = (DDSMonitoring.SubscriberQos)DDSMonitoring.SubscriberQos.create();

    public SubscriberDescription() {

    }
    public SubscriberDescription (SubscriberDescription other) {
    ...
    public static Object create() {
        ...
        SubscriberDescription self;
        self = new  SubscriberDescription();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        SubscriberDescription otherObj = (SubscriberDescription)o;
    ...
    * This method could be placed into <code>SubscriberDescriptionTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        SubscriberDescription typedSrc = (SubscriberDescription) src;
        SubscriberDescription typedDst = this;
        ...
        typedDst.qos = (DDSMonitoring.SubscriberQos) typedDst.qos.copy_from(typedSrc.qos);
