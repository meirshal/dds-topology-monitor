...
public class DataWriterDescription   implements Copyable, Serializable{

    public DDSMonitoring.BuiltinTopicKey_t entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_t.create();
    public DDSMonitoring.BuiltinTopicKey_t publisher_entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_t.create();
    ...
    public DDSMonitoring.DataWriterQos qos = (DDSMonitoring.DataWriterQos)DDSMonitoring.DataWriterQos.create();

    public DataWriterDescription() {

    }
    public DataWriterDescription (DataWriterDescription other) {
    ...
    public static Object create() {
        ...
        DataWriterDescription self;
        self = new  DataWriterDescription();
        self.clear();
        return self;
    ...
    public void clear() {
        ...
        if (publisher_entity_key != null) {
            publisher_entity_key.clear();
        }
    ...
    public boolean equals(Object o) {
        ...
        DataWriterDescription otherObj = (DataWriterDescription)o;

        if(!entity_key.equals(otherObj.entity_key)) {
            return false;
        }
        if(!publisher_entity_key.equals(otherObj.publisher_entity_key)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        __result += publisher_entity_key.hashCode(); 
    ...
    * This method could be placed into <code>DataWriterDescriptionTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        DataWriterDescription typedSrc = (DataWriterDescription) src;
        DataWriterDescription typedDst = this;

        typedDst.entity_key = (DDSMonitoring.BuiltinTopicKey_t) typedDst.entity_key.copy_from(typedSrc.entity_key);
        typedDst.publisher_entity_key = (DDSMonitoring.BuiltinTopicKey_t) typedDst.publisher_entity_key.copy_from(typedSrc.publisher_entity_key);
        ...
        typedDst.qos = (DDSMonitoring.DataWriterQos) typedDst.qos.copy_from(typedSrc.qos);
    ...
    public String toString(String desc, int indent) {
        ...
        strBuffer.append(publisher_entity_key.toString("publisher_entity_key ", indent+1));
