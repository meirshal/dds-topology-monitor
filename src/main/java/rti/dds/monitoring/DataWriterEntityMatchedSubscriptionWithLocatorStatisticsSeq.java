...
/**
* A sequence of DataWriterEntityMatchedSubscriptionWithLocatorStatistics instances.
*/
public final class DataWriterEntityMatchedSubscriptionWithLocatorStatisticsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public DataWriterEntityMatchedSubscriptionWithLocatorStatisticsSeq() {
        super(DataWriterEntityMatchedSubscriptionWithLocatorStatistics.class);
    }

    public DataWriterEntityMatchedSubscriptionWithLocatorStatisticsSeq (int initialMaximum) {
        super(DataWriterEntityMatchedSubscriptionWithLocatorStatistics.class, initialMaximum);
    }

    public DataWriterEntityMatchedSubscriptionWithLocatorStatisticsSeq (Collection elements) {
        super(DataWriterEntityMatchedSubscriptionWithLocatorStatistics.class, elements);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){ 
                    ...
                    set(i, DataWriterEntityMatchedSubscriptionWithLocatorStatistics.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' DataWriterEntityMatchedSubscriptionWithLocatorStatistics objects (beyond the original size of this object)
        for(int i = origSize; i < srcSize; i++){
            if (typedSrc.get(i) == null) {
                add(null);
            } else {
                // NOTE: we need to create a new object here to hold the copy
                add(DataWriterEntityMatchedSubscriptionWithLocatorStatistics.create());
