...
* RequestedDeadlineMissedStatusStatistics
*/

public class RequestedDeadlineMissedStatusStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::RequestedDeadlineMissedStatusStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RequestedDeadlineMissedStatusStatisticsTypeSupport _singleton
    = new RequestedDeadlineMissedStatusStatisticsTypeSupport();
    ...
    */
    public static RequestedDeadlineMissedStatusStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static RequestedDeadlineMissedStatusStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RequestedDeadlineMissedStatusStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return RequestedDeadlineMissedStatusStatistics.create();
    }
    ...
    public Object create_key() {
        return new RequestedDeadlineMissedStatusStatistics();
    }
    ...
    public Class get_type() {
        return RequestedDeadlineMissedStatusStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>RequestedDeadlineMissedStatusStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RequestedDeadlineMissedStatusStatistics typedDst = (RequestedDeadlineMissedStatusStatistics) destination;
        RequestedDeadlineMissedStatusStatistics typedSrc = (RequestedDeadlineMissedStatusStatistics) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.RequestedDeadlineMissedStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.RequestedDeadlineMissedStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RequestedDeadlineMissedStatusStatistics typedSrc = (RequestedDeadlineMissedStatusStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.RequestedDeadlineMissedStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.RequestedDeadlineMissedStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        RequestedDeadlineMissedStatusStatistics src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RequestedDeadlineMissedStatusStatistics typedDst = (RequestedDeadlineMissedStatusStatistics) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.status = (DDSMonitoring.RequestedDeadlineMissedStatus)DDSMonitoring.RequestedDeadlineMissedStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        RequestedDeadlineMissedStatusStatistics dst,
        byte[] buffer,
        long length) 
    {
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    DDSMonitoring.RequestedDeadlineMissedStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RequestedDeadlineMissedStatusStatistics typedDst = (RequestedDeadlineMissedStatusStatistics) sample;
    ...
    protected RequestedDeadlineMissedStatusStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RequestedDeadlineMissedStatusStatisticsTypeCode.VALUE,RequestedDeadlineMissedStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RequestedDeadlineMissedStatusStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RequestedDeadlineMissedStatusStatisticsTypeCode.VALUE,RequestedDeadlineMissedStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
