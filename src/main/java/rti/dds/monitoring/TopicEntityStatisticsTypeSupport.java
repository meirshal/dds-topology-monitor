...
public class TopicEntityStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::TopicEntityStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TopicEntityStatisticsTypeSupport _singleton
    = new TopicEntityStatisticsTypeSupport();
    ...
    */
    public static TopicEntityStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static TopicEntityStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TopicEntityStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return TopicEntityStatistics.create();
    }
    ...
    public Object create_key() {
        return new TopicEntityStatistics();
    }
    ...
    public Class get_type() {
        return TopicEntityStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>TopicEntityStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TopicEntityStatistics typedDst = (TopicEntityStatistics) destination;
        TopicEntityStatistics typedSrc = (TopicEntityStatistics) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += rti.dds.monitoring.InconsistentTopicStatusStatisticsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += rti.dds.monitoring.InconsistentTopicStatusStatisticsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TopicEntityStatistics typedSrc = (TopicEntityStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += rti.dds.monitoring.InconsistentTopicStatusStatisticsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.inconsistent_topic_status);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.type_name,(rti.dds.monitoring.STRING_MAX_LENGTH.VALUE));
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            rti.dds.monitoring.InconsistentTopicStatusStatisticsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.inconsistent_topic_status, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
            ...
            dst.skipListEndId = false;
            {
                ...
                memberId = 0;
                memberLengthPosition = dst.writeMemberId((short)memberId);
                DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialize_key(endpoint_data, typedSrc.topic_key, dst, false, encapsulation_id,true,endpoint_plugin_qos);
                dst.writeMemberLength(memberLengthPosition, false);
                memberId = 1;
                memberLengthPosition = dst.writeMemberId((short)memberId);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TopicEntityStatistics typedDst = (TopicEntityStatistics) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 4:
                    typedDst.type_name = src.readString((rti.dds.monitoring.STRING_MAX_LENGTH.VALUE));
                    break;
                    case 5:
                    ...
                    break;
                    case 8:
                    typedDst.inconsistent_topic_status = (rti.dds.monitoring.InconsistentTopicStatusStatistics)rti.dds.monitoring.InconsistentTopicStatusStatisticsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.inconsistent_topic_status, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if(deserialize_key) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.topic_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.topic_key, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 1:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 8:
                    rti.dds.monitoring.InconsistentTopicStatusStatisticsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TopicEntityStatistics typedDst = (TopicEntityStatistics) sample;
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 0:
                    typedDst.topic_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.topic_key, src, false, true, endpoint_plugin_qos);     
                    break;
    ...
    */
    ...
    Object instance,
    Object key) {
        TopicEntityStatistics typedDst
        = (TopicEntityStatistics) instance;
        TopicEntityStatistics typedSrc
        = (TopicEntityStatistics) key;
    ...
    */
    ...
    int mask) {
        return new TopicEntityStatisticsDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TopicEntityStatisticsDataReader(native_reader, listener, mask, this);   
    ...
    protected TopicEntityStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,TopicEntityStatisticsTypeCode.VALUE,TopicEntityStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TopicEntityStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TopicEntityStatisticsTypeCode.VALUE,TopicEntityStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
