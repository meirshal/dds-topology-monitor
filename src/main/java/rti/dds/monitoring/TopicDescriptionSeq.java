...
/**
* A sequence of TopicDescription instances.
*/
public final class TopicDescriptionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TopicDescriptionSeq() {
        super(TopicDescription.class);
    }

    public TopicDescriptionSeq (int initialMaximum) {
        super(TopicDescription.class, initialMaximum);
    }

    public TopicDescriptionSeq (Collection elements) {
        super(TopicDescription.class, elements);
    }
