...
public class  DataWriterEntityMatchedSubscriptionStatisticsTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("subscription_handle", false, (short)-1, true,(TypeCode) DDSMonitoring.InstanceHandle_tTypeCode.VALUE,1 , false);__i++;
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("rti::dds::monitoring::DataWriterEntityMatchedSubscriptionStatistics",ExtensibilityKind.MUTABLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
