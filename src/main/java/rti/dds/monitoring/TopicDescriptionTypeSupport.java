...
public class TopicDescriptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::TopicDescription";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TopicDescriptionTypeSupport _singleton
    = new TopicDescriptionTypeSupport();
    ...
    */
    public static TopicDescriptionTypeSupport get_instance() {
        return _singleton;
    }

    public static TopicDescriptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TopicDescriptionTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>TopicDescription</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        TopicDescription typedDst = (TopicDescription) destination;
        TopicDescription typedSrc = (TopicDescription) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.TopicQosTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.TopicQosTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        TopicDescription typedSrc = (TopicDescription) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.participant_entity_key);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.TopicQosTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.participant_entity_key, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberId = 7;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.tc_serialized_size);
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.TopicQosTypeSupport.get_instance().serialize(endpoint_data, typedSrc.qos, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TopicDescription typedDst = (TopicDescription) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 1:
                    typedDst.participant_entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.participant_entity_key, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 2:
                    ...
                    break;
                    case 7:
                    typedDst.tc_serialized_size = src.readInt();
                    break;
                    case 8:
                    typedDst.qos = (DDSMonitoring.TopicQos)DDSMonitoring.TopicQosTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.qos, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 8:
                    DDSMonitoring.TopicQosTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TopicDescription typedDst = (TopicDescription) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        TopicDescription typedDst
        = (TopicDescription) instance;
        TopicDescription typedSrc
        = (TopicDescription) key;
    ...
    */
    ...
    int mask) {
        return new TopicDescriptionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TopicDescriptionDataReader(native_reader, listener, mask, this);   
    ...
    protected TopicDescriptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,TopicDescriptionTypeCode.VALUE,TopicDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TopicDescriptionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,TopicDescriptionTypeCode.VALUE,TopicDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
