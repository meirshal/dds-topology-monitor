...
public class DataWriterDescriptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::DataWriterDescription";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataWriterDescriptionTypeSupport _singleton
    = new DataWriterDescriptionTypeSupport();
    ...
    */
    public static DataWriterDescriptionTypeSupport get_instance() {
        return _singleton;
    }

    public static DataWriterDescriptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataWriterDescriptionTypeCode.VALUE;
    }

    public Object create_data() {
        return DataWriterDescription.create();
    }
    ...
    public Object create_key() {
        return new DataWriterDescription();
    }
    ...
    public Class get_type() {
        return DataWriterDescription.class;
    }
    ...
    * <code>this</code> is not a <code>DataWriterDescription</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataWriterDescription typedDst = (DataWriterDescription) destination;
        DataWriterDescription typedSrc = (DataWriterDescription) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataWriterQosTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataWriterQosTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataWriterDescription typedSrc = (DataWriterDescription) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.publisher_entity_key);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataWriterQosTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.publisher_entity_key, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.DataWriterQosTypeSupport.get_instance().serialize(endpoint_data, typedSrc.qos, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataWriterDescription typedDst = (DataWriterDescription) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 1:
                    typedDst.publisher_entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.publisher_entity_key, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 2:
                    ...
                    break;
                    case 11:
                    typedDst.qos = (DDSMonitoring.DataWriterQos)DDSMonitoring.DataWriterQosTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.qos, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 11:
                    DDSMonitoring.DataWriterQosTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataWriterDescription typedDst = (DataWriterDescription) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        DataWriterDescription typedDst
        = (DataWriterDescription) instance;
        DataWriterDescription typedSrc
        = (DataWriterDescription) key;
    ...
    */
    ...
    int mask) {
        return new DataWriterDescriptionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DataWriterDescriptionDataReader(native_reader, listener, mask, this);   
    ...
    protected DataWriterDescriptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DataWriterDescriptionTypeCode.VALUE,DataWriterDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataWriterDescriptionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataWriterDescriptionTypeCode.VALUE,DataWriterDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
