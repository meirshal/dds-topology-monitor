...
public class  TopicDescriptionTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("tc_serialized_size", false, (short)-1,  false,(TypeCode) TypeCode.TC_ULONG,7 , false);__i++;
        sm[__i]=new  StructMember("qos", false, (short)-1,  false,(TypeCode) DDSMonitoring.TopicQosTypeCode.VALUE,8 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("rti::dds::monitoring::TopicDescription",ExtensibilityKind.MUTABLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
