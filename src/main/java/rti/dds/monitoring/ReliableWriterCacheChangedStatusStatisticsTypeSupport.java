...
* ReliableWriterCacheChangedStatusStatistics
*/

public class ReliableWriterCacheChangedStatusStatisticsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::ReliableWriterCacheChangedStatusStatistics";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReliableWriterCacheChangedStatusStatisticsTypeSupport _singleton
    = new ReliableWriterCacheChangedStatusStatisticsTypeSupport();
    ...
    */
    public static ReliableWriterCacheChangedStatusStatisticsTypeSupport get_instance() {
        return _singleton;
    }

    public static ReliableWriterCacheChangedStatusStatisticsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReliableWriterCacheChangedStatusStatisticsTypeCode.VALUE;
    }

    public Object create_data() {
        return ReliableWriterCacheChangedStatusStatistics.create();
    }
    ...
    public Object create_key() {
        return new ReliableWriterCacheChangedStatusStatistics();
    }
    ...
    public Class get_type() {
        return ReliableWriterCacheChangedStatusStatistics.class;
    }
    ...
    * <code>this</code> is not a <code>ReliableWriterCacheChangedStatusStatistics</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReliableWriterCacheChangedStatusStatistics typedDst = (ReliableWriterCacheChangedStatusStatistics) destination;
        ReliableWriterCacheChangedStatusStatistics typedSrc = (ReliableWriterCacheChangedStatusStatistics) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += DDSMonitoring.ReliableWriterCacheChangedStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ReliableWriterCacheChangedStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReliableWriterCacheChangedStatusStatistics typedSrc = (ReliableWriterCacheChangedStatusStatistics) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.ReliableWriterCacheChangedStatusTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.ReliableWriterCacheChangedStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.status, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        ReliableWriterCacheChangedStatusStatistics src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReliableWriterCacheChangedStatusStatistics typedDst = (ReliableWriterCacheChangedStatusStatistics) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.status = (DDSMonitoring.ReliableWriterCacheChangedStatus)DDSMonitoring.ReliableWriterCacheChangedStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.status, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        ReliableWriterCacheChangedStatusStatistics dst,
        byte[] buffer,
        long length) 
    {
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    DDSMonitoring.ReliableWriterCacheChangedStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReliableWriterCacheChangedStatusStatistics typedDst = (ReliableWriterCacheChangedStatusStatistics) sample;
    ...
    protected ReliableWriterCacheChangedStatusStatisticsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReliableWriterCacheChangedStatusStatisticsTypeCode.VALUE,ReliableWriterCacheChangedStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReliableWriterCacheChangedStatusStatisticsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReliableWriterCacheChangedStatusStatisticsTypeCode.VALUE,ReliableWriterCacheChangedStatusStatistics.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
