...
public class DataReaderDescriptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::DataReaderDescription";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DataReaderDescriptionTypeSupport _singleton
    = new DataReaderDescriptionTypeSupport();
    ...
    */
    public static DataReaderDescriptionTypeSupport get_instance() {
        return _singleton;
    }

    public static DataReaderDescriptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DataReaderDescriptionTypeCode.VALUE;
    }

    public Object create_data() {
        return DataReaderDescription.create();
    }
    ...
    public Object create_key() {
        return new DataReaderDescription();
    }
    ...
    public Class get_type() {
        return DataReaderDescription.class;
    }
    ...
    * <code>this</code> is not a <code>DataReaderDescription</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DataReaderDescription typedDst = (DataReaderDescription) destination;
        DataReaderDescription typedSrc = (DataReaderDescription) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataReaderQosTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataReaderQosTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DataReaderDescription typedSrc = (DataReaderDescription) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.entity_key);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.subscriber_entity_key);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.topic_entity_key);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DataReaderQosTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,0,typedSrc.qos);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 4);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.entity_key, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
            ...
            DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.subscriber_entity_key, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialize(endpoint_data, typedSrc.topic_entity_key, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
            ...
            memberId = 9;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.serialized_sample_max_size);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 10;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.serialized_sample_min_size);
            dst.writeMemberLength(memberLengthPosition, false);

            memberId = 11;
            memberLengthPosition = dst.writeMemberId((short)memberId);
            dst.writeInt(typedSrc.serialized_key_max_size);
            dst.writeMemberLength(memberLengthPosition, false);
            ...
            DDSMonitoring.DataReaderQosTypeSupport.get_instance().serialize(endpoint_data, typedSrc.qos, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (serialize_key) {
            ...
            dst.skipListEndId = false;
            {
                ...
                memberId = 0;
                memberLengthPosition = dst.writeMemberId((short)memberId);
                DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialize_key(endpoint_data, typedSrc.entity_key, dst, false, encapsulation_id,true,endpoint_plugin_qos);
                dst.writeMemberLength(memberLengthPosition, false);
                if (!(skipListEndId_tmp)) {
                    boolean mustUnderstand=false; /*Not default. Explicity set for backward compatibility*/
                    memberLengthPosition = 
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DataReaderDescription typedDst = (DataReaderDescription) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.entity_key, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 1:
                    typedDst.subscriber_entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.subscriber_entity_key, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 2:
                    typedDst.topic_entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.topic_entity_key, src, false, true, endpoint_plugin_qos);     
                    break;
                    case 3:
                    ...
                    break;
                    case 9:
                    typedDst.serialized_sample_max_size = src.readInt();
                    break;
                    case 10:
                    typedDst.serialized_sample_min_size = src.readInt();
                    break;
                    case 11:
                    typedDst.serialized_key_max_size = src.readInt();
                    break;
                    case 12:
                    typedDst.qos = (DDSMonitoring.DataReaderQos)DDSMonitoring.DataReaderQosTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.qos, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if(deserialize_key) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 0:
                    typedDst.entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.entity_key, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 12:
                    DDSMonitoring.DataReaderQosTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DataReaderDescription typedDst = (DataReaderDescription) sample;
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 0:
                    typedDst.entity_key = (DDSMonitoring.BuiltinTopicKey_t)DDSMonitoring.BuiltinTopicKey_tTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.entity_key, src, false, true, endpoint_plugin_qos);     
                    break;
    ...
    */
    ...
    Object instance,
    Object key) {
        DataReaderDescription typedDst
        = (DataReaderDescription) instance;
        DataReaderDescription typedSrc
        = (DataReaderDescription) key;
    ...
    */
    ...
    int mask) {
        return new DataReaderDescriptionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DataReaderDescriptionDataReader(native_reader, listener, mask, this);   
    ...
    protected DataReaderDescriptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DataReaderDescriptionTypeCode.VALUE,DataReaderDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DataReaderDescriptionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DataReaderDescriptionTypeCode.VALUE,DataReaderDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
