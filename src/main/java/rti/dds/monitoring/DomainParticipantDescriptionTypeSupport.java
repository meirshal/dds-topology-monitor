...
public class DomainParticipantDescriptionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "rti::dds::monitoring::DomainParticipantDescription";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DomainParticipantDescriptionTypeSupport _singleton
    = new DomainParticipantDescriptionTypeSupport();
    ...
    */
    public static DomainParticipantDescriptionTypeSupport get_instance() {
        return _singleton;
    }

    public static DomainParticipantDescriptionTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DomainParticipantDescriptionTypeCode.VALUE;
    }

    public Object create_data() {
        return DomainParticipantDescription.create();
    }
    ...
    public Object create_key() {
        return new DomainParticipantDescription();
    }
    ...
    public Class get_type() {
        return DomainParticipantDescription.class;
    }
    ...
    * <code>this</code> is not a <code>DomainParticipantDescription</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DomainParticipantDescription typedDst = (DomainParticipantDescription) destination;
        DomainParticipantDescription typedSrc = (DomainParticipantDescription) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DomainParticipantQosTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,0);
        // Sentinel
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(0 );
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DomainParticipantQosTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DomainParticipantDescription typedSrc = (DomainParticipantDescription) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(0);
        currentAlignment += (CdrPrimitiveType.getPadSize(currentAlignment, 4) + 12);
        currentAlignment += DDSMonitoring.DomainParticipantQosTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            DDSMonitoring.DomainParticipantQosTypeSupport.get_instance().serialize(endpoint_data, typedSrc.qos, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            if (dst.useExtendedMemberId == true) {
                dst.writeMemberLength(memberLengthPosition, true);
            } else {
                dst.writeMemberLength(memberLengthPosition, false);
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        DomainParticipantDescription src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DomainParticipantDescription typedDst = (DomainParticipantDescription) dst;
            typedDst.clear();      
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    break;
                    case 4:
                    typedDst.qos = (DDSMonitoring.DomainParticipantQos)DDSMonitoring.DomainParticipantQosTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.qos, src, false, true, endpoint_plugin_qos);     
                    break;
                    default:
    ...
    public void deserialize_from_cdr_buffer(
        DomainParticipantDescription dst,
        byte[] buffer,
        long length) 
    {
        ...
        if (skip_sample) {
            ...
            while (end != true && src.available() > 0) {
                ...
                switch (memberInfo.memberId) {
                    ...
                    case 4:
                    DDSMonitoring.DomainParticipantQosTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
                    break;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DomainParticipantDescription typedDst = (DomainParticipantDescription) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        DomainParticipantDescription typedDst
        = (DomainParticipantDescription) instance;
        DomainParticipantDescription typedSrc
        = (DomainParticipantDescription) key;
    ...
    */
    ...
    int mask) {
        return new DomainParticipantDescriptionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new DomainParticipantDescriptionDataReader(native_reader, listener, mask, this);   
    ...
    protected DomainParticipantDescriptionTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,DomainParticipantDescriptionTypeCode.VALUE,DomainParticipantDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DomainParticipantDescriptionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DomainParticipantDescriptionTypeCode.VALUE,DomainParticipantDescription.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
